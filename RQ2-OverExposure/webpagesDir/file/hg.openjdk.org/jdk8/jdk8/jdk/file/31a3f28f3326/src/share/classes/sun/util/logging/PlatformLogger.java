...
<title>jdk8/jdk8/jdk: 31a3f28f3326 src/share/classes/sun/util/logging/PlatformLogger.java</title>
</head>
<body>
...
<ul>
<li><a href="/jdk8/jdk8/jdk/rev/31a3f28f3326">changeset</a></li>
<li><a href="/jdk8/jdk8/jdk/file/31a3f28f3326/src/share/classes/sun/util/logging/">browse</a></li>
</ul>
<ul>
<li class="active">file</li>
<li><a href="/jdk8/jdk8/jdk/file/tip/src/share/classes/sun/util/logging/PlatformLogger.java">latest</a></li>
<li><a href="/jdk8/jdk8/jdk/diff/31a3f28f3326/src/share/classes/sun/util/logging/PlatformLogger.java">diff</a></li>
<li><a href="/jdk8/jdk8/jdk/comparison/31a3f28f3326/src/share/classes/sun/util/logging/PlatformLogger.java">comparison</a></li>
<li><a href="/jdk8/jdk8/jdk/annotate/31a3f28f3326/src/share/classes/sun/util/logging/PlatformLogger.java">annotate</a></li>
<li><a href="/jdk8/jdk8/jdk/log/31a3f28f3326/src/share/classes/sun/util/logging/PlatformLogger.java">file log</a></li>
<li><a href="/jdk8/jdk8/jdk/raw-file/31a3f28f3326/src/share/classes/sun/util/logging/PlatformLogger.java">raw</a></li>
</ul>
<ul>
...
<h3>view src/share/classes/sun/util/logging/PlatformLogger.java @ 2126:31a3f28f3326</h3>
...
<tr>
 ...
 <td class="date age">Wed, 23 Dec 2009 01:22:11 +0300</td>
</tr>
<tr>
 <th class="author">parents</th>
 <td class="author"><a href="/jdk8/jdk8/jdk/file/e07d1d393220/src/share/classes/sun/util/logging/PlatformLogger.java">e07d1d393220</a> </td>
</tr>
<tr>
 <th class="author">children</th>
 <td class="author"><a href="/jdk8/jdk8/jdk/file/00cd9dc3c2b5/src/share/classes/sun/util/logging/PlatformLogger.java">00cd9dc3c2b5</a> </td>
</tr>
</table>
...
<span id="l116">        new HashMap&lt;String,WeakReference&lt;PlatformLogger&gt;&gt;();</span><a href="#l116"></a>
...
<span id="l129">            loggers.put(name, new WeakReference&lt;PlatformLogger&gt;(log));</span><a href="#l129"></a>
...
<span id="l491">            new HashMap&lt;Integer, Object&gt;();</span><a href="#l491"></a>
...
<span id="l538">            int paramsNumber = (params != null) ? params.length : 0;</span><a href="#l538"></a>
<span id="l539">            for (int i = 0; i &lt; paramsNumber; i++) {</span><a href="#l539"></a>
<span id="l540">                params[i] = String.valueOf(params[i]);</span><a href="#l540"></a>
<span id="l541">            }</span><a href="#l541"></a>
<span id="l542">            LoggingSupport.log(javaLogger, levelObjects.get(level), msg, params);</span><a href="#l542"></a>
<span id="l543">        }</span><a href="#l543"></a>
<span id="l544"></span><a href="#l544"></a>
<span id="l545">        boolean isEnabled() {</span><a href="#l545"></a>
<span id="l546">            Object level = LoggingSupport.getLevel(javaLogger);</span><a href="#l546"></a>
<span id="l547">            return level == null || level.equals(levelObjects.get(OFF)) == false;</span><a href="#l547"></a>
<span id="l548">        }</span><a href="#l548"></a>
<span id="l549"></span><a href="#l549"></a>
<span id="l550">        int getLevel() {</span><a href="#l550"></a>
<span id="l551">            Object level = LoggingSupport.getLevel(javaLogger);</span><a href="#l551"></a>
<span id="l552">            if (level != null) {</span><a href="#l552"></a>
<span id="l553">                for (Map.Entry&lt;Integer, Object&gt; l : levelObjects.entrySet()) {</span><a href="#l553"></a>
<span id="l554">                    if (level == l.getValue()) {</span><a href="#l554"></a>
<span id="l555">                        return l.getKey();</span><a href="#l555"></a>
<span id="l556">                    }</span><a href="#l556"></a>
<span id="l557">                }</span><a href="#l557"></a>
<span id="l558">            }</span><a href="#l558"></a>
<span id="l559">            return 0;</span><a href="#l559"></a>
<span id="l560">        }</span><a href="#l560"></a>
<span id="l561"></span><a href="#l561"></a>
<span id="l562">        void setLevel(int newLevel) {</span><a href="#l562"></a>
<span id="l563">            levelValue = newLevel;</span><a href="#l563"></a>
<span id="l564">            LoggingSupport.setLevel(javaLogger, levelObjects.get(newLevel));</span><a href="#l564"></a>
<span id="l565">        }</span><a href="#l565"></a>
<span id="l566"></span><a href="#l566"></a>
<span id="l567">        public boolean isLoggable(int level) {</span><a href="#l567"></a>
<span id="l568">            return LoggingSupport.isLoggable(javaLogger, levelObjects.get(level));</span><a href="#l568"></a>
<span id="l569">        }</span><a href="#l569"></a>
<span id="l570">    }</span><a href="#l570"></a>
<span id="l571"></span><a href="#l571"></a>
<span id="l572">    private static String getLevelName(int level) {</span><a href="#l572"></a>
<span id="l573">        switch (level) {</span><a href="#l573"></a>
<span id="l574">            case OFF     : return &quot;OFF&quot;;</span><a href="#l574"></a>
<span id="l575">            case SEVERE  : return &quot;SEVERE&quot;;</span><a href="#l575"></a>
<span id="l576">            case WARNING : return &quot;WARNING&quot;;</span><a href="#l576"></a>
<span id="l577">            case INFO    : return &quot;INFO&quot;;</span><a href="#l577"></a>
<span id="l578">            case CONFIG  : return &quot;CONFIG&quot;;</span><a href="#l578"></a>
<span id="l579">            case FINE    : return &quot;FINE&quot;;</span><a href="#l579"></a>
<span id="l580">            case FINER   : return &quot;FINER&quot;;</span><a href="#l580"></a>
<span id="l581">            case FINEST  : return &quot;FINEST&quot;;</span><a href="#l581"></a>
<span id="l582">            case ALL     : return &quot;ALL&quot;;</span><a href="#l582"></a>
<span id="l583">            default      : return &quot;UNKNOWN&quot;;</span><a href="#l583"></a>
<span id="l584">        }</span><a href="#l584"></a>
<span id="l585">    }</span><a href="#l585"></a>
<span id="l586"></span><a href="#l586"></a>
<span id="l587">}</span><a href="#l587"></a></pre>
