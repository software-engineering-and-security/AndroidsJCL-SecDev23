...
<title>jdk7u/jdk7u/jdk: c39602abdf2f src/share/classes/java/io/ObjectStreamClass.java</title>
</head>
<body>
...
<li><a href="/jdk7u/jdk7u/jdk/file/tip/src/share/classes/java/io/ObjectStreamClass.java">latest</a></li>
<li><a href="/jdk7u/jdk7u/jdk/diff/c39602abdf2f/src/share/classes/java/io/ObjectStreamClass.java">diff</a></li>
<li><a href="/jdk7u/jdk7u/jdk/comparison/c39602abdf2f/src/share/classes/java/io/ObjectStreamClass.java">comparison</a></li>
<li><a href="/jdk7u/jdk7u/jdk/annotate/c39602abdf2f/src/share/classes/java/io/ObjectStreamClass.java">annotate</a></li>
<li><a href="/jdk7u/jdk7u/jdk/log/c39602abdf2f/src/share/classes/java/io/ObjectStreamClass.java">file log</a></li>
<li><a href="/jdk7u/jdk7u/jdk/raw-file/c39602abdf2f/src/share/classes/java/io/ObjectStreamClass.java">raw</a></li>
</ul>
<ul>
...
<h3>view src/share/classes/java/io/ObjectStreamClass.java @ 8992:c39602abdf2f</h3>
...
<tr>
 ...
 <td class="author"><a href="/jdk7u/jdk7u/jdk/file/17773cf4ad39/src/share/classes/java/io/ObjectStreamClass.java">17773cf4ad39</a> </td>
</tr>
<tr>
 <th class="author">children</th>
 <td class="author"><a href="/jdk7u/jdk7u/jdk/file/1a95d48e5ff1/src/share/classes/java/io/ObjectStreamClass.java">1a95d48e5ff1</a> </td>
</tr>
</table>
...
<span id="l547">            throw new InternalError();</span><a href="#l547"></a>
...
<span id="l1105">                    PrivilegedAction&lt;Object&gt; pea = new PrivilegedAction&lt;Object&gt;() {</span><a href="#l1105"></a>
<span id="l1106">                        @Override</span><a href="#l1106"></a>
<span id="l1107">                        public Object run() {</span><a href="#l1107"></a>
<span id="l1108">                            try {</span><a href="#l1108"></a>
<span id="l1109">                                return cons.newInstance();</span><a href="#l1109"></a>
<span id="l1110">                            } catch (InstantiationException</span><a href="#l1110"></a>
<span id="l1111">                                     | InvocationTargetException</span><a href="#l1111"></a>
<span id="l1112">                                     | IllegalAccessException x) {</span><a href="#l1112"></a>
<span id="l1113">                                throw new UndeclaredThrowableException(x);</span><a href="#l1113"></a>
<span id="l1114">                            }</span><a href="#l1114"></a>
<span id="l1115">                        }</span><a href="#l1115"></a>
<span id="l1116">                    }; // Can't use PrivilegedExceptionAction with jsa</span><a href="#l1116"></a>
<span id="l1117">                    try {</span><a href="#l1117"></a>
<span id="l1118">                        return jsa.doIntersectionPrivilege(pea,</span><a href="#l1118"></a>
<span id="l1119">                                   AccessController.getContext(),</span><a href="#l1119"></a>
<span id="l1120">                                   new AccessControlContext(domains));</span><a href="#l1120"></a>
<span id="l1121">                    } catch (UndeclaredThrowableException x) {</span><a href="#l1121"></a>
<span id="l1122">                        Throwable cause = x.getCause();</span><a href="#l1122"></a>
<span id="l1123">                        if (cause instanceof InstantiationException)</span><a href="#l1123"></a>
<span id="l1124">                            throw (InstantiationException) cause;</span><a href="#l1124"></a>
<span id="l1125">                        if (cause instanceof InvocationTargetException)</span><a href="#l1125"></a>
<span id="l1126">                            throw (InvocationTargetException) cause;</span><a href="#l1126"></a>
<span id="l1127">                        if (cause instanceof IllegalAccessException)</span><a href="#l1127"></a>
<span id="l1128">                            throw (IllegalAccessException) cause;</span><a href="#l1128"></a>
<span id="l1129">                        // not supposed to happen</span><a href="#l1129"></a>
<span id="l1130">                        throw x;</span><a href="#l1130"></a>
<span id="l1131">                    }</span><a href="#l1131"></a>
<span id="l1132">                }</span><a href="#l1132"></a>
<span id="l1133">            } catch (IllegalAccessException ex) {</span><a href="#l1133"></a>
<span id="l1134">                // should not occur, as access checks have been suppressed</span><a href="#l1134"></a>
<span id="l1135">                throw new InternalError();</span><a href="#l1135"></a>
<span id="l1136">            }</span><a href="#l1136"></a>
<span id="l1137">        } else {</span><a href="#l1137"></a>
<span id="l1138">            throw new UnsupportedOperationException();</span><a href="#l1138"></a>
...
<span id="l1143">     * Invokes the writeObject method of the represented serializable class.</span><a href="#l1143"></a>
<span id="l1144">     * Throws UnsupportedOperationException if this class descriptor is not</span><a href="#l1144"></a>
<span id="l1145">     * associated with a class, or if the class is externalizable,</span><a href="#l1145"></a>
<span id="l1146">     * non-serializable or does not define writeObject.</span><a href="#l1146"></a>
<span id="l1147">     */</span><a href="#l1147"></a>
<span id="l1148">    void invokeWriteObject(Object obj, ObjectOutputStream out)</span><a href="#l1148"></a>
<span id="l1149">        throws IOException, UnsupportedOperationException</span><a href="#l1149"></a>
<span id="l1150">    {</span><a href="#l1150"></a>
<span id="l1151">        requireInitialized();</span><a href="#l1151"></a>
<span id="l1152">        if (writeObjectMethod != null) {</span><a href="#l1152"></a>
<span id="l1153">            try {</span><a href="#l1153"></a>
<span id="l1154">                writeObjectMethod.invoke(obj, new Object[]{ out });</span><a href="#l1154"></a>
<span id="l1155">            } catch (InvocationTargetException ex) {</span><a href="#l1155"></a>
<span id="l1156">                Throwable th = ex.getTargetException();</span><a href="#l1156"></a>
<span id="l1157">                if (th instanceof IOException) {</span><a href="#l1157"></a>
<span id="l1158">                    throw (IOException) th;</span><a href="#l1158"></a>
<span id="l1159">                } else {</span><a href="#l1159"></a>
<span id="l1160">                    throwMiscException(th);</span><a href="#l1160"></a>
<span id="l1161">                }</span><a href="#l1161"></a>
<span id="l1162">            } catch (IllegalAccessException ex) {</span><a href="#l1162"></a>
<span id="l1163">                // should not occur, as access checks have been suppressed</span><a href="#l1163"></a>
<span id="l1164">                throw new InternalError();</span><a href="#l1164"></a>
<span id="l1165">            }</span><a href="#l1165"></a>
<span id="l1166">        } else {</span><a href="#l1166"></a>
<span id="l1167">            throw new UnsupportedOperationException();</span><a href="#l1167"></a>
...
<span id="l1172">     * Invokes the readObject method of the represented serializable class.</span><a href="#l1172"></a>
<span id="l1173">     * Throws UnsupportedOperationException if this class descriptor is not</span><a href="#l1173"></a>
<span id="l1174">     * associated with a class, or if the class is externalizable,</span><a href="#l1174"></a>
<span id="l1175">     * non-serializable or does not define readObject.</span><a href="#l1175"></a>
<span id="l1176">     */</span><a href="#l1176"></a>
<span id="l1177">    void invokeReadObject(Object obj, ObjectInputStream in)</span><a href="#l1177"></a>
<span id="l1178">        throws ClassNotFoundException, IOException,</span><a href="#l1178"></a>
<span id="l1179">               UnsupportedOperationException</span><a href="#l1179"></a>
<span id="l1180">    {</span><a href="#l1180"></a>
<span id="l1181">        requireInitialized();</span><a href="#l1181"></a>
<span id="l1182">        if (readObjectMethod != null) {</span><a href="#l1182"></a>
<span id="l1183">            try {</span><a href="#l1183"></a>
<span id="l1184">                readObjectMethod.invoke(obj, new Object[]{ in });</span><a href="#l1184"></a>
<span id="l1185">            } catch (InvocationTargetException ex) {</span><a href="#l1185"></a>
<span id="l1186">                Throwable th = ex.getTargetException();</span><a href="#l1186"></a>
<span id="l1187">                if (th instanceof ClassNotFoundException) {</span><a href="#l1187"></a>
<span id="l1188">                    throw (ClassNotFoundException) th;</span><a href="#l1188"></a>
<span id="l1189">                } else if (th instanceof IOException) {</span><a href="#l1189"></a>
<span id="l1190">                    throw (IOException) th;</span><a href="#l1190"></a>
<span id="l1191">                } else {</span><a href="#l1191"></a>
<span id="l1192">                    throwMiscException(th);</span><a href="#l1192"></a>
<span id="l1193">                }</span><a href="#l1193"></a>
<span id="l1194">            } catch (IllegalAccessException ex) {</span><a href="#l1194"></a>
<span id="l1195">                // should not occur, as access checks have been suppressed</span><a href="#l1195"></a>
<span id="l1196">                throw new InternalError();</span><a href="#l1196"></a>
<span id="l1197">            }</span><a href="#l1197"></a>
<span id="l1198">        } else {</span><a href="#l1198"></a>
<span id="l1199">            throw new UnsupportedOperationException();</span><a href="#l1199"></a>
...
<span id="l1204">     * Invokes the readObjectNoData method of the represented serializable</span><a href="#l1204"></a>
<span id="l1205">     * class.  Throws UnsupportedOperationException if this class descriptor is</span><a href="#l1205"></a>
<span id="l1206">     * not associated with a class, or if the class is externalizable,</span><a href="#l1206"></a>
<span id="l1207">     * non-serializable or does not define readObjectNoData.</span><a href="#l1207"></a>
<span id="l1208">     */</span><a href="#l1208"></a>
<span id="l1209">    void invokeReadObjectNoData(Object obj)</span><a href="#l1209"></a>
<span id="l1210">        throws IOException, UnsupportedOperationException</span><a href="#l1210"></a>
<span id="l1211">    {</span><a href="#l1211"></a>
<span id="l1212">        requireInitialized();</span><a href="#l1212"></a>
<span id="l1213">        if (readObjectNoDataMethod != null) {</span><a href="#l1213"></a>
<span id="l1214">            try {</span><a href="#l1214"></a>
<span id="l1215">                readObjectNoDataMethod.invoke(obj, (Object[]) null);</span><a href="#l1215"></a>
<span id="l1216">            } catch (InvocationTargetException ex) {</span><a href="#l1216"></a>
<span id="l1217">                Throwable th = ex.getTargetException();</span><a href="#l1217"></a>
<span id="l1218">                if (th instanceof ObjectStreamException) {</span><a href="#l1218"></a>
<span id="l1219">                    throw (ObjectStreamException) th;</span><a href="#l1219"></a>
<span id="l1220">                } else {</span><a href="#l1220"></a>
<span id="l1221">                    throwMiscException(th);</span><a href="#l1221"></a>
<span id="l1222">                }</span><a href="#l1222"></a>
<span id="l1223">            } catch (IllegalAccessException ex) {</span><a href="#l1223"></a>
<span id="l1224">                // should not occur, as access checks have been suppressed</span><a href="#l1224"></a>
<span id="l1225">                throw new InternalError();</span><a href="#l1225"></a>
<span id="l1226">            }</span><a href="#l1226"></a>
<span id="l1227">        } else {</span><a href="#l1227"></a>
<span id="l1228">            throw new UnsupportedOperationException();</span><a href="#l1228"></a>
...
<span id="l1233">     * Invokes the writeReplace method of the represented serializable class and</span><a href="#l1233"></a>
<span id="l1234">     * returns the result.  Throws UnsupportedOperationException if this class</span><a href="#l1234"></a>
<span id="l1235">     * descriptor is not associated with a class, or if the class is</span><a href="#l1235"></a>
<span id="l1236">     * non-serializable or does not define writeReplace.</span><a href="#l1236"></a>
<span id="l1237">     */</span><a href="#l1237"></a>
<span id="l1238">    Object invokeWriteReplace(Object obj)</span><a href="#l1238"></a>
<span id="l1239">        throws IOException, UnsupportedOperationException</span><a href="#l1239"></a>
<span id="l1240">    {</span><a href="#l1240"></a>
<span id="l1241">        requireInitialized();</span><a href="#l1241"></a>
<span id="l1242">        if (writeReplaceMethod != null) {</span><a href="#l1242"></a>
<span id="l1243">            try {</span><a href="#l1243"></a>
<span id="l1244">                return writeReplaceMethod.invoke(obj, (Object[]) null);</span><a href="#l1244"></a>
<span id="l1245">            } catch (InvocationTargetException ex) {</span><a href="#l1245"></a>
<span id="l1246">                Throwable th = ex.getTargetException();</span><a href="#l1246"></a>
<span id="l1247">                if (th instanceof ObjectStreamException) {</span><a href="#l1247"></a>
<span id="l1248">                    throw (ObjectStreamException) th;</span><a href="#l1248"></a>
<span id="l1249">                } else {</span><a href="#l1249"></a>
<span id="l1250">                    throwMiscException(th);</span><a href="#l1250"></a>
<span id="l1251">                    throw new InternalError();  // never reached</span><a href="#l1251"></a>
<span id="l1252">                }</span><a href="#l1252"></a>
<span id="l1253">            } catch (IllegalAccessException ex) {</span><a href="#l1253"></a>
<span id="l1254">                // should not occur, as access checks have been suppressed</span><a href="#l1254"></a>
<span id="l1255">                throw new InternalError();</span><a href="#l1255"></a>
<span id="l1256">            }</span><a href="#l1256"></a>
<span id="l1257">        } else {</span><a href="#l1257"></a>
<span id="l1258">            throw new UnsupportedOperationException();</span><a href="#l1258"></a>
...
<span id="l1263">     * Invokes the readResolve method of the represented serializable class and</span><a href="#l1263"></a>
<span id="l1264">     * returns the result.  Throws UnsupportedOperationException if this class</span><a href="#l1264"></a>
<span id="l1265">     * descriptor is not associated with a class, or if the class is</span><a href="#l1265"></a>
<span id="l1266">     * non-serializable or does not define readResolve.</span><a href="#l1266"></a>
<span id="l1267">     */</span><a href="#l1267"></a>
<span id="l1268">    Object invokeReadResolve(Object obj)</span><a href="#l1268"></a>
<span id="l1269">        throws IOException, UnsupportedOperationException</span><a href="#l1269"></a>
<span id="l1270">    {</span><a href="#l1270"></a>
<span id="l1271">        requireInitialized();</span><a href="#l1271"></a>
<span id="l1272">        if (readResolveMethod != null) {</span><a href="#l1272"></a>
<span id="l1273">            try {</span><a href="#l1273"></a>
<span id="l1274">                return readResolveMethod.invoke(obj, (Object[]) null);</span><a href="#l1274"></a>
<span id="l1275">            } catch (InvocationTargetException ex) {</span><a href="#l1275"></a>
<span id="l1276">                Throwable th = ex.getTargetException();</span><a href="#l1276"></a>
<span id="l1277">                if (th instanceof ObjectStreamException) {</span><a href="#l1277"></a>
<span id="l1278">                    throw (ObjectStreamException) th;</span><a href="#l1278"></a>
<span id="l1279">                } else {</span><a href="#l1279"></a>
<span id="l1280">                    throwMiscException(th);</span><a href="#l1280"></a>
<span id="l1281">                    throw new InternalError();  // never reached</span><a href="#l1281"></a>
<span id="l1282">                }</span><a href="#l1282"></a>
<span id="l1283">            } catch (IllegalAccessException ex) {</span><a href="#l1283"></a>
<span id="l1284">                // should not occur, as access checks have been suppressed</span><a href="#l1284"></a>
<span id="l1285">                throw new InternalError();</span><a href="#l1285"></a>
<span id="l1286">            }</span><a href="#l1286"></a>
<span id="l1287">        } else {</span><a href="#l1287"></a>
<span id="l1288">            throw new UnsupportedOperationException();</span><a href="#l1288"></a>
...
<span id="l1293">     * Class representing the portion of an object's serialized form allotted</span><a href="#l1293"></a>
<span id="l1294">     * to data described by a given class descriptor.  If &quot;hasData&quot; is false,</span><a href="#l1294"></a>
<span id="l1295">     * the object's serialized form does not contain data associated with the</span><a href="#l1295"></a>
<span id="l1296">     * class descriptor.</span><a href="#l1296"></a>
<span id="l1297">     */</span><a href="#l1297"></a>
<span id="l1298">    static class ClassDataSlot {</span><a href="#l1298"></a>
<span id="l1299"></span><a href="#l1299"></a>
<span id="l1300">        /** class descriptor &quot;occupying&quot; this slot */</span><a href="#l1300"></a>
<span id="l1301">        final ObjectStreamClass desc;</span><a href="#l1301"></a>
<span id="l1302">        /** true if serialized form includes data for this slot's descriptor */</span><a href="#l1302"></a>
<span id="l1303">        final boolean hasData;</span><a href="#l1303"></a>
<span id="l1304"></span><a href="#l1304"></a>
<span id="l1305">        ClassDataSlot(ObjectStreamClass desc, boolean hasData) {</span><a href="#l1305"></a>
<span id="l1306">            this.desc = desc;</span><a href="#l1306"></a>
<span id="l1307">            this.hasData = hasData;</span><a href="#l1307"></a>
...
<span id="l1312">     * Returns array of ClassDataSlot instances representing the data layout</span><a href="#l1312"></a>
<span id="l1313">     * (including superclass data) for serialized objects described by this</span><a href="#l1313"></a>
<span id="l1314">     * class descriptor.  ClassDataSlots are ordered by inheritance with those</span><a href="#l1314"></a>
<span id="l1315">     * containing &quot;higher&quot; superclasses appearing first.  The final</span><a href="#l1315"></a>
<span id="l1316">     * ClassDataSlot contains a reference to this descriptor.</span><a href="#l1316"></a>
<span id="l1317">     */</span><a href="#l1317"></a>
<span id="l1318">    ClassDataSlot[] getClassDataLayout() throws InvalidClassException {</span><a href="#l1318"></a>
<span id="l1319">        // REMIND: synchronize instead of relying on volatile?</span><a href="#l1319"></a>
<span id="l1320">        if (dataLayout == null) {</span><a href="#l1320"></a>
<span id="l1321">            dataLayout = getClassDataLayout0();</span><a href="#l1321"></a>
<span id="l1322">        }</span><a href="#l1322"></a>
<span id="l1323">        return dataLayout;</span><a href="#l1323"></a>
<span id="l1324">    }</span><a href="#l1324"></a>
<span id="l1325"></span><a href="#l1325"></a>
<span id="l1326">    private ClassDataSlot[] getClassDataLayout0()</span><a href="#l1326"></a>
<span id="l1327">        throws InvalidClassException</span><a href="#l1327"></a>
<span id="l1328">    {</span><a href="#l1328"></a>
<span id="l1329">        ArrayList&lt;ClassDataSlot&gt; slots = new ArrayList&lt;&gt;();</span><a href="#l1329"></a>
<span id="l1330">        Class&lt;?&gt; start = cl, end = cl;</span><a href="#l1330"></a>
<span id="l1331"></span><a href="#l1331"></a>
<span id="l1332">        // locate closest non-serializable superclass</span><a href="#l1332"></a>
<span id="l1333">        while (end != null &amp;&amp; Serializable.class.isAssignableFrom(end)) {</span><a href="#l1333"></a>
<span id="l1334">            end = end.getSuperclass();</span><a href="#l1334"></a>
<span id="l1335">        }</span><a href="#l1335"></a>
<span id="l1336"></span><a href="#l1336"></a>
<span id="l1337">        HashSet&lt;String&gt; oscNames = new HashSet&lt;&gt;(3);</span><a href="#l1337"></a>
<span id="l1338"></span><a href="#l1338"></a>
<span id="l1339">        for (ObjectStreamClass d = this; d != null; d = d.superDesc) {</span><a href="#l1339"></a>
<span id="l1340">            if (oscNames.contains(d.name)) {</span><a href="#l1340"></a>
<span id="l1341">                throw new InvalidClassException(&quot;Circular reference.&quot;);</span><a href="#l1341"></a>
<span id="l1342">            } else {</span><a href="#l1342"></a>
<span id="l1343">                oscNames.add(d.name);</span><a href="#l1343"></a>
<span id="l1344">            }</span><a href="#l1344"></a>
<span id="l1345"></span><a href="#l1345"></a>
<span id="l1346">            // search up inheritance hierarchy for class with matching name</span><a href="#l1346"></a>
<span id="l1347">            String searchName = (d.cl != null) ? d.cl.getName() : d.name;</span><a href="#l1347"></a>
<span id="l1348">            Class&lt;?&gt; match = null;</span><a href="#l1348"></a>
<span id="l1349">            for (Class&lt;?&gt; c = start; c != end; c = c.getSuperclass()) {</span><a href="#l1349"></a>
<span id="l1350">                if (searchName.equals(c.getName())) {</span><a href="#l1350"></a>
<span id="l1351">                    match = c;</span><a href="#l1351"></a>
<span id="l1352">                    break;</span><a href="#l1352"></a>
<span id="l1353">                }</span><a href="#l1353"></a>
<span id="l1354">            }</span><a href="#l1354"></a>
<span id="l1355"></span><a href="#l1355"></a>
<span id="l1356">            // add &quot;no data&quot; slot for each unmatched class below match</span><a href="#l1356"></a>
<span id="l1357">            if (match != null) {</span><a href="#l1357"></a>
<span id="l1358">                for (Class&lt;?&gt; c = start; c != match; c = c.getSuperclass()) {</span><a href="#l1358"></a>
<span id="l1359">                    slots.add(new ClassDataSlot(</span><a href="#l1359"></a>
<span id="l1360">                        ObjectStreamClass.lookup(c, true), false));</span><a href="#l1360"></a>
<span id="l1361">                }</span><a href="#l1361"></a>
<span id="l1362">                start = match.getSuperclass();</span><a href="#l1362"></a>
<span id="l1363">            }</span><a href="#l1363"></a>
<span id="l1364"></span><a href="#l1364"></a>
<span id="l1365">            // record descriptor/class pairing</span><a href="#l1365"></a>
<span id="l1366">            slots.add(new ClassDataSlot(d.getVariantFor(match), true));</span><a href="#l1366"></a>
<span id="l1367">        }</span><a href="#l1367"></a>
<span id="l1368"></span><a href="#l1368"></a>
<span id="l1369">        // add &quot;no data&quot; slot for any leftover unmatched classes</span><a href="#l1369"></a>
<span id="l1370">        for (Class&lt;?&gt; c = start; c != end; c = c.getSuperclass()) {</span><a href="#l1370"></a>
<span id="l1371">            slots.add(new ClassDataSlot(</span><a href="#l1371"></a>
<span id="l1372">                ObjectStreamClass.lookup(c, true), false));</span><a href="#l1372"></a>
<span id="l1373">        }</span><a href="#l1373"></a>
<span id="l1374"></span><a href="#l1374"></a>
<span id="l1375">        // order slots from superclass -&gt; subclass</span><a href="#l1375"></a>
<span id="l1376">        Collections.reverse(slots);</span><a href="#l1376"></a>
<span id="l1377">        return slots.toArray(new ClassDataSlot[slots.size()]);</span><a href="#l1377"></a>
<span id="l1378">    }</span><a href="#l1378"></a>
<span id="l1379"></span><a href="#l1379"></a>
<span id="l1380">    /**</span><a href="#l1380"></a>
<span id="l1381">     * Returns aggregate size (in bytes) of marshalled primitive field values</span><a href="#l1381"></a>
<span id="l1382">     * for represented class.</span><a href="#l1382"></a>
<span id="l1383">     */</span><a href="#l1383"></a>
<span id="l1384">    int getPrimDataSize() {</span><a href="#l1384"></a>
<span id="l1385">        return primDataSize;</span><a href="#l1385"></a>
<span id="l1386">    }</span><a href="#l1386"></a>
<span id="l1387"></span><a href="#l1387"></a>
<span id="l1388">    /**</span><a href="#l1388"></a>
<span id="l1389">     * Returns number of non-primitive serializable fields of represented</span><a href="#l1389"></a>
<span id="l1390">     * class.</span><a href="#l1390"></a>
<span id="l1391">     */</span><a href="#l1391"></a>
<span id="l1392">    int getNumObjFields() {</span><a href="#l1392"></a>
<span id="l1393">        return numObjFields;</span><a href="#l1393"></a>
<span id="l1394">    }</span><a href="#l1394"></a>
<span id="l1395"></span><a href="#l1395"></a>
<span id="l1396">    /**</span><a href="#l1396"></a>
<span id="l1397">     * Fetches the serializable primitive field values of object obj and</span><a href="#l1397"></a>
<span id="l1398">     * marshals them into byte array buf starting at offset 0.  It is the</span><a href="#l1398"></a>
<span id="l1399">     * responsibility of the caller to ensure that obj is of the proper type if</span><a href="#l1399"></a>
<span id="l1400">     * non-null.</span><a href="#l1400"></a>
<span id="l1401">     */</span><a href="#l1401"></a>
<span id="l1402">    void getPrimFieldValues(Object obj, byte[] buf) {</span><a href="#l1402"></a>
<span id="l1403">        fieldRefl.getPrimFieldValues(obj, buf);</span><a href="#l1403"></a>
<span id="l1404">    }</span><a href="#l1404"></a>
<span id="l1405"></span><a href="#l1405"></a>
<span id="l1406">    /**</span><a href="#l1406"></a>
<span id="l1407">     * Sets the serializable primitive fields of object obj using values</span><a href="#l1407"></a>
<span id="l1408">     * unmarshalled from byte array buf starting at offset 0.  It is the</span><a href="#l1408"></a>
<span id="l1409">     * responsibility of the caller to ensure that obj is of the proper type if</span><a href="#l1409"></a>
<span id="l1410">     * non-null.</span><a href="#l1410"></a>
<span id="l1411">     */</span><a href="#l1411"></a>
<span id="l1412">    void setPrimFieldValues(Object obj, byte[] buf) {</span><a href="#l1412"></a>
<span id="l1413">        fieldRefl.setPrimFieldValues(obj, buf);</span><a href="#l1413"></a>
<span id="l1414">    }</span><a href="#l1414"></a>
<span id="l1415"></span><a href="#l1415"></a>
<span id="l1416">    /**</span><a href="#l1416"></a>
<span id="l1417">     * Fetches the serializable object field values of object obj and stores</span><a href="#l1417"></a>
<span id="l1418">     * them in array vals starting at offset 0.  It is the responsibility of</span><a href="#l1418"></a>
<span id="l1419">     * the caller to ensure that obj is of the proper type if non-null.</span><a href="#l1419"></a>
<span id="l1420">     */</span><a href="#l1420"></a>
<span id="l1421">    void getObjFieldValues(Object obj, Object[] vals) {</span><a href="#l1421"></a>
<span id="l1422">        fieldRefl.getObjFieldValues(obj, vals);</span><a href="#l1422"></a>
<span id="l1423">    }</span><a href="#l1423"></a>
<span id="l1424"></span><a href="#l1424"></a>
<span id="l1425">    /**</span><a href="#l1425"></a>
<span id="l1426">     * Sets the serializable object fields of object obj using values from</span><a href="#l1426"></a>
<span id="l1427">     * array vals starting at offset 0.  It is the responsibility of the caller</span><a href="#l1427"></a>
<span id="l1428">     * to ensure that obj is of the proper type if non-null.</span><a href="#l1428"></a>
<span id="l1429">     */</span><a href="#l1429"></a>
<span id="l1430">    void setObjFieldValues(Object obj, Object[] vals) {</span><a href="#l1430"></a>
<span id="l1431">        fieldRefl.setObjFieldValues(obj, vals);</span><a href="#l1431"></a>
<span id="l1432">    }</span><a href="#l1432"></a>
<span id="l1433"></span><a href="#l1433"></a>
<span id="l1434">    /**</span><a href="#l1434"></a>
<span id="l1435">     * Calculates and sets serializable field offsets, as well as primitive</span><a href="#l1435"></a>
<span id="l1436">     * data size and object field count totals.  Throws InvalidClassException</span><a href="#l1436"></a>
<span id="l1437">     * if fields are illegally ordered.</span><a href="#l1437"></a>
<span id="l1438">     */</span><a href="#l1438"></a>
<span id="l1439">    private void computeFieldOffsets() throws InvalidClassException {</span><a href="#l1439"></a>
<span id="l1440">        primDataSize = 0;</span><a href="#l1440"></a>
<span id="l1441">        numObjFields = 0;</span><a href="#l1441"></a>
<span id="l1442">        int firstObjIndex = -1;</span><a href="#l1442"></a>
<span id="l1443"></span><a href="#l1443"></a>
<span id="l1444">        for (int i = 0; i &lt; fields.length; i++) {</span><a href="#l1444"></a>
<span id="l1445">            ObjectStreamField f = fields[i];</span><a href="#l1445"></a>
<span id="l1446">            switch (f.getTypeCode()) {</span><a href="#l1446"></a>
<span id="l1447">                case 'Z':</span><a href="#l1447"></a>
<span id="l1448">                case 'B':</span><a href="#l1448"></a>
<span id="l1449">                    f.setOffset(primDataSize++);</span><a href="#l1449"></a>
<span id="l1450">                    break;</span><a href="#l1450"></a>
<span id="l1451"></span><a href="#l1451"></a>
<span id="l1452">                case 'C':</span><a href="#l1452"></a>
<span id="l1453">                case 'S':</span><a href="#l1453"></a>
<span id="l1454">                    f.setOffset(primDataSize);</span><a href="#l1454"></a>
<span id="l1455">                    primDataSize += 2;</span><a href="#l1455"></a>
<span id="l1456">                    break;</span><a href="#l1456"></a>
<span id="l1457"></span><a href="#l1457"></a>
<span id="l1458">                case 'I':</span><a href="#l1458"></a>
<span id="l1459">                case 'F':</span><a href="#l1459"></a>
<span id="l1460">                    f.setOffset(primDataSize);</span><a href="#l1460"></a>
<span id="l1461">                    primDataSize += 4;</span><a href="#l1461"></a>
<span id="l1462">                    break;</span><a href="#l1462"></a>
<span id="l1463"></span><a href="#l1463"></a>
<span id="l1464">                case 'J':</span><a href="#l1464"></a>
<span id="l1465">                case 'D':</span><a href="#l1465"></a>
<span id="l1466">                    f.setOffset(primDataSize);</span><a href="#l1466"></a>
<span id="l1467">                    primDataSize += 8;</span><a href="#l1467"></a>
<span id="l1468">                    break;</span><a href="#l1468"></a>
<span id="l1469"></span><a href="#l1469"></a>
<span id="l1470">                case '[':</span><a href="#l1470"></a>
<span id="l1471">                case 'L':</span><a href="#l1471"></a>
<span id="l1472">                    f.setOffset(numObjFields++);</span><a href="#l1472"></a>
<span id="l1473">                    if (firstObjIndex == -1) {</span><a href="#l1473"></a>
<span id="l1474">                        firstObjIndex = i;</span><a href="#l1474"></a>
<span id="l1475">                    }</span><a href="#l1475"></a>
<span id="l1476">                    break;</span><a href="#l1476"></a>
<span id="l1477"></span><a href="#l1477"></a>
<span id="l1478">                default:</span><a href="#l1478"></a>
<span id="l1479">                    throw new InternalError();</span><a href="#l1479"></a>
<span id="l1480">            }</span><a href="#l1480"></a>
<span id="l1481">        }</span><a href="#l1481"></a>
<span id="l1482">        if (firstObjIndex != -1 &amp;&amp;</span><a href="#l1482"></a>
<span id="l1483">            firstObjIndex + numObjFields != fields.length)</span><a href="#l1483"></a>
<span id="l1484">        {</span><a href="#l1484"></a>
<span id="l1485">            throw new InvalidClassException(name, &quot;illegal field order&quot;);</span><a href="#l1485"></a>
...
<span id="l1490">     * If given class is the same as the class associated with this class</span><a href="#l1490"></a>
<span id="l1491">     * descriptor, returns reference to this class descriptor.  Otherwise,</span><a href="#l1491"></a>
<span id="l1492">     * returns variant of this class descriptor bound to given class.</span><a href="#l1492"></a>
<span id="l1493">     */</span><a href="#l1493"></a>
<span id="l1494">    private ObjectStreamClass getVariantFor(Class&lt;?&gt; cl)</span><a href="#l1494"></a>
<span id="l1495">        throws InvalidClassException</span><a href="#l1495"></a>
<span id="l1496">    {</span><a href="#l1496"></a>
<span id="l1497">        if (this.cl == cl) {</span><a href="#l1497"></a>
<span id="l1498">            return this;</span><a href="#l1498"></a>
<span id="l1499">        }</span><a href="#l1499"></a>
<span id="l1500">        ObjectStreamClass desc = new ObjectStreamClass();</span><a href="#l1500"></a>
<span id="l1501">        if (isProxy) {</span><a href="#l1501"></a>
<span id="l1502">            desc.initProxy(cl, null, superDesc);</span><a href="#l1502"></a>
<span id="l1503">        } else {</span><a href="#l1503"></a>
<span id="l1504">            desc.initNonProxy(this, cl, null, superDesc);</span><a href="#l1504"></a>
<span id="l1505">        }</span><a href="#l1505"></a>
<span id="l1506">        return desc;</span><a href="#l1506"></a>
<span id="l1507">    }</span><a href="#l1507"></a>
<span id="l1508"></span><a href="#l1508"></a>
<span id="l1509">    /**</span><a href="#l1509"></a>
<span id="l1510">     * Returns public no-arg constructor of given class, or null if none found.</span><a href="#l1510"></a>
<span id="l1511">     * Access checks are disabled on the returned constructor (if any), since</span><a href="#l1511"></a>
<span id="l1512">     * the defining class may still be non-public.</span><a href="#l1512"></a>
<span id="l1513">     */</span><a href="#l1513"></a>
<span id="l1514">    private static Constructor getExternalizableConstructor(Class&lt;?&gt; cl) {</span><a href="#l1514"></a>
<span id="l1515">        try {</span><a href="#l1515"></a>
<span id="l1516">            Constructor cons = cl.getDeclaredConstructor((Class&lt;?&gt;[]) null);</span><a href="#l1516"></a>
<span id="l1517">            cons.setAccessible(true);</span><a href="#l1517"></a>
<span id="l1518">            return ((cons.getModifiers() &amp; Modifier.PUBLIC) != 0) ?</span><a href="#l1518"></a>
<span id="l1519">                cons : null;</span><a href="#l1519"></a>
<span id="l1520">        } catch (NoSuchMethodException ex) {</span><a href="#l1520"></a>
<span id="l1521">            return null;</span><a href="#l1521"></a>
...
<span id="l1526">     * Given a class, determines whether its superclass has</span><a href="#l1526"></a>
<span id="l1527">     * any constructors that are accessible from the class.</span><a href="#l1527"></a>
<span id="l1528">     * This is a special purpose method intended to do access</span><a href="#l1528"></a>
<span id="l1529">     * checking for a serializable class and its superclasses</span><a href="#l1529"></a>
<span id="l1530">     * up to, but not including, the first non-serializable</span><a href="#l1530"></a>
<span id="l1531">     * superclass. This also implies that the superclass is</span><a href="#l1531"></a>
<span id="l1532">     * always non-null, because a serializable class must be a</span><a href="#l1532"></a>
<span id="l1533">     * class (not an interface) and Object is not serializable.</span><a href="#l1533"></a>
<span id="l1534">     *</span><a href="#l1534"></a>
<span id="l1535">     * @param cl the class from which access is checked</span><a href="#l1535"></a>
<span id="l1536">     * @return whether the superclass has a constructor accessible from cl</span><a href="#l1536"></a>
<span id="l1537">     */</span><a href="#l1537"></a>
<span id="l1538">    private static boolean superHasAccessibleConstructor(Class&lt;?&gt; cl) {</span><a href="#l1538"></a>
<span id="l1539">        Class&lt;?&gt; superCl = cl.getSuperclass();</span><a href="#l1539"></a>
<span id="l1540">        assert Serializable.class.isAssignableFrom(cl);</span><a href="#l1540"></a>
<span id="l1541">        assert superCl != null;</span><a href="#l1541"></a>
<span id="l1542">        if (packageEquals(cl, superCl)) {</span><a href="#l1542"></a>
<span id="l1543">            // accessible if any non-private constructor is found</span><a href="#l1543"></a>
<span id="l1544">            for (Constructor&lt;?&gt; ctor : superCl.getDeclaredConstructors()) {</span><a href="#l1544"></a>
<span id="l1545">                if ((ctor.getModifiers() &amp; Modifier.PRIVATE) == 0) {</span><a href="#l1545"></a>
<span id="l1546">                    return true;</span><a href="#l1546"></a>
<span id="l1547">                }</span><a href="#l1547"></a>
<span id="l1548">            }</span><a href="#l1548"></a>
<span id="l1549">            return false;</span><a href="#l1549"></a>
<span id="l1550">        } else {</span><a href="#l1550"></a>
<span id="l1551">            // sanity check to ensure the parent is protected or public</span><a href="#l1551"></a>
<span id="l1552">            if ((superCl.getModifiers() &amp; (Modifier.PROTECTED | Modifier.PUBLIC)) == 0) {</span><a href="#l1552"></a>
<span id="l1553">                return false;</span><a href="#l1553"></a>
<span id="l1554">            }</span><a href="#l1554"></a>
<span id="l1555">            // accessible if any constructor is protected or public</span><a href="#l1555"></a>
<span id="l1556">            for (Constructor&lt;?&gt; ctor : superCl.getDeclaredConstructors()) {</span><a href="#l1556"></a>
<span id="l1557">                if ((ctor.getModifiers() &amp; (Modifier.PROTECTED | Modifier.PUBLIC)) != 0) {</span><a href="#l1557"></a>
<span id="l1558">                    return true;</span><a href="#l1558"></a>
<span id="l1559">                }</span><a href="#l1559"></a>
<span id="l1560">            }</span><a href="#l1560"></a>
<span id="l1561">            return false;</span><a href="#l1561"></a>
...
<span id="l1566">     * Returns subclass-accessible no-arg constructor of first non-serializable</span><a href="#l1566"></a>
<span id="l1567">     * superclass, or null if none found.  Access checks are disabled on the</span><a href="#l1567"></a>
<span id="l1568">     * returned constructor (if any).</span><a href="#l1568"></a>
<span id="l1569">     */</span><a href="#l1569"></a>
<span id="l1570">    private static Constructor getSerializableConstructor(Class&lt;?&gt; cl) {</span><a href="#l1570"></a>
<span id="l1571">        Class&lt;?&gt; initCl = cl;</span><a href="#l1571"></a>
<span id="l1572">        while (Serializable.class.isAssignableFrom(initCl)) {</span><a href="#l1572"></a>
<span id="l1573">            Class&lt;?&gt; prev = initCl;</span><a href="#l1573"></a>
<span id="l1574">            if ((initCl = initCl.getSuperclass()) == null ||</span><a href="#l1574"></a>
<span id="l1575">                (!disableSerialConstructorChecks &amp;&amp; !superHasAccessibleConstructor(prev))) {</span><a href="#l1575"></a>
<span id="l1576">                return null;</span><a href="#l1576"></a>
<span id="l1577">            }</span><a href="#l1577"></a>
<span id="l1578">        }</span><a href="#l1578"></a>
<span id="l1579">        try {</span><a href="#l1579"></a>
<span id="l1580">            Constructor cons = initCl.getDeclaredConstructor((Class&lt;?&gt;[]) null);</span><a href="#l1580"></a>
<span id="l1581">            int mods = cons.getModifiers();</span><a href="#l1581"></a>
<span id="l1582">            if ((mods &amp; Modifier.PRIVATE) != 0 ||</span><a href="#l1582"></a>
<span id="l1583">                ((mods &amp; (Modifier.PUBLIC | Modifier.PROTECTED)) == 0 &amp;&amp;</span><a href="#l1583"></a>
<span id="l1584">                 !packageEquals(cl, initCl)))</span><a href="#l1584"></a>
<span id="l1585">            {</span><a href="#l1585"></a>
<span id="l1586">                return null;</span><a href="#l1586"></a>
<span id="l1587">            }</span><a href="#l1587"></a>
<span id="l1588">            cons = reflFactory.newConstructorForSerialization(cl, cons);</span><a href="#l1588"></a>
<span id="l1589">            cons.setAccessible(true);</span><a href="#l1589"></a>
<span id="l1590">            return cons;</span><a href="#l1590"></a>
<span id="l1591">        } catch (NoSuchMethodException ex) {</span><a href="#l1591"></a>
<span id="l1592">            return null;</span><a href="#l1592"></a>
...
<span id="l1597">     * Returns non-static, non-abstract method with given signature provided it</span><a href="#l1597"></a>
<span id="l1598">     * is defined by or accessible (via inheritance) by the given class, or</span><a href="#l1598"></a>
<span id="l1599">     * null if no match found.  Access checks are disabled on the returned</span><a href="#l1599"></a>
<span id="l1600">     * method (if any).</span><a href="#l1600"></a>
<span id="l1601">     */</span><a href="#l1601"></a>
<span id="l1602">    private static Method getInheritableMethod(Class&lt;?&gt; cl, String name,</span><a href="#l1602"></a>
<span id="l1603">                                               Class&lt;?&gt;[] argTypes,</span><a href="#l1603"></a>
<span id="l1604">                                               Class&lt;?&gt; returnType)</span><a href="#l1604"></a>
<span id="l1605">    {</span><a href="#l1605"></a>
<span id="l1606">        Method meth = null;</span><a href="#l1606"></a>
<span id="l1607">        Class&lt;?&gt; defCl = cl;</span><a href="#l1607"></a>
<span id="l1608">        while (defCl != null) {</span><a href="#l1608"></a>
<span id="l1609">            try {</span><a href="#l1609"></a>
<span id="l1610">                meth = defCl.getDeclaredMethod(name, argTypes);</span><a href="#l1610"></a>
<span id="l1611">                break;</span><a href="#l1611"></a>
<span id="l1612">            } catch (NoSuchMethodException ex) {</span><a href="#l1612"></a>
<span id="l1613">                defCl = defCl.getSuperclass();</span><a href="#l1613"></a>
<span id="l1614">            }</span><a href="#l1614"></a>
<span id="l1615">        }</span><a href="#l1615"></a>
<span id="l1616"></span><a href="#l1616"></a>
<span id="l1617">        if ((meth == null) || (meth.getReturnType() != returnType)) {</span><a href="#l1617"></a>
<span id="l1618">            return null;</span><a href="#l1618"></a>
<span id="l1619">        }</span><a href="#l1619"></a>
<span id="l1620">        meth.setAccessible(true);</span><a href="#l1620"></a>
<span id="l1621">        int mods = meth.getModifiers();</span><a href="#l1621"></a>
<span id="l1622">        if ((mods &amp; (Modifier.STATIC | Modifier.ABSTRACT)) != 0) {</span><a href="#l1622"></a>
<span id="l1623">            return null;</span><a href="#l1623"></a>
<span id="l1624">        } else if ((mods &amp; (Modifier.PUBLIC | Modifier.PROTECTED)) != 0) {</span><a href="#l1624"></a>
<span id="l1625">            return meth;</span><a href="#l1625"></a>
<span id="l1626">        } else if ((mods &amp; Modifier.PRIVATE) != 0) {</span><a href="#l1626"></a>
<span id="l1627">            return (cl == defCl) ? meth : null;</span><a href="#l1627"></a>
<span id="l1628">        } else {</span><a href="#l1628"></a>
<span id="l1629">            return packageEquals(cl, defCl) ? meth : null;</span><a href="#l1629"></a>
...
<span id="l1634">     * Returns non-static private method with given signature defined by given</span><a href="#l1634"></a>
<span id="l1635">     * class, or null if none found.  Access checks are disabled on the</span><a href="#l1635"></a>
<span id="l1636">     * returned method (if any).</span><a href="#l1636"></a>
<span id="l1637">     */</span><a href="#l1637"></a>
<span id="l1638">    private static Method getPrivateMethod(Class&lt;?&gt; cl, String name,</span><a href="#l1638"></a>
<span id="l1639">                                           Class&lt;?&gt;[] argTypes,</span><a href="#l1639"></a>
<span id="l1640">                                           Class&lt;?&gt; returnType)</span><a href="#l1640"></a>
<span id="l1641">    {</span><a href="#l1641"></a>
<span id="l1642">        try {</span><a href="#l1642"></a>
<span id="l1643">            Method meth = cl.getDeclaredMethod(name, argTypes);</span><a href="#l1643"></a>
<span id="l1644">            meth.setAccessible(true);</span><a href="#l1644"></a>
<span id="l1645">            int mods = meth.getModifiers();</span><a href="#l1645"></a>
<span id="l1646">            return ((meth.getReturnType() == returnType) &amp;&amp;</span><a href="#l1646"></a>
<span id="l1647">                    ((mods &amp; Modifier.STATIC) == 0) &amp;&amp;</span><a href="#l1647"></a>
<span id="l1648">                    ((mods &amp; Modifier.PRIVATE) != 0)) ? meth : null;</span><a href="#l1648"></a>
<span id="l1649">        } catch (NoSuchMethodException ex) {</span><a href="#l1649"></a>
<span id="l1650">            return null;</span><a href="#l1650"></a>
...
<span id="l1655">     * Returns true if classes are defined in the same runtime package, false</span><a href="#l1655"></a>
<span id="l1656">     * otherwise.</span><a href="#l1656"></a>
<span id="l1657">     */</span><a href="#l1657"></a>
<span id="l1658">    private static boolean packageEquals(Class&lt;?&gt; cl1, Class&lt;?&gt; cl2) {</span><a href="#l1658"></a>
<span id="l1659">        return (cl1.getClassLoader() == cl2.getClassLoader() &amp;&amp;</span><a href="#l1659"></a>
<span id="l1660">                getPackageName(cl1).equals(getPackageName(cl2)));</span><a href="#l1660"></a>
<span id="l1661">    }</span><a href="#l1661"></a>
<span id="l1662"></span><a href="#l1662"></a>
<span id="l1663">    /**</span><a href="#l1663"></a>
<span id="l1664">     * Returns package name of given class.</span><a href="#l1664"></a>
<span id="l1665">     */</span><a href="#l1665"></a>
<span id="l1666">    private static String getPackageName(Class&lt;?&gt; cl) {</span><a href="#l1666"></a>
<span id="l1667">        String s = cl.getName();</span><a href="#l1667"></a>
<span id="l1668">        int i = s.lastIndexOf('[');</span><a href="#l1668"></a>
<span id="l1669">        if (i &gt;= 0) {</span><a href="#l1669"></a>
<span id="l1670">            s = s.substring(i + 2);</span><a href="#l1670"></a>
<span id="l1671">        }</span><a href="#l1671"></a>
<span id="l1672">        i = s.lastIndexOf('.');</span><a href="#l1672"></a>
<span id="l1673">        return (i &gt;= 0) ? s.substring(0, i) : &quot;&quot;;</span><a href="#l1673"></a>
<span id="l1674">    }</span><a href="#l1674"></a>
<span id="l1675"></span><a href="#l1675"></a>
<span id="l1676">    /**</span><a href="#l1676"></a>
<span id="l1677">     * Compares class names for equality, ignoring package names.  Returns true</span><a href="#l1677"></a>
<span id="l1678">     * if class names equal, false otherwise.</span><a href="#l1678"></a>
<span id="l1679">     */</span><a href="#l1679"></a>
<span id="l1680">    private static boolean classNamesEqual(String name1, String name2) {</span><a href="#l1680"></a>
<span id="l1681">        name1 = name1.substring(name1.lastIndexOf('.') + 1);</span><a href="#l1681"></a>
<span id="l1682">        name2 = name2.substring(name2.lastIndexOf('.') + 1);</span><a href="#l1682"></a>
<span id="l1683">        return name1.equals(name2);</span><a href="#l1683"></a>
<span id="l1684">    }</span><a href="#l1684"></a>
<span id="l1685"></span><a href="#l1685"></a>
<span id="l1686">    /**</span><a href="#l1686"></a>
<span id="l1687">     * Returns JVM type signature for given class.</span><a href="#l1687"></a>
<span id="l1688">     */</span><a href="#l1688"></a>
<span id="l1689">    private static String getClassSignature(Class&lt;?&gt; cl) {</span><a href="#l1689"></a>
<span id="l1690">        StringBuilder sbuf = new StringBuilder();</span><a href="#l1690"></a>
<span id="l1691">        while (cl.isArray()) {</span><a href="#l1691"></a>
<span id="l1692">            sbuf.append('[');</span><a href="#l1692"></a>
<span id="l1693">            cl = cl.getComponentType();</span><a href="#l1693"></a>
<span id="l1694">        }</span><a href="#l1694"></a>
<span id="l1695">        if (cl.isPrimitive()) {</span><a href="#l1695"></a>
<span id="l1696">            if (cl == Integer.TYPE) {</span><a href="#l1696"></a>
<span id="l1697">                sbuf.append('I');</span><a href="#l1697"></a>
<span id="l1698">            } else if (cl == Byte.TYPE) {</span><a href="#l1698"></a>
<span id="l1699">                sbuf.append('B');</span><a href="#l1699"></a>
<span id="l1700">            } else if (cl == Long.TYPE) {</span><a href="#l1700"></a>
<span id="l1701">                sbuf.append('J');</span><a href="#l1701"></a>
<span id="l1702">            } else if (cl == Float.TYPE) {</span><a href="#l1702"></a>
<span id="l1703">                sbuf.append('F');</span><a href="#l1703"></a>
<span id="l1704">            } else if (cl == Double.TYPE) {</span><a href="#l1704"></a>
<span id="l1705">                sbuf.append('D');</span><a href="#l1705"></a>
<span id="l1706">            } else if (cl == Short.TYPE) {</span><a href="#l1706"></a>
<span id="l1707">                sbuf.append('S');</span><a href="#l1707"></a>
<span id="l1708">            } else if (cl == Character.TYPE) {</span><a href="#l1708"></a>
<span id="l1709">                sbuf.append('C');</span><a href="#l1709"></a>
<span id="l1710">            } else if (cl == Boolean.TYPE) {</span><a href="#l1710"></a>
<span id="l1711">                sbuf.append('Z');</span><a href="#l1711"></a>
<span id="l1712">            } else if (cl == Void.TYPE) {</span><a href="#l1712"></a>
<span id="l1713">                sbuf.append('V');</span><a href="#l1713"></a>
<span id="l1714">            } else {</span><a href="#l1714"></a>
<span id="l1715">                throw new InternalError();</span><a href="#l1715"></a>
<span id="l1716">            }</span><a href="#l1716"></a>
<span id="l1717">        } else {</span><a href="#l1717"></a>
<span id="l1718">            sbuf.append('L' + cl.getName().replace('.', '/') + ';');</span><a href="#l1718"></a>
<span id="l1719">        }</span><a href="#l1719"></a>
<span id="l1720">        return sbuf.toString();</span><a href="#l1720"></a>
<span id="l1721">    }</span><a href="#l1721"></a>
<span id="l1722"></span><a href="#l1722"></a>
<span id="l1723">    /**</span><a href="#l1723"></a>
<span id="l1724">     * Returns JVM type signature for given list of parameters and return type.</span><a href="#l1724"></a>
<span id="l1725">     */</span><a href="#l1725"></a>
<span id="l1726">    private static String getMethodSignature(Class&lt;?&gt;[] paramTypes,</span><a href="#l1726"></a>
<span id="l1727">                                             Class&lt;?&gt; retType)</span><a href="#l1727"></a>
<span id="l1728">    {</span><a href="#l1728"></a>
<span id="l1729">        StringBuilder sbuf = new StringBuilder();</span><a href="#l1729"></a>
<span id="l1730">        sbuf.append('(');</span><a href="#l1730"></a>
<span id="l1731">        for (int i = 0; i &lt; paramTypes.length; i++) {</span><a href="#l1731"></a>
<span id="l1732">            sbuf.append(getClassSignature(paramTypes[i]));</span><a href="#l1732"></a>
<span id="l1733">        }</span><a href="#l1733"></a>
<span id="l1734">        sbuf.append(')');</span><a href="#l1734"></a>
<span id="l1735">        sbuf.append(getClassSignature(retType));</span><a href="#l1735"></a>
<span id="l1736">        return sbuf.toString();</span><a href="#l1736"></a>
<span id="l1737">    }</span><a href="#l1737"></a>
<span id="l1738"></span><a href="#l1738"></a>
<span id="l1739">    /**</span><a href="#l1739"></a>
<span id="l1740">     * Convenience method for throwing an exception that is either a</span><a href="#l1740"></a>
<span id="l1741">     * RuntimeException, Error, or of some unexpected type (in which case it is</span><a href="#l1741"></a>
<span id="l1742">     * wrapped inside an IOException).</span><a href="#l1742"></a>
<span id="l1743">     */</span><a href="#l1743"></a>
<span id="l1744">    private static void throwMiscException(Throwable th) throws IOException {</span><a href="#l1744"></a>
<span id="l1745">        if (th instanceof RuntimeException) {</span><a href="#l1745"></a>
<span id="l1746">            throw (RuntimeException) th;</span><a href="#l1746"></a>
<span id="l1747">        } else if (th instanceof Error) {</span><a href="#l1747"></a>
<span id="l1748">            throw (Error) th;</span><a href="#l1748"></a>
<span id="l1749">        } else {</span><a href="#l1749"></a>
<span id="l1750">            IOException ex = new IOException(&quot;unexpected exception type&quot;);</span><a href="#l1750"></a>
<span id="l1751">            ex.initCause(th);</span><a href="#l1751"></a>
<span id="l1752">            throw ex;</span><a href="#l1752"></a>
...
<span id="l1757">     * Returns ObjectStreamField array describing the serializable fields of</span><a href="#l1757"></a>
<span id="l1758">     * the given class.  Serializable fields backed by an actual field of the</span><a href="#l1758"></a>
<span id="l1759">     * class are represented by ObjectStreamFields with corresponding non-null</span><a href="#l1759"></a>
<span id="l1760">     * Field objects.  Throws InvalidClassException if the (explicitly</span><a href="#l1760"></a>
<span id="l1761">     * declared) serializable fields are invalid.</span><a href="#l1761"></a>
<span id="l1762">     */</span><a href="#l1762"></a>
<span id="l1763">    private static ObjectStreamField[] getSerialFields(Class&lt;?&gt; cl)</span><a href="#l1763"></a>
<span id="l1764">        throws InvalidClassException</span><a href="#l1764"></a>
<span id="l1765">    {</span><a href="#l1765"></a>
<span id="l1766">        ObjectStreamField[] fields;</span><a href="#l1766"></a>
<span id="l1767">        if (Serializable.class.isAssignableFrom(cl) &amp;&amp;</span><a href="#l1767"></a>
<span id="l1768">            !Externalizable.class.isAssignableFrom(cl) &amp;&amp;</span><a href="#l1768"></a>
<span id="l1769">            !Proxy.isProxyClass(cl) &amp;&amp;</span><a href="#l1769"></a>
<span id="l1770">            !cl.isInterface())</span><a href="#l1770"></a>
<span id="l1771">        {</span><a href="#l1771"></a>
<span id="l1772">            if ((fields = getDeclaredSerialFields(cl)) == null) {</span><a href="#l1772"></a>
<span id="l1773">                fields = getDefaultSerialFields(cl);</span><a href="#l1773"></a>
<span id="l1774">            }</span><a href="#l1774"></a>
<span id="l1775">            Arrays.sort(fields);</span><a href="#l1775"></a>
<span id="l1776">        } else {</span><a href="#l1776"></a>
<span id="l1777">            fields = NO_FIELDS;</span><a href="#l1777"></a>
<span id="l1778">        }</span><a href="#l1778"></a>
<span id="l1779">        return fields;</span><a href="#l1779"></a>
<span id="l1780">    }</span><a href="#l1780"></a>
<span id="l1781"></span><a href="#l1781"></a>
<span id="l1782">    /**</span><a href="#l1782"></a>
<span id="l1783">     * Returns serializable fields of given class as defined explicitly by a</span><a href="#l1783"></a>
<span id="l1784">     * &quot;serialPersistentFields&quot; field, or null if no appropriate</span><a href="#l1784"></a>
<span id="l1785">     * &quot;serialPersistentFields&quot; field is defined.  Serializable fields backed</span><a href="#l1785"></a>
<span id="l1786">     * by an actual field of the class are represented by ObjectStreamFields</span><a href="#l1786"></a>
<span id="l1787">     * with corresponding non-null Field objects.  For compatibility with past</span><a href="#l1787"></a>
<span id="l1788">     * releases, a &quot;serialPersistentFields&quot; field with a null value is</span><a href="#l1788"></a>
<span id="l1789">     * considered equivalent to not declaring &quot;serialPersistentFields&quot;.  Throws</span><a href="#l1789"></a>
<span id="l1790">     * InvalidClassException if the declared serializable fields are</span><a href="#l1790"></a>
<span id="l1791">     * invalid--e.g., if multiple fields share the same name.</span><a href="#l1791"></a>
<span id="l1792">     */</span><a href="#l1792"></a>
<span id="l1793">    private static ObjectStreamField[] getDeclaredSerialFields(Class&lt;?&gt; cl)</span><a href="#l1793"></a>
<span id="l1794">        throws InvalidClassException</span><a href="#l1794"></a>
<span id="l1795">    {</span><a href="#l1795"></a>
<span id="l1796">        ObjectStreamField[] serialPersistentFields = null;</span><a href="#l1796"></a>
<span id="l1797">        try {</span><a href="#l1797"></a>
<span id="l1798">            Field f = cl.getDeclaredField(&quot;serialPersistentFields&quot;);</span><a href="#l1798"></a>
<span id="l1799">            int mask = Modifier.PRIVATE | Modifier.STATIC | Modifier.FINAL;</span><a href="#l1799"></a>
<span id="l1800">            if ((f.getModifiers() &amp; mask) == mask) {</span><a href="#l1800"></a>
<span id="l1801">                f.setAccessible(true);</span><a href="#l1801"></a>
<span id="l1802">                serialPersistentFields = (ObjectStreamField[]) f.get(null);</span><a href="#l1802"></a>
<span id="l1803">            }</span><a href="#l1803"></a>
<span id="l1804">        } catch (Exception ex) {</span><a href="#l1804"></a>
<span id="l1805">        }</span><a href="#l1805"></a>
<span id="l1806">        if (serialPersistentFields == null) {</span><a href="#l1806"></a>
<span id="l1807">            return null;</span><a href="#l1807"></a>
<span id="l1808">        } else if (serialPersistentFields.length == 0) {</span><a href="#l1808"></a>
<span id="l1809">            return NO_FIELDS;</span><a href="#l1809"></a>
<span id="l1810">        }</span><a href="#l1810"></a>
<span id="l1811"></span><a href="#l1811"></a>
<span id="l1812">        ObjectStreamField[] boundFields =</span><a href="#l1812"></a>
<span id="l1813">            new ObjectStreamField[serialPersistentFields.length];</span><a href="#l1813"></a>
<span id="l1814">        Set&lt;String&gt; fieldNames = new HashSet&lt;&gt;(serialPersistentFields.length);</span><a href="#l1814"></a>
<span id="l1815"></span><a href="#l1815"></a>
<span id="l1816">        for (int i = 0; i &lt; serialPersistentFields.length; i++) {</span><a href="#l1816"></a>
<span id="l1817">            ObjectStreamField spf = serialPersistentFields[i];</span><a href="#l1817"></a>
<span id="l1818"></span><a href="#l1818"></a>
<span id="l1819">            String fname = spf.getName();</span><a href="#l1819"></a>
<span id="l1820">            if (fieldNames.contains(fname)) {</span><a href="#l1820"></a>
<span id="l1821">                throw new InvalidClassException(</span><a href="#l1821"></a>
<span id="l1822">                    &quot;multiple serializable fields named &quot; + fname);</span><a href="#l1822"></a>
<span id="l1823">            }</span><a href="#l1823"></a>
<span id="l1824">            fieldNames.add(fname);</span><a href="#l1824"></a>
<span id="l1825"></span><a href="#l1825"></a>
<span id="l1826">            try {</span><a href="#l1826"></a>
<span id="l1827">                Field f = cl.getDeclaredField(fname);</span><a href="#l1827"></a>
<span id="l1828">                if ((f.getType() == spf.getType()) &amp;&amp;</span><a href="#l1828"></a>
<span id="l1829">                    ((f.getModifiers() &amp; Modifier.STATIC) == 0))</span><a href="#l1829"></a>
<span id="l1830">                {</span><a href="#l1830"></a>
<span id="l1831">                    boundFields[i] =</span><a href="#l1831"></a>
<span id="l1832">                        new ObjectStreamField(f, spf.isUnshared(), true);</span><a href="#l1832"></a>
<span id="l1833">                }</span><a href="#l1833"></a>
<span id="l1834">            } catch (NoSuchFieldException ex) {</span><a href="#l1834"></a>
<span id="l1835">            }</span><a href="#l1835"></a>
<span id="l1836">            if (boundFields[i] == null) {</span><a href="#l1836"></a>
<span id="l1837">                boundFields[i] = new ObjectStreamField(</span><a href="#l1837"></a>
<span id="l1838">                    fname, spf.getType(), spf.isUnshared());</span><a href="#l1838"></a>
<span id="l1839">            }</span><a href="#l1839"></a>
<span id="l1840">        }</span><a href="#l1840"></a>
<span id="l1841">        return boundFields;</span><a href="#l1841"></a>
<span id="l1842">    }</span><a href="#l1842"></a>
<span id="l1843"></span><a href="#l1843"></a>
<span id="l1844">    /**</span><a href="#l1844"></a>
<span id="l1845">     * Returns array of ObjectStreamFields corresponding to all non-static</span><a href="#l1845"></a>
<span id="l1846">     * non-transient fields declared by given class.  Each ObjectStreamField</span><a href="#l1846"></a>
<span id="l1847">     * contains a Field object for the field it represents.  If no default</span><a href="#l1847"></a>
<span id="l1848">     * serializable fields exist, NO_FIELDS is returned.</span><a href="#l1848"></a>
<span id="l1849">     */</span><a href="#l1849"></a>
<span id="l1850">    private static ObjectStreamField[] getDefaultSerialFields(Class&lt;?&gt; cl) {</span><a href="#l1850"></a>
<span id="l1851">        Field[] clFields = cl.getDeclaredFields();</span><a href="#l1851"></a>
<span id="l1852">        ArrayList&lt;ObjectStreamField&gt; list = new ArrayList&lt;&gt;();</span><a href="#l1852"></a>
<span id="l1853">        int mask = Modifier.STATIC | Modifier.TRANSIENT;</span><a href="#l1853"></a>
<span id="l1854"></span><a href="#l1854"></a>
<span id="l1855">        for (int i = 0; i &lt; clFields.length; i++) {</span><a href="#l1855"></a>
<span id="l1856">            if ((clFields[i].getModifiers() &amp; mask) == 0) {</span><a href="#l1856"></a>
<span id="l1857">                list.add(new ObjectStreamField(clFields[i], false, true));</span><a href="#l1857"></a>
<span id="l1858">            }</span><a href="#l1858"></a>
<span id="l1859">        }</span><a href="#l1859"></a>
<span id="l1860">        int size = list.size();</span><a href="#l1860"></a>
<span id="l1861">        return (size == 0) ? NO_FIELDS :</span><a href="#l1861"></a>
<span id="l1862">            list.toArray(new ObjectStreamField[size]);</span><a href="#l1862"></a>
<span id="l1863">    }</span><a href="#l1863"></a>
<span id="l1864"></span><a href="#l1864"></a>
<span id="l1865">    /**</span><a href="#l1865"></a>
<span id="l1866">     * Returns explicit serial version UID value declared by given class, or</span><a href="#l1866"></a>
<span id="l1867">     * null if none.</span><a href="#l1867"></a>
<span id="l1868">     */</span><a href="#l1868"></a>
<span id="l1869">    private static Long getDeclaredSUID(Class&lt;?&gt; cl) {</span><a href="#l1869"></a>
<span id="l1870">        try {</span><a href="#l1870"></a>
<span id="l1871">            Field f = cl.getDeclaredField(&quot;serialVersionUID&quot;);</span><a href="#l1871"></a>
<span id="l1872">            int mask = Modifier.STATIC | Modifier.FINAL;</span><a href="#l1872"></a>
<span id="l1873">            if ((f.getModifiers() &amp; mask) == mask) {</span><a href="#l1873"></a>
<span id="l1874">                f.setAccessible(true);</span><a href="#l1874"></a>
<span id="l1875">                return Long.valueOf(f.getLong(null));</span><a href="#l1875"></a>
<span id="l1876">            }</span><a href="#l1876"></a>
<span id="l1877">        } catch (Exception ex) {</span><a href="#l1877"></a>
<span id="l1878">        }</span><a href="#l1878"></a>
<span id="l1879">        return null;</span><a href="#l1879"></a>
<span id="l1880">    }</span><a href="#l1880"></a>
<span id="l1881"></span><a href="#l1881"></a>
<span id="l1882">    /**</span><a href="#l1882"></a>
<span id="l1883">     * Computes the default serial version UID value for the given class.</span><a href="#l1883"></a>
<span id="l1884">     */</span><a href="#l1884"></a>
<span id="l1885">    private static long computeDefaultSUID(Class&lt;?&gt; cl) {</span><a href="#l1885"></a>
<span id="l1886">        if (!Serializable.class.isAssignableFrom(cl) || Proxy.isProxyClass(cl))</span><a href="#l1886"></a>
<span id="l1887">        {</span><a href="#l1887"></a>
<span id="l1888">            return 0L;</span><a href="#l1888"></a>
<span id="l1889">        }</span><a href="#l1889"></a>
<span id="l1890"></span><a href="#l1890"></a>
<span id="l1891">        try {</span><a href="#l1891"></a>
<span id="l1892">            ByteArrayOutputStream bout = new ByteArrayOutputStream();</span><a href="#l1892"></a>
<span id="l1893">            DataOutputStream dout = new DataOutputStream(bout);</span><a href="#l1893"></a>
<span id="l1894"></span><a href="#l1894"></a>
<span id="l1895">            dout.writeUTF(cl.getName());</span><a href="#l1895"></a>
<span id="l1896"></span><a href="#l1896"></a>
<span id="l1897">            int classMods = cl.getModifiers() &amp;</span><a href="#l1897"></a>
<span id="l1898">                (Modifier.PUBLIC | Modifier.FINAL |</span><a href="#l1898"></a>
<span id="l1899">                 Modifier.INTERFACE | Modifier.ABSTRACT);</span><a href="#l1899"></a>
<span id="l1900"></span><a href="#l1900"></a>
<span id="l1901">            /*</span><a href="#l1901"></a>
<span id="l1902">             * compensate for javac bug in which ABSTRACT bit was set for an</span><a href="#l1902"></a>
<span id="l1903">             * interface only if the interface declared methods</span><a href="#l1903"></a>
<span id="l1904">             */</span><a href="#l1904"></a>
<span id="l1905">            Method[] methods = cl.getDeclaredMethods();</span><a href="#l1905"></a>
<span id="l1906">            if ((classMods &amp; Modifier.INTERFACE) != 0) {</span><a href="#l1906"></a>
<span id="l1907">                classMods = (methods.length &gt; 0) ?</span><a href="#l1907"></a>
<span id="l1908">                    (classMods | Modifier.ABSTRACT) :</span><a href="#l1908"></a>
<span id="l1909">                    (classMods &amp; ~Modifier.ABSTRACT);</span><a href="#l1909"></a>
<span id="l1910">            }</span><a href="#l1910"></a>
<span id="l1911">            dout.writeInt(classMods);</span><a href="#l1911"></a>
<span id="l1912"></span><a href="#l1912"></a>
<span id="l1913">            if (!cl.isArray()) {</span><a href="#l1913"></a>
<span id="l1914">                /*</span><a href="#l1914"></a>
<span id="l1915">                 * compensate for change in 1.2FCS in which</span><a href="#l1915"></a>
<span id="l1916">                 * Class.getInterfaces() was modified to return Cloneable and</span><a href="#l1916"></a>
<span id="l1917">                 * Serializable for array classes.</span><a href="#l1917"></a>
<span id="l1918">                 */</span><a href="#l1918"></a>
<span id="l1919">                Class&lt;?&gt;[] interfaces = cl.getInterfaces();</span><a href="#l1919"></a>
<span id="l1920">                String[] ifaceNames = new String[interfaces.length];</span><a href="#l1920"></a>
<span id="l1921">                for (int i = 0; i &lt; interfaces.length; i++) {</span><a href="#l1921"></a>
<span id="l1922">                    ifaceNames[i] = interfaces[i].getName();</span><a href="#l1922"></a>
<span id="l1923">                }</span><a href="#l1923"></a>
<span id="l1924">                Arrays.sort(ifaceNames);</span><a href="#l1924"></a>
<span id="l1925">                for (int i = 0; i &lt; ifaceNames.length; i++) {</span><a href="#l1925"></a>
<span id="l1926">                    dout.writeUTF(ifaceNames[i]);</span><a href="#l1926"></a>
<span id="l1927">                }</span><a href="#l1927"></a>
<span id="l1928">            }</span><a href="#l1928"></a>
<span id="l1929"></span><a href="#l1929"></a>
<span id="l1930">            Field[] fields = cl.getDeclaredFields();</span><a href="#l1930"></a>
<span id="l1931">            MemberSignature[] fieldSigs = new MemberSignature[fields.length];</span><a href="#l1931"></a>
<span id="l1932">            for (int i = 0; i &lt; fields.length; i++) {</span><a href="#l1932"></a>
<span id="l1933">                fieldSigs[i] = new MemberSignature(fields[i]);</span><a href="#l1933"></a>
<span id="l1934">            }</span><a href="#l1934"></a>
<span id="l1935">            Arrays.sort(fieldSigs, new Comparator&lt;MemberSignature&gt;() {</span><a href="#l1935"></a>
<span id="l1936">                public int compare(MemberSignature ms1, MemberSignature ms2) {</span><a href="#l1936"></a>
<span id="l1937">                    return ms1.name.compareTo(ms2.name);</span><a href="#l1937"></a>
<span id="l1938">                }</span><a href="#l1938"></a>
<span id="l1939">            });</span><a href="#l1939"></a>
<span id="l1940">            for (int i = 0; i &lt; fieldSigs.length; i++) {</span><a href="#l1940"></a>
<span id="l1941">                MemberSignature sig = fieldSigs[i];</span><a href="#l1941"></a>
<span id="l1942">                int mods = sig.member.getModifiers() &amp;</span><a href="#l1942"></a>
<span id="l1943">                    (Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED |</span><a href="#l1943"></a>
<span id="l1944">                     Modifier.STATIC | Modifier.FINAL | Modifier.VOLATILE |</span><a href="#l1944"></a>
<span id="l1945">                     Modifier.TRANSIENT);</span><a href="#l1945"></a>
<span id="l1946">                if (((mods &amp; Modifier.PRIVATE) == 0) ||</span><a href="#l1946"></a>
<span id="l1947">                    ((mods &amp; (Modifier.STATIC | Modifier.TRANSIENT)) == 0))</span><a href="#l1947"></a>
<span id="l1948">                {</span><a href="#l1948"></a>
<span id="l1949">                    dout.writeUTF(sig.name);</span><a href="#l1949"></a>
<span id="l1950">                    dout.writeInt(mods);</span><a href="#l1950"></a>
<span id="l1951">                    dout.writeUTF(sig.signature);</span><a href="#l1951"></a>
<span id="l1952">                }</span><a href="#l1952"></a>
<span id="l1953">            }</span><a href="#l1953"></a>
<span id="l1954"></span><a href="#l1954"></a>
<span id="l1955">            if (hasStaticInitializer(cl)) {</span><a href="#l1955"></a>
<span id="l1956">                dout.writeUTF(&quot;&lt;clinit&gt;&quot;);</span><a href="#l1956"></a>
<span id="l1957">                dout.writeInt(Modifier.STATIC);</span><a href="#l1957"></a>
<span id="l1958">                dout.writeUTF(&quot;()V&quot;);</span><a href="#l1958"></a>
<span id="l1959">            }</span><a href="#l1959"></a>
<span id="l1960"></span><a href="#l1960"></a>
<span id="l1961">            Constructor[] cons = cl.getDeclaredConstructors();</span><a href="#l1961"></a>
<span id="l1962">            MemberSignature[] consSigs = new MemberSignature[cons.length];</span><a href="#l1962"></a>
<span id="l1963">            for (int i = 0; i &lt; cons.length; i++) {</span><a href="#l1963"></a>
<span id="l1964">                consSigs[i] = new MemberSignature(cons[i]);</span><a href="#l1964"></a>
<span id="l1965">            }</span><a href="#l1965"></a>
<span id="l1966">            Arrays.sort(consSigs, new Comparator&lt;MemberSignature&gt;() {</span><a href="#l1966"></a>
<span id="l1967">                public int compare(MemberSignature ms1, MemberSignature ms2) {</span><a href="#l1967"></a>
<span id="l1968">                    return ms1.signature.compareTo(ms2.signature);</span><a href="#l1968"></a>
<span id="l1969">                }</span><a href="#l1969"></a>
<span id="l1970">            });</span><a href="#l1970"></a>
<span id="l1971">            for (int i = 0; i &lt; consSigs.length; i++) {</span><a href="#l1971"></a>
<span id="l1972">                MemberSignature sig = consSigs[i];</span><a href="#l1972"></a>
<span id="l1973">                int mods = sig.member.getModifiers() &amp;</span><a href="#l1973"></a>
<span id="l1974">                    (Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED |</span><a href="#l1974"></a>
<span id="l1975">                     Modifier.STATIC | Modifier.FINAL |</span><a href="#l1975"></a>
<span id="l1976">                     Modifier.SYNCHRONIZED | Modifier.NATIVE |</span><a href="#l1976"></a>
<span id="l1977">                     Modifier.ABSTRACT | Modifier.STRICT);</span><a href="#l1977"></a>
<span id="l1978">                if ((mods &amp; Modifier.PRIVATE) == 0) {</span><a href="#l1978"></a>
<span id="l1979">                    dout.writeUTF(&quot;&lt;init&gt;&quot;);</span><a href="#l1979"></a>
<span id="l1980">                    dout.writeInt(mods);</span><a href="#l1980"></a>
<span id="l1981">                    dout.writeUTF(sig.signature.replace('/', '.'));</span><a href="#l1981"></a>
<span id="l1982">                }</span><a href="#l1982"></a>
<span id="l1983">            }</span><a href="#l1983"></a>
<span id="l1984"></span><a href="#l1984"></a>
<span id="l1985">            MemberSignature[] methSigs = new MemberSignature[methods.length];</span><a href="#l1985"></a>
<span id="l1986">            for (int i = 0; i &lt; methods.length; i++) {</span><a href="#l1986"></a>
<span id="l1987">                methSigs[i] = new MemberSignature(methods[i]);</span><a href="#l1987"></a>
<span id="l1988">            }</span><a href="#l1988"></a>
<span id="l1989">            Arrays.sort(methSigs, new Comparator&lt;MemberSignature&gt;() {</span><a href="#l1989"></a>
<span id="l1990">                public int compare(MemberSignature ms1, MemberSignature ms2) {</span><a href="#l1990"></a>
<span id="l1991">                    int comp = ms1.name.compareTo(ms2.name);</span><a href="#l1991"></a>
<span id="l1992">                    if (comp == 0) {</span><a href="#l1992"></a>
<span id="l1993">                        comp = ms1.signature.compareTo(ms2.signature);</span><a href="#l1993"></a>
<span id="l1994">                    }</span><a href="#l1994"></a>
<span id="l1995">                    return comp;</span><a href="#l1995"></a>
<span id="l1996">                }</span><a href="#l1996"></a>
<span id="l1997">            });</span><a href="#l1997"></a>
<span id="l1998">            for (int i = 0; i &lt; methSigs.length; i++) {</span><a href="#l1998"></a>
<span id="l1999">                MemberSignature sig = methSigs[i];</span><a href="#l1999"></a>
<span id="l2000">                int mods = sig.member.getModifiers() &amp;</span><a href="#l2000"></a>
<span id="l2001">                    (Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED |</span><a href="#l2001"></a>
<span id="l2002">                     Modifier.STATIC | Modifier.FINAL |</span><a href="#l2002"></a>
<span id="l2003">                     Modifier.SYNCHRONIZED | Modifier.NATIVE |</span><a href="#l2003"></a>
<span id="l2004">                     Modifier.ABSTRACT | Modifier.STRICT);</span><a href="#l2004"></a>
<span id="l2005">                if ((mods &amp; Modifier.PRIVATE) == 0) {</span><a href="#l2005"></a>
<span id="l2006">                    dout.writeUTF(sig.name);</span><a href="#l2006"></a>
<span id="l2007">                    dout.writeInt(mods);</span><a href="#l2007"></a>
<span id="l2008">                    dout.writeUTF(sig.signature.replace('/', '.'));</span><a href="#l2008"></a>
<span id="l2009">                }</span><a href="#l2009"></a>
<span id="l2010">            }</span><a href="#l2010"></a>
<span id="l2011"></span><a href="#l2011"></a>
<span id="l2012">            dout.flush();</span><a href="#l2012"></a>
<span id="l2013"></span><a href="#l2013"></a>
<span id="l2014">            MessageDigest md = MessageDigest.getInstance(&quot;SHA&quot;);</span><a href="#l2014"></a>
<span id="l2015">            byte[] hashBytes = md.digest(bout.toByteArray());</span><a href="#l2015"></a>
<span id="l2016">            long hash = 0;</span><a href="#l2016"></a>
<span id="l2017">            for (int i = Math.min(hashBytes.length, 8) - 1; i &gt;= 0; i--) {</span><a href="#l2017"></a>
<span id="l2018">                hash = (hash &lt;&lt; 8) | (hashBytes[i] &amp; 0xFF);</span><a href="#l2018"></a>
<span id="l2019">            }</span><a href="#l2019"></a>
<span id="l2020">            return hash;</span><a href="#l2020"></a>
<span id="l2021">        } catch (IOException ex) {</span><a href="#l2021"></a>
<span id="l2022">            throw new InternalError();</span><a href="#l2022"></a>
<span id="l2023">        } catch (NoSuchAlgorithmException ex) {</span><a href="#l2023"></a>
<span id="l2024">            throw new SecurityException(ex.getMessage());</span><a href="#l2024"></a>
...
<span id="l2029">     * Returns true if the given class defines a static initializer method,</span><a href="#l2029"></a>
<span id="l2030">     * false otherwise.</span><a href="#l2030"></a>
<span id="l2031">     */</span><a href="#l2031"></a>
<span id="l2032">    private native static boolean hasStaticInitializer(Class&lt;?&gt; cl);</span><a href="#l2032"></a>
<span id="l2033"></span><a href="#l2033"></a>
<span id="l2034">    /**</span><a href="#l2034"></a>
<span id="l2035">     * Class for computing and caching field/constructor/method signatures</span><a href="#l2035"></a>
<span id="l2036">     * during serialVersionUID calculation.</span><a href="#l2036"></a>
<span id="l2037">     */</span><a href="#l2037"></a>
<span id="l2038">    private static class MemberSignature {</span><a href="#l2038"></a>
<span id="l2039"></span><a href="#l2039"></a>
<span id="l2040">        public final Member member;</span><a href="#l2040"></a>
<span id="l2041">        public final String name;</span><a href="#l2041"></a>
<span id="l2042">        public final String signature;</span><a href="#l2042"></a>
<span id="l2043"></span><a href="#l2043"></a>
<span id="l2044">        public MemberSignature(Field field) {</span><a href="#l2044"></a>
<span id="l2045">            member = field;</span><a href="#l2045"></a>
<span id="l2046">            name = field.getName();</span><a href="#l2046"></a>
<span id="l2047">            signature = getClassSignature(field.getType());</span><a href="#l2047"></a>
<span id="l2048">        }</span><a href="#l2048"></a>
<span id="l2049"></span><a href="#l2049"></a>
<span id="l2050">        public MemberSignature(Constructor cons) {</span><a href="#l2050"></a>
<span id="l2051">            member = cons;</span><a href="#l2051"></a>
<span id="l2052">            name = cons.getName();</span><a href="#l2052"></a>
<span id="l2053">            signature = getMethodSignature(</span><a href="#l2053"></a>
<span id="l2054">                cons.getParameterTypes(), Void.TYPE);</span><a href="#l2054"></a>
<span id="l2055">        }</span><a href="#l2055"></a>
<span id="l2056"></span><a href="#l2056"></a>
<span id="l2057">        public MemberSignature(Method meth) {</span><a href="#l2057"></a>
<span id="l2058">            member = meth;</span><a href="#l2058"></a>
<span id="l2059">            name = meth.getName();</span><a href="#l2059"></a>
<span id="l2060">            signature = getMethodSignature(</span><a href="#l2060"></a>
<span id="l2061">                meth.getParameterTypes(), meth.getReturnType());</span><a href="#l2061"></a>
...
<span id="l2066">     * Class for setting and retrieving serializable field values in batch.</span><a href="#l2066"></a>
<span id="l2067">     */</span><a href="#l2067"></a>
<span id="l2068">    // REMIND: dynamically generate these?</span><a href="#l2068"></a>
<span id="l2069">    private static class FieldReflector {</span><a href="#l2069"></a>
<span id="l2070"></span><a href="#l2070"></a>
<span id="l2071">        /** handle for performing unsafe operations */</span><a href="#l2071"></a>
<span id="l2072">        private static final Unsafe unsafe = Unsafe.getUnsafe();</span><a href="#l2072"></a>
<span id="l2073"></span><a href="#l2073"></a>
<span id="l2074">        /** fields to operate on */</span><a href="#l2074"></a>
<span id="l2075">        private final ObjectStreamField[] fields;</span><a href="#l2075"></a>
<span id="l2076">        /** number of primitive fields */</span><a href="#l2076"></a>
<span id="l2077">        private final int numPrimFields;</span><a href="#l2077"></a>
<span id="l2078">        /** unsafe field keys for reading fields - may contain dupes */</span><a href="#l2078"></a>
<span id="l2079">        private final long[] readKeys;</span><a href="#l2079"></a>
<span id="l2080">        /** unsafe fields keys for writing fields - no dupes */</span><a href="#l2080"></a>
<span id="l2081">        private final long[] writeKeys;</span><a href="#l2081"></a>
<span id="l2082">        /** field data offsets */</span><a href="#l2082"></a>
<span id="l2083">        private final int[] offsets;</span><a href="#l2083"></a>
<span id="l2084">        /** field type codes */</span><a href="#l2084"></a>
<span id="l2085">        private final char[] typeCodes;</span><a href="#l2085"></a>
<span id="l2086">        /** field types */</span><a href="#l2086"></a>
<span id="l2087">        private final Class&lt;?&gt;[] types;</span><a href="#l2087"></a>
<span id="l2088"></span><a href="#l2088"></a>
<span id="l2089">        /**</span><a href="#l2089"></a>
<span id="l2090">         * Constructs FieldReflector capable of setting/getting values from the</span><a href="#l2090"></a>
<span id="l2091">         * subset of fields whose ObjectStreamFields contain non-null</span><a href="#l2091"></a>
<span id="l2092">         * reflective Field objects.  ObjectStreamFields with null Fields are</span><a href="#l2092"></a>
<span id="l2093">         * treated as filler, for which get operations return default values</span><a href="#l2093"></a>
<span id="l2094">         * and set operations discard given values.</span><a href="#l2094"></a>
<span id="l2095">         */</span><a href="#l2095"></a>
<span id="l2096">        FieldReflector(ObjectStreamField[] fields) {</span><a href="#l2096"></a>
<span id="l2097">            this.fields = fields;</span><a href="#l2097"></a>
<span id="l2098">            int nfields = fields.length;</span><a href="#l2098"></a>
<span id="l2099">            readKeys = new long[nfields];</span><a href="#l2099"></a>
<span id="l2100">            writeKeys = new long[nfields];</span><a href="#l2100"></a>
<span id="l2101">            offsets = new int[nfields];</span><a href="#l2101"></a>
<span id="l2102">            typeCodes = new char[nfields];</span><a href="#l2102"></a>
<span id="l2103">            ArrayList&lt;Class&lt;?&gt;&gt; typeList = new ArrayList&lt;&gt;();</span><a href="#l2103"></a>
<span id="l2104">            Set&lt;Long&gt; usedKeys = new HashSet&lt;&gt;();</span><a href="#l2104"></a>
<span id="l2105"></span><a href="#l2105"></a>
<span id="l2106"></span><a href="#l2106"></a>
<span id="l2107">            for (int i = 0; i &lt; nfields; i++) {</span><a href="#l2107"></a>
<span id="l2108">                ObjectStreamField f = fields[i];</span><a href="#l2108"></a>
<span id="l2109">                Field rf = f.getField();</span><a href="#l2109"></a>
<span id="l2110">                long key = (rf != null) ?</span><a href="#l2110"></a>
<span id="l2111">                    unsafe.objectFieldOffset(rf) : Unsafe.INVALID_FIELD_OFFSET;</span><a href="#l2111"></a>
<span id="l2112">                readKeys[i] = key;</span><a href="#l2112"></a>
<span id="l2113">                writeKeys[i] = usedKeys.add(key) ?</span><a href="#l2113"></a>
<span id="l2114">                    key : Unsafe.INVALID_FIELD_OFFSET;</span><a href="#l2114"></a>
<span id="l2115">                offsets[i] = f.getOffset();</span><a href="#l2115"></a>
<span id="l2116">                typeCodes[i] = f.getTypeCode();</span><a href="#l2116"></a>
<span id="l2117">                if (!f.isPrimitive()) {</span><a href="#l2117"></a>
<span id="l2118">                    typeList.add((rf != null) ? rf.getType() : null);</span><a href="#l2118"></a>
<span id="l2119">                }</span><a href="#l2119"></a>
<span id="l2120">            }</span><a href="#l2120"></a>
<span id="l2121"></span><a href="#l2121"></a>
<span id="l2122">            types = typeList.toArray(new Class&lt;?&gt;[typeList.size()]);</span><a href="#l2122"></a>
<span id="l2123">            numPrimFields = nfields - types.length;</span><a href="#l2123"></a>
<span id="l2124">        }</span><a href="#l2124"></a>
<span id="l2125"></span><a href="#l2125"></a>
<span id="l2126">        /**</span><a href="#l2126"></a>
<span id="l2127">         * Returns list of ObjectStreamFields representing fields operated on</span><a href="#l2127"></a>
<span id="l2128">         * by this reflector.  The shared/unshared values and Field objects</span><a href="#l2128"></a>
<span id="l2129">         * contained by ObjectStreamFields in the list reflect their bindings</span><a href="#l2129"></a>
<span id="l2130">         * to locally defined serializable fields.</span><a href="#l2130"></a>
<span id="l2131">         */</span><a href="#l2131"></a>
<span id="l2132">        ObjectStreamField[] getFields() {</span><a href="#l2132"></a>
<span id="l2133">            return fields;</span><a href="#l2133"></a>
<span id="l2134">        }</span><a href="#l2134"></a>
<span id="l2135"></span><a href="#l2135"></a>
<span id="l2136">        /**</span><a href="#l2136"></a>
<span id="l2137">         * Fetches the serializable primitive field values of object obj and</span><a href="#l2137"></a>
<span id="l2138">         * marshals them into byte array buf starting at offset 0.  The caller</span><a href="#l2138"></a>
<span id="l2139">         * is responsible for ensuring that obj is of the proper type.</span><a href="#l2139"></a>
<span id="l2140">         */</span><a href="#l2140"></a>
<span id="l2141">        void getPrimFieldValues(Object obj, byte[] buf) {</span><a href="#l2141"></a>
<span id="l2142">            if (obj == null) {</span><a href="#l2142"></a>
<span id="l2143">                throw new NullPointerException();</span><a href="#l2143"></a>
<span id="l2144">            }</span><a href="#l2144"></a>
<span id="l2145">            /* assuming checkDefaultSerialize() has been called on the class</span><a href="#l2145"></a>
<span id="l2146">             * descriptor this FieldReflector was obtained from, no field keys</span><a href="#l2146"></a>
<span id="l2147">             * in array should be equal to Unsafe.INVALID_FIELD_OFFSET.</span><a href="#l2147"></a>
<span id="l2148">             */</span><a href="#l2148"></a>
<span id="l2149">            for (int i = 0; i &lt; numPrimFields; i++) {</span><a href="#l2149"></a>
<span id="l2150">                long key = readKeys[i];</span><a href="#l2150"></a>
<span id="l2151">                int off = offsets[i];</span><a href="#l2151"></a>
<span id="l2152">                switch (typeCodes[i]) {</span><a href="#l2152"></a>
<span id="l2153">                    case 'Z':</span><a href="#l2153"></a>
<span id="l2154">                        Bits.putBoolean(buf, off, unsafe.getBoolean(obj, key));</span><a href="#l2154"></a>
<span id="l2155">                        break;</span><a href="#l2155"></a>
<span id="l2156"></span><a href="#l2156"></a>
<span id="l2157">                    case 'B':</span><a href="#l2157"></a>
<span id="l2158">                        buf[off] = unsafe.getByte(obj, key);</span><a href="#l2158"></a>
<span id="l2159">                        break;</span><a href="#l2159"></a>
<span id="l2160"></span><a href="#l2160"></a>
<span id="l2161">                    case 'C':</span><a href="#l2161"></a>
<span id="l2162">                        Bits.putChar(buf, off, unsafe.getChar(obj, key));</span><a href="#l2162"></a>
<span id="l2163">                        break;</span><a href="#l2163"></a>
<span id="l2164"></span><a href="#l2164"></a>
<span id="l2165">                    case 'S':</span><a href="#l2165"></a>
<span id="l2166">                        Bits.putShort(buf, off, unsafe.getShort(obj, key));</span><a href="#l2166"></a>
<span id="l2167">                        break;</span><a href="#l2167"></a>
<span id="l2168"></span><a href="#l2168"></a>
<span id="l2169">                    case 'I':</span><a href="#l2169"></a>
<span id="l2170">                        Bits.putInt(buf, off, unsafe.getInt(obj, key));</span><a href="#l2170"></a>
<span id="l2171">                        break;</span><a href="#l2171"></a>
<span id="l2172"></span><a href="#l2172"></a>
<span id="l2173">                    case 'F':</span><a href="#l2173"></a>
<span id="l2174">                        Bits.putFloat(buf, off, unsafe.getFloat(obj, key));</span><a href="#l2174"></a>
<span id="l2175">                        break;</span><a href="#l2175"></a>
<span id="l2176"></span><a href="#l2176"></a>
<span id="l2177">                    case 'J':</span><a href="#l2177"></a>
<span id="l2178">                        Bits.putLong(buf, off, unsafe.getLong(obj, key));</span><a href="#l2178"></a>
<span id="l2179">                        break;</span><a href="#l2179"></a>
<span id="l2180"></span><a href="#l2180"></a>
<span id="l2181">                    case 'D':</span><a href="#l2181"></a>
<span id="l2182">                        Bits.putDouble(buf, off, unsafe.getDouble(obj, key));</span><a href="#l2182"></a>
<span id="l2183">                        break;</span><a href="#l2183"></a>
<span id="l2184"></span><a href="#l2184"></a>
<span id="l2185">                    default:</span><a href="#l2185"></a>
<span id="l2186">                        throw new InternalError();</span><a href="#l2186"></a>
...
<span id="l2192">         * Sets the serializable primitive fields of object obj using values</span><a href="#l2192"></a>
<span id="l2193">         * unmarshalled from byte array buf starting at offset 0.  The caller</span><a href="#l2193"></a>
<span id="l2194">         * is responsible for ensuring that obj is of the proper type.</span><a href="#l2194"></a>
<span id="l2195">         */</span><a href="#l2195"></a>
<span id="l2196">        void setPrimFieldValues(Object obj, byte[] buf) {</span><a href="#l2196"></a>
<span id="l2197">            if (obj == null) {</span><a href="#l2197"></a>
<span id="l2198">                throw new NullPointerException();</span><a href="#l2198"></a>
<span id="l2199">            }</span><a href="#l2199"></a>
<span id="l2200">            for (int i = 0; i &lt; numPrimFields; i++) {</span><a href="#l2200"></a>
<span id="l2201">                long key = writeKeys[i];</span><a href="#l2201"></a>
<span id="l2202">                if (key == Unsafe.INVALID_FIELD_OFFSET) {</span><a href="#l2202"></a>
<span id="l2203">                    continue;           // discard value</span><a href="#l2203"></a>
<span id="l2204">                }</span><a href="#l2204"></a>
<span id="l2205">                int off = offsets[i];</span><a href="#l2205"></a>
<span id="l2206">                switch (typeCodes[i]) {</span><a href="#l2206"></a>
<span id="l2207">                    case 'Z':</span><a href="#l2207"></a>
<span id="l2208">                        unsafe.putBoolean(obj, key, Bits.getBoolean(buf, off));</span><a href="#l2208"></a>
<span id="l2209">                        break;</span><a href="#l2209"></a>
<span id="l2210"></span><a href="#l2210"></a>
<span id="l2211">                    case 'B':</span><a href="#l2211"></a>
<span id="l2212">                        unsafe.putByte(obj, key, buf[off]);</span><a href="#l2212"></a>
<span id="l2213">                        break;</span><a href="#l2213"></a>
<span id="l2214"></span><a href="#l2214"></a>
<span id="l2215">                    case 'C':</span><a href="#l2215"></a>
<span id="l2216">                        unsafe.putChar(obj, key, Bits.getChar(buf, off));</span><a href="#l2216"></a>
<span id="l2217">                        break;</span><a href="#l2217"></a>
<span id="l2218"></span><a href="#l2218"></a>
<span id="l2219">                    case 'S':</span><a href="#l2219"></a>
<span id="l2220">                        unsafe.putShort(obj, key, Bits.getShort(buf, off));</span><a href="#l2220"></a>
<span id="l2221">                        break;</span><a href="#l2221"></a>
<span id="l2222"></span><a href="#l2222"></a>
<span id="l2223">                    case 'I':</span><a href="#l2223"></a>
<span id="l2224">                        unsafe.putInt(obj, key, Bits.getInt(buf, off));</span><a href="#l2224"></a>
<span id="l2225">                        break;</span><a href="#l2225"></a>
<span id="l2226"></span><a href="#l2226"></a>
<span id="l2227">                    case 'F':</span><a href="#l2227"></a>
<span id="l2228">                        unsafe.putFloat(obj, key, Bits.getFloat(buf, off));</span><a href="#l2228"></a>
<span id="l2229">                        break;</span><a href="#l2229"></a>
<span id="l2230"></span><a href="#l2230"></a>
<span id="l2231">                    case 'J':</span><a href="#l2231"></a>
<span id="l2232">                        unsafe.putLong(obj, key, Bits.getLong(buf, off));</span><a href="#l2232"></a>
<span id="l2233">                        break;</span><a href="#l2233"></a>
<span id="l2234"></span><a href="#l2234"></a>
<span id="l2235">                    case 'D':</span><a href="#l2235"></a>
<span id="l2236">                        unsafe.putDouble(obj, key, Bits.getDouble(buf, off));</span><a href="#l2236"></a>
<span id="l2237">                        break;</span><a href="#l2237"></a>
<span id="l2238"></span><a href="#l2238"></a>
<span id="l2239">                    default:</span><a href="#l2239"></a>
<span id="l2240">                        throw new InternalError();</span><a href="#l2240"></a>
...
<span id="l2245">        /**</span><a href="#l2245"></a>
<span id="l2246">         * Fetches the serializable object field values of object obj and</span><a href="#l2246"></a>
<span id="l2247">         * stores them in array vals starting at offset 0.  The caller is</span><a href="#l2247"></a>
<span id="l2248">         * responsible for ensuring that obj is of the proper type.</span><a href="#l2248"></a>
<span id="l2249">         */</span><a href="#l2249"></a>
<span id="l2250">        void getObjFieldValues(Object obj, Object[] vals) {</span><a href="#l2250"></a>
<span id="l2251">            if (obj == null) {</span><a href="#l2251"></a>
<span id="l2252">                throw new NullPointerException();</span><a href="#l2252"></a>
<span id="l2253">            }</span><a href="#l2253"></a>
<span id="l2254">            /* assuming checkDefaultSerialize() has been called on the class</span><a href="#l2254"></a>
<span id="l2255">             * descriptor this FieldReflector was obtained from, no field keys</span><a href="#l2255"></a>
<span id="l2256">             * in array should be equal to Unsafe.INVALID_FIELD_OFFSET.</span><a href="#l2256"></a>
<span id="l2257">             */</span><a href="#l2257"></a>
<span id="l2258">            for (int i = numPrimFields; i &lt; fields.length; i++) {</span><a href="#l2258"></a>
<span id="l2259">                switch (typeCodes[i]) {</span><a href="#l2259"></a>
<span id="l2260">                    case 'L':</span><a href="#l2260"></a>
<span id="l2261">                    case '[':</span><a href="#l2261"></a>
<span id="l2262">                        vals[offsets[i]] = unsafe.getObject(obj, readKeys[i]);</span><a href="#l2262"></a>
<span id="l2263">                        break;</span><a href="#l2263"></a>
<span id="l2264"></span><a href="#l2264"></a>
<span id="l2265">                    default:</span><a href="#l2265"></a>
<span id="l2266">                        throw new InternalError();</span><a href="#l2266"></a>
...
<span id="l2272">         * Sets the serializable object fields of object obj using values from</span><a href="#l2272"></a>
<span id="l2273">         * array vals starting at offset 0.  The caller is responsible for</span><a href="#l2273"></a>
<span id="l2274">         * ensuring that obj is of the proper type; however, attempts to set a</span><a href="#l2274"></a>
<span id="l2275">         * field with a value of the wrong type will trigger an appropriate</span><a href="#l2275"></a>
<span id="l2276">         * ClassCastException.</span><a href="#l2276"></a>
<span id="l2277">         */</span><a href="#l2277"></a>
<span id="l2278">        void setObjFieldValues(Object obj, Object[] vals) {</span><a href="#l2278"></a>
<span id="l2279">            if (obj == null) {</span><a href="#l2279"></a>
<span id="l2280">                throw new NullPointerException();</span><a href="#l2280"></a>
<span id="l2281">            }</span><a href="#l2281"></a>
<span id="l2282">            for (int i = numPrimFields; i &lt; fields.length; i++) {</span><a href="#l2282"></a>
<span id="l2283">                long key = writeKeys[i];</span><a href="#l2283"></a>
<span id="l2284">                if (key == Unsafe.INVALID_FIELD_OFFSET) {</span><a href="#l2284"></a>
<span id="l2285">                    continue;           // discard value</span><a href="#l2285"></a>
<span id="l2286">                }</span><a href="#l2286"></a>
<span id="l2287">                switch (typeCodes[i]) {</span><a href="#l2287"></a>
<span id="l2288">                    case 'L':</span><a href="#l2288"></a>
<span id="l2289">                    case '[':</span><a href="#l2289"></a>
<span id="l2290">                        Object val = vals[offsets[i]];</span><a href="#l2290"></a>
<span id="l2291">                        if (val != null &amp;&amp;</span><a href="#l2291"></a>
<span id="l2292">                            !types[i - numPrimFields].isInstance(val))</span><a href="#l2292"></a>
<span id="l2293">                        {</span><a href="#l2293"></a>
<span id="l2294">                            Field f = fields[i].getField();</span><a href="#l2294"></a>
<span id="l2295">                            throw new ClassCastException(</span><a href="#l2295"></a>
<span id="l2296">                                &quot;cannot assign instance of &quot; +</span><a href="#l2296"></a>
<span id="l2297">                                val.getClass().getName() + &quot; to field &quot; +</span><a href="#l2297"></a>
<span id="l2298">                                f.getDeclaringClass().getName() + &quot;.&quot; +</span><a href="#l2298"></a>
<span id="l2299">                                f.getName() + &quot; of type &quot; +</span><a href="#l2299"></a>
<span id="l2300">                                f.getType().getName() + &quot; in instance of &quot; +</span><a href="#l2300"></a>
<span id="l2301">                                obj.getClass().getName());</span><a href="#l2301"></a>
<span id="l2302">                        }</span><a href="#l2302"></a>
<span id="l2303">                        unsafe.putObject(obj, key, val);</span><a href="#l2303"></a>
<span id="l2304">                        break;</span><a href="#l2304"></a>
<span id="l2305"></span><a href="#l2305"></a>
<span id="l2306">                    default:</span><a href="#l2306"></a>
<span id="l2307">                        throw new InternalError();</span><a href="#l2307"></a>
...
<span id="l2314">     * Matches given set of serializable fields with serializable fields</span><a href="#l2314"></a>
<span id="l2315">     * described by the given local class descriptor, and returns a</span><a href="#l2315"></a>
<span id="l2316">     * FieldReflector instance capable of setting/getting values from the</span><a href="#l2316"></a>
<span id="l2317">     * subset of fields that match (non-matching fields are treated as filler,</span><a href="#l2317"></a>
<span id="l2318">     * for which get operations return default values and set operations</span><a href="#l2318"></a>
<span id="l2319">     * discard given values).  Throws InvalidClassException if unresolvable</span><a href="#l2319"></a>
<span id="l2320">     * type conflicts exist between the two sets of fields.</span><a href="#l2320"></a>
<span id="l2321">     */</span><a href="#l2321"></a>
<span id="l2322">    private static FieldReflector getReflector(ObjectStreamField[] fields,</span><a href="#l2322"></a>
<span id="l2323">                                               ObjectStreamClass localDesc)</span><a href="#l2323"></a>
<span id="l2324">        throws InvalidClassException</span><a href="#l2324"></a>
<span id="l2325">    {</span><a href="#l2325"></a>
<span id="l2326">        // class irrelevant if no fields</span><a href="#l2326"></a>
<span id="l2327">        Class&lt;?&gt; cl = (localDesc != null &amp;&amp; fields.length &gt; 0) ?</span><a href="#l2327"></a>
<span id="l2328">            localDesc.cl : null;</span><a href="#l2328"></a>
<span id="l2329">        processQueue(Caches.reflectorsQueue, Caches.reflectors);</span><a href="#l2329"></a>
<span id="l2330">        FieldReflectorKey key = new FieldReflectorKey(cl, fields,</span><a href="#l2330"></a>
<span id="l2331">                                                      Caches.reflectorsQueue);</span><a href="#l2331"></a>
<span id="l2332">        Reference&lt;?&gt; ref = Caches.reflectors.get(key);</span><a href="#l2332"></a>
<span id="l2333">        Object entry = null;</span><a href="#l2333"></a>
<span id="l2334">        if (ref != null) {</span><a href="#l2334"></a>
<span id="l2335">            entry = ref.get();</span><a href="#l2335"></a>
<span id="l2336">        }</span><a href="#l2336"></a>
<span id="l2337">        EntryFuture future = null;</span><a href="#l2337"></a>
<span id="l2338">        if (entry == null) {</span><a href="#l2338"></a>
<span id="l2339">            EntryFuture newEntry = new EntryFuture();</span><a href="#l2339"></a>
<span id="l2340">            Reference&lt;?&gt; newRef = new SoftReference&lt;&gt;(newEntry);</span><a href="#l2340"></a>
<span id="l2341">            do {</span><a href="#l2341"></a>
<span id="l2342">                if (ref != null) {</span><a href="#l2342"></a>
<span id="l2343">                    Caches.reflectors.remove(key, ref);</span><a href="#l2343"></a>
<span id="l2344">                }</span><a href="#l2344"></a>
<span id="l2345">                ref = Caches.reflectors.putIfAbsent(key, newRef);</span><a href="#l2345"></a>
<span id="l2346">                if (ref != null) {</span><a href="#l2346"></a>
<span id="l2347">                    entry = ref.get();</span><a href="#l2347"></a>
<span id="l2348">                }</span><a href="#l2348"></a>
<span id="l2349">            } while (ref != null &amp;&amp; entry == null);</span><a href="#l2349"></a>
<span id="l2350">            if (entry == null) {</span><a href="#l2350"></a>
<span id="l2351">                future = newEntry;</span><a href="#l2351"></a>
<span id="l2352">            }</span><a href="#l2352"></a>
<span id="l2353">        }</span><a href="#l2353"></a>
<span id="l2354"></span><a href="#l2354"></a>
<span id="l2355">        if (entry instanceof FieldReflector) {  // check common case first</span><a href="#l2355"></a>
<span id="l2356">            return (FieldReflector) entry;</span><a href="#l2356"></a>
<span id="l2357">        } else if (entry instanceof EntryFuture) {</span><a href="#l2357"></a>
<span id="l2358">            entry = ((EntryFuture) entry).get();</span><a href="#l2358"></a>
<span id="l2359">        } else if (entry == null) {</span><a href="#l2359"></a>
<span id="l2360">            try {</span><a href="#l2360"></a>
<span id="l2361">                entry = new FieldReflector(matchFields(fields, localDesc));</span><a href="#l2361"></a>
<span id="l2362">            } catch (Throwable th) {</span><a href="#l2362"></a>
<span id="l2363">                entry = th;</span><a href="#l2363"></a>
<span id="l2364">            }</span><a href="#l2364"></a>
<span id="l2365">            future.set(entry);</span><a href="#l2365"></a>
<span id="l2366">            Caches.reflectors.put(key, new SoftReference&lt;Object&gt;(entry));</span><a href="#l2366"></a>
<span id="l2367">        }</span><a href="#l2367"></a>
<span id="l2368"></span><a href="#l2368"></a>
<span id="l2369">        if (entry instanceof FieldReflector) {</span><a href="#l2369"></a>
<span id="l2370">            return (FieldReflector) entry;</span><a href="#l2370"></a>
<span id="l2371">        } else if (entry instanceof InvalidClassException) {</span><a href="#l2371"></a>
<span id="l2372">            throw (InvalidClassException) entry;</span><a href="#l2372"></a>
<span id="l2373">        } else if (entry instanceof RuntimeException) {</span><a href="#l2373"></a>
<span id="l2374">            throw (RuntimeException) entry;</span><a href="#l2374"></a>
<span id="l2375">        } else if (entry instanceof Error) {</span><a href="#l2375"></a>
<span id="l2376">            throw (Error) entry;</span><a href="#l2376"></a>
<span id="l2377">        } else {</span><a href="#l2377"></a>
<span id="l2378">            throw new InternalError(&quot;unexpected entry: &quot; + entry);</span><a href="#l2378"></a>
...
<span id="l2383">     * FieldReflector cache lookup key.  Keys are considered equal if they</span><a href="#l2383"></a>
<span id="l2384">     * refer to the same class and equivalent field formats.</span><a href="#l2384"></a>
<span id="l2385">     */</span><a href="#l2385"></a>
<span id="l2386">    private static class FieldReflectorKey extends WeakReference&lt;Class&lt;?&gt;&gt; {</span><a href="#l2386"></a>
<span id="l2387"></span><a href="#l2387"></a>
<span id="l2388">        private final String sigs;</span><a href="#l2388"></a>
<span id="l2389">        private final int hash;</span><a href="#l2389"></a>
<span id="l2390">        private final boolean nullClass;</span><a href="#l2390"></a>
<span id="l2391"></span><a href="#l2391"></a>
<span id="l2392">        FieldReflectorKey(Class&lt;?&gt; cl, ObjectStreamField[] fields,</span><a href="#l2392"></a>
<span id="l2393">                          ReferenceQueue&lt;Class&lt;?&gt;&gt; queue)</span><a href="#l2393"></a>
<span id="l2394">        {</span><a href="#l2394"></a>
<span id="l2395">            super(cl, queue);</span><a href="#l2395"></a>
<span id="l2396">            nullClass = (cl == null);</span><a href="#l2396"></a>
<span id="l2397">            StringBuilder sbuf = new StringBuilder();</span><a href="#l2397"></a>
<span id="l2398">            for (int i = 0; i &lt; fields.length; i++) {</span><a href="#l2398"></a>
<span id="l2399">                ObjectStreamField f = fields[i];</span><a href="#l2399"></a>
<span id="l2400">                sbuf.append(f.getName()).append(f.getSignature());</span><a href="#l2400"></a>
<span id="l2401">            }</span><a href="#l2401"></a>
<span id="l2402">            sigs = sbuf.toString();</span><a href="#l2402"></a>
<span id="l2403">            hash = System.identityHashCode(cl) + sigs.hashCode();</span><a href="#l2403"></a>
<span id="l2404">        }</span><a href="#l2404"></a>
<span id="l2405"></span><a href="#l2405"></a>
<span id="l2406">        public int hashCode() {</span><a href="#l2406"></a>
<span id="l2407">            return hash;</span><a href="#l2407"></a>
<span id="l2408">        }</span><a href="#l2408"></a>
<span id="l2409"></span><a href="#l2409"></a>
<span id="l2410">        public boolean equals(Object obj) {</span><a href="#l2410"></a>
<span id="l2411">            if (obj == this) {</span><a href="#l2411"></a>
<span id="l2412">                return true;</span><a href="#l2412"></a>
<span id="l2413">            }</span><a href="#l2413"></a>
<span id="l2414"></span><a href="#l2414"></a>
<span id="l2415">            if (obj instanceof FieldReflectorKey) {</span><a href="#l2415"></a>
<span id="l2416">                FieldReflectorKey other = (FieldReflectorKey) obj;</span><a href="#l2416"></a>
<span id="l2417">                Class&lt;?&gt; referent;</span><a href="#l2417"></a>
<span id="l2418">                return (nullClass ? other.nullClass</span><a href="#l2418"></a>
<span id="l2419">                                  : ((referent = get()) != null) &amp;&amp;</span><a href="#l2419"></a>
<span id="l2420">                                    (referent == other.get())) &amp;&amp;</span><a href="#l2420"></a>
<span id="l2421">                    sigs.equals(other.sigs);</span><a href="#l2421"></a>
<span id="l2422">            } else {</span><a href="#l2422"></a>
<span id="l2423">                return false;</span><a href="#l2423"></a>
...
<span id="l2429">     * Matches given set of serializable fields with serializable fields</span><a href="#l2429"></a>
<span id="l2430">     * obtained from the given local class descriptor (which contain bindings</span><a href="#l2430"></a>
<span id="l2431">     * to reflective Field objects).  Returns list of ObjectStreamFields in</span><a href="#l2431"></a>
<span id="l2432">     * which each ObjectStreamField whose signature matches that of a local</span><a href="#l2432"></a>
<span id="l2433">     * field contains a Field object for that field; unmatched</span><a href="#l2433"></a>
<span id="l2434">     * ObjectStreamFields contain null Field objects.  Shared/unshared settings</span><a href="#l2434"></a>
<span id="l2435">     * of the returned ObjectStreamFields also reflect those of matched local</span><a href="#l2435"></a>
<span id="l2436">     * ObjectStreamFields.  Throws InvalidClassException if unresolvable type</span><a href="#l2436"></a>
<span id="l2437">     * conflicts exist between the two sets of fields.</span><a href="#l2437"></a>
<span id="l2438">     */</span><a href="#l2438"></a>
<span id="l2439">    private static ObjectStreamField[] matchFields(ObjectStreamField[] fields,</span><a href="#l2439"></a>
<span id="l2440">                                                   ObjectStreamClass localDesc)</span><a href="#l2440"></a>
<span id="l2441">        throws InvalidClassException</span><a href="#l2441"></a>
<span id="l2442">    {</span><a href="#l2442"></a>
<span id="l2443">        ObjectStreamField[] localFields = (localDesc != null) ?</span><a href="#l2443"></a>
<span id="l2444">            localDesc.fields : NO_FIELDS;</span><a href="#l2444"></a>
<span id="l2445"></span><a href="#l2445"></a>
<span id="l2446">        /*</span><a href="#l2446"></a>
<span id="l2447">         * Even if fields == localFields, we cannot simply return localFields</span><a href="#l2447"></a>
<span id="l2448">         * here.  In previous implementations of serialization,</span><a href="#l2448"></a>
<span id="l2449">         * ObjectStreamField.getType() returned Object.class if the</span><a href="#l2449"></a>
<span id="l2450">         * ObjectStreamField represented a non-primitive field and belonged to</span><a href="#l2450"></a>
<span id="l2451">         * a non-local class descriptor.  To preserve this (questionable)</span><a href="#l2451"></a>
<span id="l2452">         * behavior, the ObjectStreamField instances returned by matchFields</span><a href="#l2452"></a>
<span id="l2453">         * cannot report non-primitive types other than Object.class; hence</span><a href="#l2453"></a>
<span id="l2454">         * localFields cannot be returned directly.</span><a href="#l2454"></a>
<span id="l2455">         */</span><a href="#l2455"></a>
<span id="l2456"></span><a href="#l2456"></a>
<span id="l2457">        ObjectStreamField[] matches = new ObjectStreamField[fields.length];</span><a href="#l2457"></a>
<span id="l2458">        for (int i = 0; i &lt; fields.length; i++) {</span><a href="#l2458"></a>
<span id="l2459">            ObjectStreamField f = fields[i], m = null;</span><a href="#l2459"></a>
<span id="l2460">            for (int j = 0; j &lt; localFields.length; j++) {</span><a href="#l2460"></a>
<span id="l2461">                ObjectStreamField lf = localFields[j];</span><a href="#l2461"></a>
<span id="l2462">                if (f.getName().equals(lf.getName())) {</span><a href="#l2462"></a>
<span id="l2463">                    if ((f.isPrimitive() || lf.isPrimitive()) &amp;&amp;</span><a href="#l2463"></a>
<span id="l2464">                        f.getTypeCode() != lf.getTypeCode())</span><a href="#l2464"></a>
<span id="l2465">                    {</span><a href="#l2465"></a>
<span id="l2466">                        throw new InvalidClassException(localDesc.name,</span><a href="#l2466"></a>
<span id="l2467">                            &quot;incompatible types for field &quot; + f.getName());</span><a href="#l2467"></a>
<span id="l2468">                    }</span><a href="#l2468"></a>
<span id="l2469">                    if (lf.getField() != null) {</span><a href="#l2469"></a>
<span id="l2470">                        m = new ObjectStreamField(</span><a href="#l2470"></a>
<span id="l2471">                            lf.getField(), lf.isUnshared(), false);</span><a href="#l2471"></a>
<span id="l2472">                    } else {</span><a href="#l2472"></a>
<span id="l2473">                        m = new ObjectStreamField(</span><a href="#l2473"></a>
<span id="l2474">                            lf.getName(), lf.getSignature(), lf.isUnshared());</span><a href="#l2474"></a>
<span id="l2475">                    }</span><a href="#l2475"></a>
<span id="l2476">                }</span><a href="#l2476"></a>
<span id="l2477">            }</span><a href="#l2477"></a>
<span id="l2478">            if (m == null) {</span><a href="#l2478"></a>
<span id="l2479">                m = new ObjectStreamField(</span><a href="#l2479"></a>
<span id="l2480">                    f.getName(), f.getSignature(), false);</span><a href="#l2480"></a>
<span id="l2481">            }</span><a href="#l2481"></a>
<span id="l2482">            m.setOffset(f.getOffset());</span><a href="#l2482"></a>
<span id="l2483">            matches[i] = m;</span><a href="#l2483"></a>
<span id="l2484">        }</span><a href="#l2484"></a>
<span id="l2485">        return matches;</span><a href="#l2485"></a>
<span id="l2486">    }</span><a href="#l2486"></a>
<span id="l2487"></span><a href="#l2487"></a>
<span id="l2488">    /**</span><a href="#l2488"></a>
<span id="l2489">     * Removes from the specified map any keys that have been enqueued</span><a href="#l2489"></a>
<span id="l2490">     * on the specified reference queue.</span><a href="#l2490"></a>
<span id="l2491">     */</span><a href="#l2491"></a>
<span id="l2492">    static void processQueue(ReferenceQueue&lt;Class&lt;?&gt;&gt; queue,</span><a href="#l2492"></a>
<span id="l2493">                             ConcurrentMap&lt;? extends</span><a href="#l2493"></a>
<span id="l2494">                             WeakReference&lt;Class&lt;?&gt;&gt;, ?&gt; map)</span><a href="#l2494"></a>
<span id="l2495">    {</span><a href="#l2495"></a>
<span id="l2496">        Reference&lt;? extends Class&lt;?&gt;&gt; ref;</span><a href="#l2496"></a>
<span id="l2497">        while((ref = queue.poll()) != null) {</span><a href="#l2497"></a>
<span id="l2498">            map.remove(ref);</span><a href="#l2498"></a>
...
<span id="l2503">     *  Weak key for Class objects.</span><a href="#l2503"></a>
<span id="l2504">     *</span><a href="#l2504"></a>
<span id="l2505">     **/</span><a href="#l2505"></a>
<span id="l2506">    static class WeakClassKey extends WeakReference&lt;Class&lt;?&gt;&gt; {</span><a href="#l2506"></a>
<span id="l2507">        /**</span><a href="#l2507"></a>
<span id="l2508">         * saved value of the referent's identity hash code, to maintain</span><a href="#l2508"></a>
<span id="l2509">         * a consistent hash code after the referent has been cleared</span><a href="#l2509"></a>
<span id="l2510">         */</span><a href="#l2510"></a>
<span id="l2511">        private final int hash;</span><a href="#l2511"></a>
<span id="l2512"></span><a href="#l2512"></a>
<span id="l2513">        /**</span><a href="#l2513"></a>
<span id="l2514">         * Create a new WeakClassKey to the given object, registered</span><a href="#l2514"></a>
<span id="l2515">         * with a queue.</span><a href="#l2515"></a>
<span id="l2516">         */</span><a href="#l2516"></a>
<span id="l2517">        WeakClassKey(Class&lt;?&gt; cl, ReferenceQueue&lt;Class&lt;?&gt;&gt; refQueue) {</span><a href="#l2517"></a>
<span id="l2518">            super(cl, refQueue);</span><a href="#l2518"></a>
<span id="l2519">            hash = System.identityHashCode(cl);</span><a href="#l2519"></a>
<span id="l2520">        }</span><a href="#l2520"></a>
<span id="l2521"></span><a href="#l2521"></a>
<span id="l2522">        /**</span><a href="#l2522"></a>
<span id="l2523">         * Returns the identity hash code of the original referent.</span><a href="#l2523"></a>
<span id="l2524">         */</span><a href="#l2524"></a>
<span id="l2525">        public int hashCode() {</span><a href="#l2525"></a>
<span id="l2526">            return hash;</span><a href="#l2526"></a>
<span id="l2527">        }</span><a href="#l2527"></a>
<span id="l2528"></span><a href="#l2528"></a>
<span id="l2529">        /**</span><a href="#l2529"></a>
<span id="l2530">         * Returns true if the given object is this identical</span><a href="#l2530"></a>
<span id="l2531">         * WeakClassKey instance, or, if this object's referent has not</span><a href="#l2531"></a>
<span id="l2532">         * been cleared, if the given object is another WeakClassKey</span><a href="#l2532"></a>
<span id="l2533">         * instance with the identical non-null referent as this one.</span><a href="#l2533"></a>
<span id="l2534">         */</span><a href="#l2534"></a>
<span id="l2535">        public boolean equals(Object obj) {</span><a href="#l2535"></a>
<span id="l2536">            if (obj == this) {</span><a href="#l2536"></a>
<span id="l2537">                return true;</span><a href="#l2537"></a>
<span id="l2538">            }</span><a href="#l2538"></a>
<span id="l2539"></span><a href="#l2539"></a>
<span id="l2540">            if (obj instanceof WeakClassKey) {</span><a href="#l2540"></a>
<span id="l2541">                Object referent = get();</span><a href="#l2541"></a>
<span id="l2542">                return (referent != null) &amp;&amp;</span><a href="#l2542"></a>
<span id="l2543">                       (referent == ((WeakClassKey) obj).get());</span><a href="#l2543"></a>
<span id="l2544">            } else {</span><a href="#l2544"></a>
<span id="l2545">                return false;</span><a href="#l2545"></a>
<span id="l2546">            }</span><a href="#l2546"></a>
<span id="l2547">        }</span><a href="#l2547"></a>
<span id="l2548">    }</span><a href="#l2548"></a>
<span id="l2549">}</span><a href="#l2549"></a></pre>
