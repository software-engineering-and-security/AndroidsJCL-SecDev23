...
<title>jdk8u/monojdk8u: 0dc979a234d0 jdk/src/share/classes/java/io/ObjectInputStream.java</title>
</head>
<body>
...
<ul>
<li><a href="/jdk8u/monojdk8u/rev/0dc979a234d0">changeset</a></li>
<li><a href="/jdk8u/monojdk8u/file/0dc979a234d0/jdk/src/share/classes/java/io/">browse</a></li>
</ul>
<ul>
<li class="active">file</li>
<li><a href="/jdk8u/monojdk8u/file/tip/jdk/src/share/classes/java/io/ObjectInputStream.java">latest</a></li>
<li><a href="/jdk8u/monojdk8u/diff/0dc979a234d0/jdk/src/share/classes/java/io/ObjectInputStream.java">diff</a></li>
<li><a href="/jdk8u/monojdk8u/comparison/0dc979a234d0/jdk/src/share/classes/java/io/ObjectInputStream.java">comparison</a></li>
<li><a href="/jdk8u/monojdk8u/annotate/0dc979a234d0/jdk/src/share/classes/java/io/ObjectInputStream.java">annotate</a></li>
<li><a href="/jdk8u/monojdk8u/log/0dc979a234d0/jdk/src/share/classes/java/io/ObjectInputStream.java">file log</a></li>
<li><a href="/jdk8u/monojdk8u/raw-file/0dc979a234d0/jdk/src/share/classes/java/io/ObjectInputStream.java">raw</a></li>
</ul>
<ul>
...
<h3>view jdk/src/share/classes/java/io/ObjectInputStream.java @ 48820:0dc979a234d0</h3>
...
<tr>
 ...
 <td class="date age">Fri, 26 Nov 2021 15:04:05 +0300</td>
</tr>
<tr>
 <th class="author">parents</th>
 <td class="author"><a href="/jdk8u/monojdk8u/file/77ccfc2d7c3c/jdk/src/share/classes/java/io/ObjectInputStream.java">77ccfc2d7c3c</a> </td>
</tr>
<tr>
...
<span id="l2452">        // Check that an object follows the TC_EXCEPTION typecode</span><a href="#l2452"></a>
<span id="l2453">        byte tc = bin.peekByte();</span><a href="#l2453"></a>
<span id="l2454">        if (tc != TC_OBJECT &amp;&amp;</span><a href="#l2454"></a>
<span id="l2455">            tc != TC_REFERENCE) {</span><a href="#l2455"></a>
<span id="l2456">            throw new StreamCorruptedException(</span><a href="#l2456"></a>
<span id="l2457">                    String.format(&quot;invalid type code: %02X&quot;, tc));</span><a href="#l2457"></a>
<span id="l2458">        }</span><a href="#l2458"></a>
<span id="l2459">        return (IOException) readObject0(Object.class, false);</span><a href="#l2459"></a>
<span id="l2460">    }</span><a href="#l2460"></a>
<span id="l2461"></span><a href="#l2461"></a>
<span id="l2462">    /**</span><a href="#l2462"></a>
<span id="l2463">     * If recursion depth is 0, clears internal data structures; otherwise,</span><a href="#l2463"></a>
<span id="l2464">     * throws a StreamCorruptedException.  This method is called when a</span><a href="#l2464"></a>
<span id="l2465">     * TC_RESET typecode is encountered.</span><a href="#l2465"></a>
<span id="l2466">     */</span><a href="#l2466"></a>
<span id="l2467">    private void handleReset() throws StreamCorruptedException {</span><a href="#l2467"></a>
<span id="l2468">        if (depth &gt; 0) {</span><a href="#l2468"></a>
<span id="l2469">            throw new StreamCorruptedException(</span><a href="#l2469"></a>
<span id="l2470">                &quot;unexpected reset; recursion depth: &quot; + depth);</span><a href="#l2470"></a>
<span id="l2471">        }</span><a href="#l2471"></a>
<span id="l2472">        clear();</span><a href="#l2472"></a>
<span id="l2473">    }</span><a href="#l2473"></a>
<span id="l2474"></span><a href="#l2474"></a>
<span id="l2475">    /**</span><a href="#l2475"></a>
<span id="l2476">     * Converts specified span of bytes into float values.</span><a href="#l2476"></a>
<span id="l2477">     */</span><a href="#l2477"></a>
<span id="l2478">    // REMIND: remove once hotspot inlines Float.intBitsToFloat</span><a href="#l2478"></a>
<span id="l2479">    private static native void bytesToFloats(byte[] src, int srcpos,</span><a href="#l2479"></a>
<span id="l2480">                                             float[] dst, int dstpos,</span><a href="#l2480"></a>
<span id="l2481">                                             int nfloats);</span><a href="#l2481"></a>
<span id="l2482"></span><a href="#l2482"></a>
<span id="l2483">    /**</span><a href="#l2483"></a>
<span id="l2484">     * Converts specified span of bytes into double values.</span><a href="#l2484"></a>
<span id="l2485">     */</span><a href="#l2485"></a>
<span id="l2486">    // REMIND: remove once hotspot inlines Double.longBitsToDouble</span><a href="#l2486"></a>
<span id="l2487">    private static native void bytesToDoubles(byte[] src, int srcpos,</span><a href="#l2487"></a>
<span id="l2488">                                              double[] dst, int dstpos,</span><a href="#l2488"></a>
<span id="l2489">                                              int ndoubles);</span><a href="#l2489"></a>
<span id="l2490"></span><a href="#l2490"></a>
<span id="l2491">    /**</span><a href="#l2491"></a>
<span id="l2492">     * Returns first non-privileged class loader on the stack (excluding</span><a href="#l2492"></a>
<span id="l2493">     * reflection generated frames) or the extension class loader if only</span><a href="#l2493"></a>
<span id="l2494">     * class loaded by the boot class loader and extension class loader are</span><a href="#l2494"></a>
<span id="l2495">     * found on the stack. This method is also called via reflection by the</span><a href="#l2495"></a>
<span id="l2496">     * following RMI-IIOP class:</span><a href="#l2496"></a>
<span id="l2497">     *</span><a href="#l2497"></a>
<span id="l2498">     *     com.sun.corba.se.internal.util.JDKClassLoader</span><a href="#l2498"></a>
<span id="l2499">     *</span><a href="#l2499"></a>
<span id="l2500">     * This method should not be removed or its signature changed without</span><a href="#l2500"></a>
<span id="l2501">     * corresponding modifications to the above class.</span><a href="#l2501"></a>
<span id="l2502">     */</span><a href="#l2502"></a>
<span id="l2503">    private static ClassLoader latestUserDefinedLoader() {</span><a href="#l2503"></a>
<span id="l2504">        return sun.misc.VM.latestUserDefinedLoader();</span><a href="#l2504"></a>
<span id="l2505">    }</span><a href="#l2505"></a>
<span id="l2506"></span><a href="#l2506"></a>
<span id="l2507">    /**</span><a href="#l2507"></a>
<span id="l2508">     * Default GetField implementation.</span><a href="#l2508"></a>
<span id="l2509">     */</span><a href="#l2509"></a>
<span id="l2510">    private class GetFieldImpl extends GetField {</span><a href="#l2510"></a>
<span id="l2511"></span><a href="#l2511"></a>
<span id="l2512">        /** class descriptor describing serializable fields */</span><a href="#l2512"></a>
<span id="l2513">        private final ObjectStreamClass desc;</span><a href="#l2513"></a>
<span id="l2514">        /** primitive field values */</span><a href="#l2514"></a>
<span id="l2515">        private final byte[] primVals;</span><a href="#l2515"></a>
<span id="l2516">        /** object field values */</span><a href="#l2516"></a>
<span id="l2517">        private final Object[] objVals;</span><a href="#l2517"></a>
<span id="l2518">        /** object field value handles */</span><a href="#l2518"></a>
<span id="l2519">        private final int[] objHandles;</span><a href="#l2519"></a>
<span id="l2520"></span><a href="#l2520"></a>
<span id="l2521">        /**</span><a href="#l2521"></a>
<span id="l2522">         * Creates GetFieldImpl object for reading fields defined in given</span><a href="#l2522"></a>
<span id="l2523">         * class descriptor.</span><a href="#l2523"></a>
<span id="l2524">         */</span><a href="#l2524"></a>
<span id="l2525">        GetFieldImpl(ObjectStreamClass desc) {</span><a href="#l2525"></a>
<span id="l2526">            this.desc = desc;</span><a href="#l2526"></a>
<span id="l2527">            primVals = new byte[desc.getPrimDataSize()];</span><a href="#l2527"></a>
<span id="l2528">            objVals = new Object[desc.getNumObjFields()];</span><a href="#l2528"></a>
<span id="l2529">            objHandles = new int[objVals.length];</span><a href="#l2529"></a>
<span id="l2530">        }</span><a href="#l2530"></a>
<span id="l2531"></span><a href="#l2531"></a>
<span id="l2532">        public ObjectStreamClass getObjectStreamClass() {</span><a href="#l2532"></a>
<span id="l2533">            return desc;</span><a href="#l2533"></a>
<span id="l2534">        }</span><a href="#l2534"></a>
<span id="l2535"></span><a href="#l2535"></a>
<span id="l2536">        public boolean defaulted(String name) throws IOException {</span><a href="#l2536"></a>
<span id="l2537">            return (getFieldOffset(name, null) &lt; 0);</span><a href="#l2537"></a>
<span id="l2538">        }</span><a href="#l2538"></a>
<span id="l2539"></span><a href="#l2539"></a>
<span id="l2540">        public boolean get(String name, boolean val) throws IOException {</span><a href="#l2540"></a>
<span id="l2541">            int off = getFieldOffset(name, Boolean.TYPE);</span><a href="#l2541"></a>
<span id="l2542">            return (off &gt;= 0) ? Bits.getBoolean(primVals, off) : val;</span><a href="#l2542"></a>
<span id="l2543">        }</span><a href="#l2543"></a>
<span id="l2544"></span><a href="#l2544"></a>
<span id="l2545">        public byte get(String name, byte val) throws IOException {</span><a href="#l2545"></a>
<span id="l2546">            int off = getFieldOffset(name, Byte.TYPE);</span><a href="#l2546"></a>
<span id="l2547">            return (off &gt;= 0) ? primVals[off] : val;</span><a href="#l2547"></a>
<span id="l2548">        }</span><a href="#l2548"></a>
<span id="l2549"></span><a href="#l2549"></a>
<span id="l2550">        public char get(String name, char val) throws IOException {</span><a href="#l2550"></a>
<span id="l2551">            int off = getFieldOffset(name, Character.TYPE);</span><a href="#l2551"></a>
<span id="l2552">            return (off &gt;= 0) ? Bits.getChar(primVals, off) : val;</span><a href="#l2552"></a>
<span id="l2553">        }</span><a href="#l2553"></a>
<span id="l2554"></span><a href="#l2554"></a>
<span id="l2555">        public short get(String name, short val) throws IOException {</span><a href="#l2555"></a>
<span id="l2556">            int off = getFieldOffset(name, Short.TYPE);</span><a href="#l2556"></a>
<span id="l2557">            return (off &gt;= 0) ? Bits.getShort(primVals, off) : val;</span><a href="#l2557"></a>
<span id="l2558">        }</span><a href="#l2558"></a>
<span id="l2559"></span><a href="#l2559"></a>
<span id="l2560">        public int get(String name, int val) throws IOException {</span><a href="#l2560"></a>
<span id="l2561">            int off = getFieldOffset(name, Integer.TYPE);</span><a href="#l2561"></a>
<span id="l2562">            return (off &gt;= 0) ? Bits.getInt(primVals, off) : val;</span><a href="#l2562"></a>
<span id="l2563">        }</span><a href="#l2563"></a>
<span id="l2564"></span><a href="#l2564"></a>
<span id="l2565">        public float get(String name, float val) throws IOException {</span><a href="#l2565"></a>
<span id="l2566">            int off = getFieldOffset(name, Float.TYPE);</span><a href="#l2566"></a>
<span id="l2567">            return (off &gt;= 0) ? Bits.getFloat(primVals, off) : val;</span><a href="#l2567"></a>
<span id="l2568">        }</span><a href="#l2568"></a>
<span id="l2569"></span><a href="#l2569"></a>
<span id="l2570">        public long get(String name, long val) throws IOException {</span><a href="#l2570"></a>
<span id="l2571">            int off = getFieldOffset(name, Long.TYPE);</span><a href="#l2571"></a>
<span id="l2572">            return (off &gt;= 0) ? Bits.getLong(primVals, off) : val;</span><a href="#l2572"></a>
<span id="l2573">        }</span><a href="#l2573"></a>
<span id="l2574"></span><a href="#l2574"></a>
<span id="l2575">        public double get(String name, double val) throws IOException {</span><a href="#l2575"></a>
<span id="l2576">            int off = getFieldOffset(name, Double.TYPE);</span><a href="#l2576"></a>
<span id="l2577">            return (off &gt;= 0) ? Bits.getDouble(primVals, off) : val;</span><a href="#l2577"></a>
<span id="l2578">        }</span><a href="#l2578"></a>
<span id="l2579"></span><a href="#l2579"></a>
<span id="l2580">        public Object get(String name, Object val) throws IOException {</span><a href="#l2580"></a>
<span id="l2581">            int off = getFieldOffset(name, Object.class);</span><a href="#l2581"></a>
<span id="l2582">            if (off &gt;= 0) {</span><a href="#l2582"></a>
<span id="l2583">                int objHandle = objHandles[off];</span><a href="#l2583"></a>
<span id="l2584">                handles.markDependency(passHandle, objHandle);</span><a href="#l2584"></a>
<span id="l2585">                return (handles.lookupException(objHandle) == null) ?</span><a href="#l2585"></a>
<span id="l2586">                    objVals[off] : null;</span><a href="#l2586"></a>
<span id="l2587">            } else {</span><a href="#l2587"></a>
<span id="l2588">                return val;</span><a href="#l2588"></a>
...
<span id="l2593">         * Reads primitive and object field values from stream.</span><a href="#l2593"></a>
<span id="l2594">         */</span><a href="#l2594"></a>
<span id="l2595">        void readFields() throws IOException {</span><a href="#l2595"></a>
<span id="l2596">            bin.readFully(primVals, 0, primVals.length, false);</span><a href="#l2596"></a>
<span id="l2597"></span><a href="#l2597"></a>
<span id="l2598">            int oldHandle = passHandle;</span><a href="#l2598"></a>
<span id="l2599">            ObjectStreamField[] fields = desc.getFields(false);</span><a href="#l2599"></a>
<span id="l2600">            int numPrimFields = fields.length - objVals.length;</span><a href="#l2600"></a>
<span id="l2601">            for (int i = 0; i &lt; objVals.length; i++) {</span><a href="#l2601"></a>
<span id="l2602">                objVals[i] =</span><a href="#l2602"></a>
<span id="l2603">                    readObject0(Object.class, fields[numPrimFields + i].isUnshared());</span><a href="#l2603"></a>
<span id="l2604">                objHandles[i] = passHandle;</span><a href="#l2604"></a>
<span id="l2605">            }</span><a href="#l2605"></a>
<span id="l2606">            passHandle = oldHandle;</span><a href="#l2606"></a>
<span id="l2607">        }</span><a href="#l2607"></a>
<span id="l2608"></span><a href="#l2608"></a>
<span id="l2609">        /**</span><a href="#l2609"></a>
<span id="l2610">         * Returns offset of field with given name and type.  A specified type</span><a href="#l2610"></a>
<span id="l2611">         * of null matches all types, Object.class matches all non-primitive</span><a href="#l2611"></a>
<span id="l2612">         * types, and any other non-null type matches assignable types only.</span><a href="#l2612"></a>
<span id="l2613">         * If no matching field is found in the (incoming) class</span><a href="#l2613"></a>
<span id="l2614">         * descriptor but a matching field is present in the associated local</span><a href="#l2614"></a>
<span id="l2615">         * class descriptor, returns -1.  Throws IllegalArgumentException if</span><a href="#l2615"></a>
<span id="l2616">         * neither incoming nor local class descriptor contains a match.</span><a href="#l2616"></a>
<span id="l2617">         */</span><a href="#l2617"></a>
<span id="l2618">        private int getFieldOffset(String name, Class&lt;?&gt; type) {</span><a href="#l2618"></a>
<span id="l2619">            ObjectStreamField field = desc.getField(name, type);</span><a href="#l2619"></a>
<span id="l2620">            if (field != null) {</span><a href="#l2620"></a>
<span id="l2621">                return field.getOffset();</span><a href="#l2621"></a>
<span id="l2622">            } else if (desc.getLocalDesc().getField(name, type) != null) {</span><a href="#l2622"></a>
<span id="l2623">                return -1;</span><a href="#l2623"></a>
<span id="l2624">            } else {</span><a href="#l2624"></a>
<span id="l2625">                throw new IllegalArgumentException(&quot;no such field &quot; + name +</span><a href="#l2625"></a>
<span id="l2626">                                                   &quot; with type &quot; + type);</span><a href="#l2626"></a>
...
<span id="l2632">     * Prioritized list of callbacks to be performed once object graph has been</span><a href="#l2632"></a>
<span id="l2633">     * completely deserialized.</span><a href="#l2633"></a>
<span id="l2634">     */</span><a href="#l2634"></a>
<span id="l2635">    private static class ValidationList {</span><a href="#l2635"></a>
<span id="l2636"></span><a href="#l2636"></a>
<span id="l2637">        private static class Callback {</span><a href="#l2637"></a>
<span id="l2638">            final ObjectInputValidation obj;</span><a href="#l2638"></a>
<span id="l2639">            final int priority;</span><a href="#l2639"></a>
<span id="l2640">            Callback next;</span><a href="#l2640"></a>
<span id="l2641">            final AccessControlContext acc;</span><a href="#l2641"></a>
<span id="l2642"></span><a href="#l2642"></a>
<span id="l2643">            Callback(ObjectInputValidation obj, int priority, Callback next,</span><a href="#l2643"></a>
<span id="l2644">                AccessControlContext acc)</span><a href="#l2644"></a>
<span id="l2645">            {</span><a href="#l2645"></a>
<span id="l2646">                this.obj = obj;</span><a href="#l2646"></a>
<span id="l2647">                this.priority = priority;</span><a href="#l2647"></a>
<span id="l2648">                this.next = next;</span><a href="#l2648"></a>
<span id="l2649">                this.acc = acc;</span><a href="#l2649"></a>
<span id="l2650">            }</span><a href="#l2650"></a>
<span id="l2651">        }</span><a href="#l2651"></a>
<span id="l2652"></span><a href="#l2652"></a>
<span id="l2653">        /** linked list of callbacks */</span><a href="#l2653"></a>
<span id="l2654">        private Callback list;</span><a href="#l2654"></a>
<span id="l2655"></span><a href="#l2655"></a>
<span id="l2656">        /**</span><a href="#l2656"></a>
<span id="l2657">         * Creates new (empty) ValidationList.</span><a href="#l2657"></a>
<span id="l2658">         */</span><a href="#l2658"></a>
<span id="l2659">        ValidationList() {</span><a href="#l2659"></a>
<span id="l2660">        }</span><a href="#l2660"></a>
<span id="l2661"></span><a href="#l2661"></a>
<span id="l2662">        /**</span><a href="#l2662"></a>
<span id="l2663">         * Registers callback.  Throws InvalidObjectException if callback</span><a href="#l2663"></a>
<span id="l2664">         * object is null.</span><a href="#l2664"></a>
<span id="l2665">         */</span><a href="#l2665"></a>
<span id="l2666">        void register(ObjectInputValidation obj, int priority)</span><a href="#l2666"></a>
<span id="l2667">            throws InvalidObjectException</span><a href="#l2667"></a>
<span id="l2668">        {</span><a href="#l2668"></a>
<span id="l2669">            if (obj == null) {</span><a href="#l2669"></a>
<span id="l2670">                throw new InvalidObjectException(&quot;null callback&quot;);</span><a href="#l2670"></a>
<span id="l2671">            }</span><a href="#l2671"></a>
<span id="l2672"></span><a href="#l2672"></a>
<span id="l2673">            Callback prev = null, cur = list;</span><a href="#l2673"></a>
<span id="l2674">            while (cur != null &amp;&amp; priority &lt; cur.priority) {</span><a href="#l2674"></a>
<span id="l2675">                prev = cur;</span><a href="#l2675"></a>
<span id="l2676">                cur = cur.next;</span><a href="#l2676"></a>
<span id="l2677">            }</span><a href="#l2677"></a>
<span id="l2678">            AccessControlContext acc = AccessController.getContext();</span><a href="#l2678"></a>
<span id="l2679">            if (prev != null) {</span><a href="#l2679"></a>
<span id="l2680">                prev.next = new Callback(obj, priority, cur, acc);</span><a href="#l2680"></a>
<span id="l2681">            } else {</span><a href="#l2681"></a>
<span id="l2682">                list = new Callback(obj, priority, list, acc);</span><a href="#l2682"></a>
...
<span id="l2687">         * Invokes all registered callbacks and clears the callback list.</span><a href="#l2687"></a>
<span id="l2688">         * Callbacks with higher priorities are called first; those with equal</span><a href="#l2688"></a>
<span id="l2689">         * priorities may be called in any order.  If any of the callbacks</span><a href="#l2689"></a>
<span id="l2690">         * throws an InvalidObjectException, the callback process is terminated</span><a href="#l2690"></a>
<span id="l2691">         * and the exception propagated upwards.</span><a href="#l2691"></a>
<span id="l2692">         */</span><a href="#l2692"></a>
<span id="l2693">        void doCallbacks() throws InvalidObjectException {</span><a href="#l2693"></a>
<span id="l2694">            try {</span><a href="#l2694"></a>
<span id="l2695">                while (list != null) {</span><a href="#l2695"></a>
<span id="l2696">                    AccessController.doPrivileged(</span><a href="#l2696"></a>
<span id="l2697">                        new PrivilegedExceptionAction&lt;Void&gt;()</span><a href="#l2697"></a>
<span id="l2698">                    {</span><a href="#l2698"></a>
<span id="l2699">                        public Void run() throws InvalidObjectException {</span><a href="#l2699"></a>
<span id="l2700">                            list.obj.validateObject();</span><a href="#l2700"></a>
<span id="l2701">                            return null;</span><a href="#l2701"></a>
<span id="l2702">                        }</span><a href="#l2702"></a>
<span id="l2703">                    }, list.acc);</span><a href="#l2703"></a>
<span id="l2704">                    list = list.next;</span><a href="#l2704"></a>
<span id="l2705">                }</span><a href="#l2705"></a>
<span id="l2706">            } catch (PrivilegedActionException ex) {</span><a href="#l2706"></a>
<span id="l2707">                list = null;</span><a href="#l2707"></a>
<span id="l2708">                throw (InvalidObjectException) ex.getException();</span><a href="#l2708"></a>
...
<span id="l2713">         * Resets the callback list to its initial (empty) state.</span><a href="#l2713"></a>
<span id="l2714">         */</span><a href="#l2714"></a>
<span id="l2715">        public void clear() {</span><a href="#l2715"></a>
<span id="l2716">            list = null;</span><a href="#l2716"></a>
<span id="l2717">        }</span><a href="#l2717"></a>
<span id="l2718">    }</span><a href="#l2718"></a>
<span id="l2719"></span><a href="#l2719"></a>
<span id="l2720">    /**</span><a href="#l2720"></a>
<span id="l2721">     * Hold a snapshot of values to be passed to an ObjectInputFilter.</span><a href="#l2721"></a>
<span id="l2722">     */</span><a href="#l2722"></a>
<span id="l2723">    static class FilterValues implements ObjectInputFilter.FilterInfo {</span><a href="#l2723"></a>
<span id="l2724">        final Class&lt;?&gt; clazz;</span><a href="#l2724"></a>
<span id="l2725">        final long arrayLength;</span><a href="#l2725"></a>
<span id="l2726">        final long totalObjectRefs;</span><a href="#l2726"></a>
<span id="l2727">        final long depth;</span><a href="#l2727"></a>
<span id="l2728">        final long streamBytes;</span><a href="#l2728"></a>
<span id="l2729"></span><a href="#l2729"></a>
<span id="l2730">        public FilterValues(Class&lt;?&gt; clazz, long arrayLength, long totalObjectRefs,</span><a href="#l2730"></a>
<span id="l2731">                            long depth, long streamBytes) {</span><a href="#l2731"></a>
<span id="l2732">            this.clazz = clazz;</span><a href="#l2732"></a>
<span id="l2733">            this.arrayLength = arrayLength;</span><a href="#l2733"></a>
<span id="l2734">            this.totalObjectRefs = totalObjectRefs;</span><a href="#l2734"></a>
<span id="l2735">            this.depth = depth;</span><a href="#l2735"></a>
<span id="l2736">            this.streamBytes = streamBytes;</span><a href="#l2736"></a>
<span id="l2737">        }</span><a href="#l2737"></a>
<span id="l2738"></span><a href="#l2738"></a>
<span id="l2739">        @Override</span><a href="#l2739"></a>
<span id="l2740">        public Class&lt;?&gt; serialClass() {</span><a href="#l2740"></a>
<span id="l2741">            return clazz;</span><a href="#l2741"></a>
<span id="l2742">        }</span><a href="#l2742"></a>
<span id="l2743"></span><a href="#l2743"></a>
<span id="l2744">        @Override</span><a href="#l2744"></a>
<span id="l2745">        public long arrayLength() {</span><a href="#l2745"></a>
<span id="l2746">            return arrayLength;</span><a href="#l2746"></a>
<span id="l2747">        }</span><a href="#l2747"></a>
<span id="l2748"></span><a href="#l2748"></a>
<span id="l2749">        @Override</span><a href="#l2749"></a>
<span id="l2750">        public long references() {</span><a href="#l2750"></a>
<span id="l2751">            return totalObjectRefs;</span><a href="#l2751"></a>
<span id="l2752">        }</span><a href="#l2752"></a>
<span id="l2753"></span><a href="#l2753"></a>
<span id="l2754">        @Override</span><a href="#l2754"></a>
<span id="l2755">        public long depth() {</span><a href="#l2755"></a>
<span id="l2756">            return depth;</span><a href="#l2756"></a>
<span id="l2757">        }</span><a href="#l2757"></a>
<span id="l2758"></span><a href="#l2758"></a>
<span id="l2759">        @Override</span><a href="#l2759"></a>
<span id="l2760">        public long streamBytes() {</span><a href="#l2760"></a>
<span id="l2761">            return streamBytes;</span><a href="#l2761"></a>
<span id="l2762">        }</span><a href="#l2762"></a>
<span id="l2763">    }</span><a href="#l2763"></a>
<span id="l2764"></span><a href="#l2764"></a>
<span id="l2765">    /**</span><a href="#l2765"></a>
<span id="l2766">     * Input stream supporting single-byte peek operations.</span><a href="#l2766"></a>
<span id="l2767">     */</span><a href="#l2767"></a>
<span id="l2768">    private static class PeekInputStream extends InputStream {</span><a href="#l2768"></a>
<span id="l2769"></span><a href="#l2769"></a>
<span id="l2770">        /** underlying stream */</span><a href="#l2770"></a>
<span id="l2771">        private final InputStream in;</span><a href="#l2771"></a>
<span id="l2772">        /** peeked byte */</span><a href="#l2772"></a>
<span id="l2773">        private int peekb = -1;</span><a href="#l2773"></a>
<span id="l2774">        /** total bytes read from the stream */</span><a href="#l2774"></a>
<span id="l2775">        private long totalBytesRead = 0;</span><a href="#l2775"></a>
<span id="l2776"></span><a href="#l2776"></a>
<span id="l2777">        /**</span><a href="#l2777"></a>
<span id="l2778">         * Creates new PeekInputStream on top of given underlying stream.</span><a href="#l2778"></a>
<span id="l2779">         */</span><a href="#l2779"></a>
<span id="l2780">        PeekInputStream(InputStream in) {</span><a href="#l2780"></a>
<span id="l2781">            this.in = in;</span><a href="#l2781"></a>
<span id="l2782">        }</span><a href="#l2782"></a>
<span id="l2783"></span><a href="#l2783"></a>
<span id="l2784">        /**</span><a href="#l2784"></a>
<span id="l2785">         * Peeks at next byte value in stream.  Similar to read(), except</span><a href="#l2785"></a>
<span id="l2786">         * that it does not consume the read value.</span><a href="#l2786"></a>
<span id="l2787">         */</span><a href="#l2787"></a>
<span id="l2788">        int peek() throws IOException {</span><a href="#l2788"></a>
<span id="l2789">            if (peekb &gt;= 0) {</span><a href="#l2789"></a>
<span id="l2790">                return peekb;</span><a href="#l2790"></a>
<span id="l2791">            }</span><a href="#l2791"></a>
<span id="l2792">            peekb = in.read();</span><a href="#l2792"></a>
<span id="l2793">            totalBytesRead += peekb &gt;= 0 ? 1 : 0;</span><a href="#l2793"></a>
<span id="l2794">            return peekb;</span><a href="#l2794"></a>
<span id="l2795">        }</span><a href="#l2795"></a>
<span id="l2796"></span><a href="#l2796"></a>
<span id="l2797">        public int read() throws IOException {</span><a href="#l2797"></a>
<span id="l2798">            if (peekb &gt;= 0) {</span><a href="#l2798"></a>
<span id="l2799">                int v = peekb;</span><a href="#l2799"></a>
<span id="l2800">                peekb = -1;</span><a href="#l2800"></a>
<span id="l2801">                return v;</span><a href="#l2801"></a>
<span id="l2802">            } else {</span><a href="#l2802"></a>
<span id="l2803">                int nbytes = in.read();</span><a href="#l2803"></a>
<span id="l2804">                totalBytesRead += nbytes &gt;= 0 ? 1 : 0;</span><a href="#l2804"></a>
<span id="l2805">                return nbytes;</span><a href="#l2805"></a>
<span id="l2806">            }</span><a href="#l2806"></a>
<span id="l2807">        }</span><a href="#l2807"></a>
<span id="l2808"></span><a href="#l2808"></a>
<span id="l2809">        public int read(byte[] b, int off, int len) throws IOException {</span><a href="#l2809"></a>
<span id="l2810">            int nbytes;</span><a href="#l2810"></a>
<span id="l2811">            if (len == 0) {</span><a href="#l2811"></a>
<span id="l2812">                return 0;</span><a href="#l2812"></a>
<span id="l2813">            } else if (peekb &lt; 0) {</span><a href="#l2813"></a>
...
<span id="l2816">                return nbytes;</span><a href="#l2816"></a>
<span id="l2817">            } else {</span><a href="#l2817"></a>
<span id="l2818">                b[off++] = (byte) peekb;</span><a href="#l2818"></a>
<span id="l2819">                len--;</span><a href="#l2819"></a>
<span id="l2820">                peekb = -1;</span><a href="#l2820"></a>
<span id="l2821">                nbytes = in.read(b, off, len);</span><a href="#l2821"></a>
<span id="l2822">                totalBytesRead += nbytes &gt;= 0 ? nbytes : 0;</span><a href="#l2822"></a>
<span id="l2823">                return (nbytes &gt;= 0) ? (nbytes + 1) : 1;</span><a href="#l2823"></a>
<span id="l2824">            }</span><a href="#l2824"></a>
<span id="l2825">        }</span><a href="#l2825"></a>
<span id="l2826"></span><a href="#l2826"></a>
<span id="l2827">        void readFully(byte[] b, int off, int len) throws IOException {</span><a href="#l2827"></a>
<span id="l2828">            int n = 0;</span><a href="#l2828"></a>
<span id="l2829">            while (n &lt; len) {</span><a href="#l2829"></a>
<span id="l2830">                int count = read(b, off + n, len - n);</span><a href="#l2830"></a>
<span id="l2831">                if (count &lt; 0) {</span><a href="#l2831"></a>
<span id="l2832">                    throw new EOFException();</span><a href="#l2832"></a>
<span id="l2833">                }</span><a href="#l2833"></a>
<span id="l2834">                n += count;</span><a href="#l2834"></a>
<span id="l2835">            }</span><a href="#l2835"></a>
<span id="l2836">        }</span><a href="#l2836"></a>
<span id="l2837"></span><a href="#l2837"></a>
<span id="l2838">        public long skip(long n) throws IOException {</span><a href="#l2838"></a>
<span id="l2839">            if (n &lt;= 0) {</span><a href="#l2839"></a>
<span id="l2840">                return 0;</span><a href="#l2840"></a>
<span id="l2841">            }</span><a href="#l2841"></a>
<span id="l2842">            int skipped = 0;</span><a href="#l2842"></a>
<span id="l2843">            if (peekb &gt;= 0) {</span><a href="#l2843"></a>
<span id="l2844">                peekb = -1;</span><a href="#l2844"></a>
<span id="l2845">                skipped++;</span><a href="#l2845"></a>
<span id="l2846">                n--;</span><a href="#l2846"></a>
<span id="l2847">            }</span><a href="#l2847"></a>
<span id="l2848">            n = skipped + in.skip(n);</span><a href="#l2848"></a>
<span id="l2849">            totalBytesRead += n;</span><a href="#l2849"></a>
<span id="l2850">            return n;</span><a href="#l2850"></a>
<span id="l2851">        }</span><a href="#l2851"></a>
<span id="l2852"></span><a href="#l2852"></a>
<span id="l2853">        public int available() throws IOException {</span><a href="#l2853"></a>
<span id="l2854">            return in.available() + ((peekb &gt;= 0) ? 1 : 0);</span><a href="#l2854"></a>
<span id="l2855">        }</span><a href="#l2855"></a>
<span id="l2856"></span><a href="#l2856"></a>
<span id="l2857">        public void close() throws IOException {</span><a href="#l2857"></a>
<span id="l2858">            in.close();</span><a href="#l2858"></a>
<span id="l2859">        }</span><a href="#l2859"></a>
<span id="l2860"></span><a href="#l2860"></a>
<span id="l2861">        public long getBytesRead() {</span><a href="#l2861"></a>
<span id="l2862">            return totalBytesRead;</span><a href="#l2862"></a>
...
<span id="l2867">     * Input stream with two modes: in default mode, inputs data written in the</span><a href="#l2867"></a>
<span id="l2868">     * same format as DataOutputStream; in &quot;block data&quot; mode, inputs data</span><a href="#l2868"></a>
<span id="l2869">     * bracketed by block data markers (see object serialization specification</span><a href="#l2869"></a>
<span id="l2870">     * for details).  Buffering depends on block data mode: when in default</span><a href="#l2870"></a>
<span id="l2871">     * mode, no data is buffered in advance; when in block data mode, all data</span><a href="#l2871"></a>
<span id="l2872">     * for the current data block is read in at once (and buffered).</span><a href="#l2872"></a>
<span id="l2873">     */</span><a href="#l2873"></a>
<span id="l2874">    private class BlockDataInputStream</span><a href="#l2874"></a>
<span id="l2875">        extends InputStream implements DataInput</span><a href="#l2875"></a>
<span id="l2876">    {</span><a href="#l2876"></a>
<span id="l2877">        /** maximum data block length */</span><a href="#l2877"></a>
<span id="l2878">        private static final int MAX_BLOCK_SIZE = 1024;</span><a href="#l2878"></a>
<span id="l2879">        /** maximum data block header length */</span><a href="#l2879"></a>
<span id="l2880">        private static final int MAX_HEADER_SIZE = 5;</span><a href="#l2880"></a>
<span id="l2881">        /** (tunable) length of char buffer (for reading strings) */</span><a href="#l2881"></a>
<span id="l2882">        private static final int CHAR_BUF_SIZE = 256;</span><a href="#l2882"></a>
<span id="l2883">        /** readBlockHeader() return value indicating header read may block */</span><a href="#l2883"></a>
<span id="l2884">        private static final int HEADER_BLOCKED = -2;</span><a href="#l2884"></a>
<span id="l2885"></span><a href="#l2885"></a>
<span id="l2886">        /** buffer for reading general/block data */</span><a href="#l2886"></a>
<span id="l2887">        private final byte[] buf = new byte[MAX_BLOCK_SIZE];</span><a href="#l2887"></a>
<span id="l2888">        /** buffer for reading block data headers */</span><a href="#l2888"></a>
<span id="l2889">        private final byte[] hbuf = new byte[MAX_HEADER_SIZE];</span><a href="#l2889"></a>
<span id="l2890">        /** char buffer for fast string reads */</span><a href="#l2890"></a>
<span id="l2891">        private final char[] cbuf = new char[CHAR_BUF_SIZE];</span><a href="#l2891"></a>
<span id="l2892"></span><a href="#l2892"></a>
<span id="l2893">        /** block data mode */</span><a href="#l2893"></a>
<span id="l2894">        private boolean blkmode = false;</span><a href="#l2894"></a>
<span id="l2895"></span><a href="#l2895"></a>
<span id="l2896">        // block data state fields; values meaningful only when blkmode true</span><a href="#l2896"></a>
<span id="l2897">        /** current offset into buf */</span><a href="#l2897"></a>
<span id="l2898">        private int pos = 0;</span><a href="#l2898"></a>
<span id="l2899">        /** end offset of valid data in buf, or -1 if no more block data */</span><a href="#l2899"></a>
<span id="l2900">        private int end = -1;</span><a href="#l2900"></a>
<span id="l2901">        /** number of bytes in current block yet to be read from stream */</span><a href="#l2901"></a>
<span id="l2902">        private int unread = 0;</span><a href="#l2902"></a>
<span id="l2903"></span><a href="#l2903"></a>
<span id="l2904">        /** underlying stream (wrapped in peekable filter stream) */</span><a href="#l2904"></a>
<span id="l2905">        private final PeekInputStream in;</span><a href="#l2905"></a>
<span id="l2906">        /** loopback stream (for data reads that span data blocks) */</span><a href="#l2906"></a>
<span id="l2907">        private final DataInputStream din;</span><a href="#l2907"></a>
<span id="l2908"></span><a href="#l2908"></a>
<span id="l2909">        /**</span><a href="#l2909"></a>
<span id="l2910">         * Creates new BlockDataInputStream on top of given underlying stream.</span><a href="#l2910"></a>
<span id="l2911">         * Block data mode is turned off by default.</span><a href="#l2911"></a>
<span id="l2912">         */</span><a href="#l2912"></a>
<span id="l2913">        BlockDataInputStream(InputStream in) {</span><a href="#l2913"></a>
<span id="l2914">            this.in = new PeekInputStream(in);</span><a href="#l2914"></a>
<span id="l2915">            din = new DataInputStream(this);</span><a href="#l2915"></a>
<span id="l2916">        }</span><a href="#l2916"></a>
<span id="l2917"></span><a href="#l2917"></a>
<span id="l2918">        /**</span><a href="#l2918"></a>
<span id="l2919">         * Sets block data mode to the given mode (true == on, false == off)</span><a href="#l2919"></a>
<span id="l2920">         * and returns the previous mode value.  If the new mode is the same as</span><a href="#l2920"></a>
<span id="l2921">         * the old mode, no action is taken.  Throws IllegalStateException if</span><a href="#l2921"></a>
<span id="l2922">         * block data mode is being switched from on to off while unconsumed</span><a href="#l2922"></a>
<span id="l2923">         * block data is still present in the stream.</span><a href="#l2923"></a>
<span id="l2924">         */</span><a href="#l2924"></a>
<span id="l2925">        boolean setBlockDataMode(boolean newmode) throws IOException {</span><a href="#l2925"></a>
<span id="l2926">            if (blkmode == newmode) {</span><a href="#l2926"></a>
<span id="l2927">                return blkmode;</span><a href="#l2927"></a>
<span id="l2928">            }</span><a href="#l2928"></a>
<span id="l2929">            if (newmode) {</span><a href="#l2929"></a>
<span id="l2930">                pos = 0;</span><a href="#l2930"></a>
<span id="l2931">                end = 0;</span><a href="#l2931"></a>
<span id="l2932">                unread = 0;</span><a href="#l2932"></a>
<span id="l2933">            } else if (pos &lt; end) {</span><a href="#l2933"></a>
<span id="l2934">                throw new IllegalStateException(&quot;unread block data&quot;);</span><a href="#l2934"></a>
<span id="l2935">            }</span><a href="#l2935"></a>
<span id="l2936">            blkmode = newmode;</span><a href="#l2936"></a>
<span id="l2937">            return !blkmode;</span><a href="#l2937"></a>
<span id="l2938">        }</span><a href="#l2938"></a>
<span id="l2939"></span><a href="#l2939"></a>
<span id="l2940">        /**</span><a href="#l2940"></a>
<span id="l2941">         * Returns true if the stream is currently in block data mode, false</span><a href="#l2941"></a>
<span id="l2942">         * otherwise.</span><a href="#l2942"></a>
<span id="l2943">         */</span><a href="#l2943"></a>
<span id="l2944">        boolean getBlockDataMode() {</span><a href="#l2944"></a>
<span id="l2945">            return blkmode;</span><a href="#l2945"></a>
<span id="l2946">        }</span><a href="#l2946"></a>
<span id="l2947"></span><a href="#l2947"></a>
<span id="l2948">        /**</span><a href="#l2948"></a>
<span id="l2949">         * If in block data mode, skips to the end of the current group of data</span><a href="#l2949"></a>
<span id="l2950">         * blocks (but does not unset block data mode).  If not in block data</span><a href="#l2950"></a>
<span id="l2951">         * mode, throws an IllegalStateException.</span><a href="#l2951"></a>
<span id="l2952">         */</span><a href="#l2952"></a>
<span id="l2953">        void skipBlockData() throws IOException {</span><a href="#l2953"></a>
<span id="l2954">            if (!blkmode) {</span><a href="#l2954"></a>
<span id="l2955">                throw new IllegalStateException(&quot;not in block data mode&quot;);</span><a href="#l2955"></a>
<span id="l2956">            }</span><a href="#l2956"></a>
<span id="l2957">            while (end &gt;= 0) {</span><a href="#l2957"></a>
<span id="l2958">                refill();</span><a href="#l2958"></a>
<span id="l2959">            }</span><a href="#l2959"></a>
<span id="l2960">        }</span><a href="#l2960"></a>
<span id="l2961"></span><a href="#l2961"></a>
<span id="l2962">        /**</span><a href="#l2962"></a>
<span id="l2963">         * Attempts to read in the next block data header (if any).  If</span><a href="#l2963"></a>
<span id="l2964">         * canBlock is false and a full header cannot be read without possibly</span><a href="#l2964"></a>
<span id="l2965">         * blocking, returns HEADER_BLOCKED, else if the next element in the</span><a href="#l2965"></a>
<span id="l2966">         * stream is a block data header, returns the block data length</span><a href="#l2966"></a>
<span id="l2967">         * specified by the header, else returns -1.</span><a href="#l2967"></a>
<span id="l2968">         */</span><a href="#l2968"></a>
<span id="l2969">        private int readBlockHeader(boolean canBlock) throws IOException {</span><a href="#l2969"></a>
<span id="l2970">            if (defaultDataEnd) {</span><a href="#l2970"></a>
<span id="l2971">                /*</span><a href="#l2971"></a>
<span id="l2972">                 * Fix for 4360508: stream is currently at the end of a field</span><a href="#l2972"></a>
<span id="l2973">                 * value block written via default serialization; since there</span><a href="#l2973"></a>
<span id="l2974">                 * is no terminating TC_ENDBLOCKDATA tag, simulate</span><a href="#l2974"></a>
<span id="l2975">                 * end-of-custom-data behavior explicitly.</span><a href="#l2975"></a>
<span id="l2976">                 */</span><a href="#l2976"></a>
<span id="l2977">                return -1;</span><a href="#l2977"></a>
<span id="l2978">            }</span><a href="#l2978"></a>
<span id="l2979">            try {</span><a href="#l2979"></a>
<span id="l2980">                for (;;) {</span><a href="#l2980"></a>
<span id="l2981">                    int avail = canBlock ? Integer.MAX_VALUE : in.available();</span><a href="#l2981"></a>
<span id="l2982">                    if (avail == 0) {</span><a href="#l2982"></a>
...
<span id="l2986">                    int tc = in.peek();</span><a href="#l2986"></a>
<span id="l2987">                    switch (tc) {</span><a href="#l2987"></a>
<span id="l2988">                        case TC_BLOCKDATA:</span><a href="#l2988"></a>
<span id="l2989">                            if (avail &lt; 2) {</span><a href="#l2989"></a>
<span id="l2990">                                return HEADER_BLOCKED;</span><a href="#l2990"></a>
<span id="l2991">                            }</span><a href="#l2991"></a>
<span id="l2992">                            in.readFully(hbuf, 0, 2);</span><a href="#l2992"></a>
<span id="l2993">                            return hbuf[1] &amp; 0xFF;</span><a href="#l2993"></a>
<span id="l2994"></span><a href="#l2994"></a>
<span id="l2995">                        case TC_BLOCKDATALONG:</span><a href="#l2995"></a>
<span id="l2996">                            if (avail &lt; 5) {</span><a href="#l2996"></a>
<span id="l2997">                                return HEADER_BLOCKED;</span><a href="#l2997"></a>
<span id="l2998">                            }</span><a href="#l2998"></a>
<span id="l2999">                            in.readFully(hbuf, 0, 5);</span><a href="#l2999"></a>
<span id="l3000">                            int len = Bits.getInt(hbuf, 1);</span><a href="#l3000"></a>
<span id="l3001">                            if (len &lt; 0) {</span><a href="#l3001"></a>
<span id="l3002">                                throw new StreamCorruptedException(</span><a href="#l3002"></a>
<span id="l3003">                                    &quot;illegal block data header length: &quot; +</span><a href="#l3003"></a>
<span id="l3004">                                    len);</span><a href="#l3004"></a>
<span id="l3005">                            }</span><a href="#l3005"></a>
<span id="l3006">                            return len;</span><a href="#l3006"></a>
<span id="l3007"></span><a href="#l3007"></a>
<span id="l3008">                        /*</span><a href="#l3008"></a>
<span id="l3009">                         * TC_RESETs may occur in between data blocks.</span><a href="#l3009"></a>
<span id="l3010">                         * Unfortunately, this case must be parsed at a lower</span><a href="#l3010"></a>
<span id="l3011">                         * level than other typecodes, since primitive data</span><a href="#l3011"></a>
<span id="l3012">                         * reads may span data blocks separated by a TC_RESET.</span><a href="#l3012"></a>
<span id="l3013">                         */</span><a href="#l3013"></a>
<span id="l3014">                        case TC_RESET:</span><a href="#l3014"></a>
<span id="l3015">                            in.read();</span><a href="#l3015"></a>
<span id="l3016">                            handleReset();</span><a href="#l3016"></a>
<span id="l3017">                            break;</span><a href="#l3017"></a>
<span id="l3018"></span><a href="#l3018"></a>
<span id="l3019">                        default:</span><a href="#l3019"></a>
<span id="l3020">                            if (tc &gt;= 0 &amp;&amp; (tc &lt; TC_BASE || tc &gt; TC_MAX)) {</span><a href="#l3020"></a>
<span id="l3021">                                throw new StreamCorruptedException(</span><a href="#l3021"></a>
<span id="l3022">                                    String.format(&quot;invalid type code: %02X&quot;,</span><a href="#l3022"></a>
<span id="l3023">                                    tc));</span><a href="#l3023"></a>
<span id="l3024">                            }</span><a href="#l3024"></a>
<span id="l3025">                            return -1;</span><a href="#l3025"></a>
<span id="l3026">                    }</span><a href="#l3026"></a>
<span id="l3027">                }</span><a href="#l3027"></a>
<span id="l3028">            } catch (EOFException ex) {</span><a href="#l3028"></a>
<span id="l3029">                throw new StreamCorruptedException(</span><a href="#l3029"></a>
<span id="l3030">                    &quot;unexpected EOF while reading block data header&quot;);</span><a href="#l3030"></a>
<span id="l3031">            }</span><a href="#l3031"></a>
<span id="l3032">        }</span><a href="#l3032"></a>
<span id="l3033"></span><a href="#l3033"></a>
<span id="l3034">        /**</span><a href="#l3034"></a>
<span id="l3035">         * Refills internal buffer buf with block data.  Any data in buf at the</span><a href="#l3035"></a>
<span id="l3036">         * time of the call is considered consumed.  Sets the pos, end, and</span><a href="#l3036"></a>
<span id="l3037">         * unread fields to reflect the new amount of available block data; if</span><a href="#l3037"></a>
<span id="l3038">         * the next element in the stream is not a data block, sets pos and</span><a href="#l3038"></a>
<span id="l3039">         * unread to 0 and end to -1.</span><a href="#l3039"></a>
<span id="l3040">         */</span><a href="#l3040"></a>
<span id="l3041">        private void refill() throws IOException {</span><a href="#l3041"></a>
<span id="l3042">            try {</span><a href="#l3042"></a>
<span id="l3043">                do {</span><a href="#l3043"></a>
<span id="l3044">                    pos = 0;</span><a href="#l3044"></a>
<span id="l3045">                    if (unread &gt; 0) {</span><a href="#l3045"></a>
<span id="l3046">                        int n =</span><a href="#l3046"></a>
<span id="l3047">                            in.read(buf, 0, Math.min(unread, MAX_BLOCK_SIZE));</span><a href="#l3047"></a>
<span id="l3048">                        if (n &gt;= 0) {</span><a href="#l3048"></a>
<span id="l3049">                            end = n;</span><a href="#l3049"></a>
<span id="l3050">                            unread -= n;</span><a href="#l3050"></a>
<span id="l3051">                        } else {</span><a href="#l3051"></a>
<span id="l3052">                            throw new StreamCorruptedException(</span><a href="#l3052"></a>
<span id="l3053">                                &quot;unexpected EOF in middle of data block&quot;);</span><a href="#l3053"></a>
<span id="l3054">                        }</span><a href="#l3054"></a>
<span id="l3055">                    } else {</span><a href="#l3055"></a>
<span id="l3056">                        int n = readBlockHeader(true);</span><a href="#l3056"></a>
<span id="l3057">                        if (n &gt;= 0) {</span><a href="#l3057"></a>
<span id="l3058">                            end = 0;</span><a href="#l3058"></a>
<span id="l3059">                            unread = n;</span><a href="#l3059"></a>
<span id="l3060">                        } else {</span><a href="#l3060"></a>
...
<span id="l3065">                } while (pos == end);</span><a href="#l3065"></a>
<span id="l3066">            } catch (IOException ex) {</span><a href="#l3066"></a>
<span id="l3067">                pos = 0;</span><a href="#l3067"></a>
<span id="l3068">                end = -1;</span><a href="#l3068"></a>
<span id="l3069">                unread = 0;</span><a href="#l3069"></a>
<span id="l3070">                throw ex;</span><a href="#l3070"></a>
<span id="l3071">            }</span><a href="#l3071"></a>
<span id="l3072">        }</span><a href="#l3072"></a>
<span id="l3073"></span><a href="#l3073"></a>
<span id="l3074">        /**</span><a href="#l3074"></a>
<span id="l3075">         * If in block data mode, returns the number of unconsumed bytes</span><a href="#l3075"></a>
<span id="l3076">         * remaining in the current data block.  If not in block data mode,</span><a href="#l3076"></a>
<span id="l3077">         * throws an IllegalStateException.</span><a href="#l3077"></a>
<span id="l3078">         */</span><a href="#l3078"></a>
<span id="l3079">        int currentBlockRemaining() {</span><a href="#l3079"></a>
<span id="l3080">            if (blkmode) {</span><a href="#l3080"></a>
<span id="l3081">                return (end &gt;= 0) ? (end - pos) + unread : 0;</span><a href="#l3081"></a>
<span id="l3082">            } else {</span><a href="#l3082"></a>
<span id="l3083">                throw new IllegalStateException();</span><a href="#l3083"></a>
...
<span id="l3088">         * Peeks at (but does not consume) and returns the next byte value in</span><a href="#l3088"></a>
<span id="l3089">         * the stream, or -1 if the end of the stream/block data (if in block</span><a href="#l3089"></a>
<span id="l3090">         * data mode) has been reached.</span><a href="#l3090"></a>
<span id="l3091">         */</span><a href="#l3091"></a>
<span id="l3092">        int peek() throws IOException {</span><a href="#l3092"></a>
<span id="l3093">            if (blkmode) {</span><a href="#l3093"></a>
<span id="l3094">                if (pos == end) {</span><a href="#l3094"></a>
<span id="l3095">                    refill();</span><a href="#l3095"></a>
<span id="l3096">                }</span><a href="#l3096"></a>
<span id="l3097">                return (end &gt;= 0) ? (buf[pos] &amp; 0xFF) : -1;</span><a href="#l3097"></a>
<span id="l3098">            } else {</span><a href="#l3098"></a>
<span id="l3099">                return in.peek();</span><a href="#l3099"></a>
<span id="l3100">            }</span><a href="#l3100"></a>
<span id="l3101">        }</span><a href="#l3101"></a>
<span id="l3102"></span><a href="#l3102"></a>
<span id="l3103">        /**</span><a href="#l3103"></a>
<span id="l3104">         * Peeks at (but does not consume) and returns the next byte value in</span><a href="#l3104"></a>
<span id="l3105">         * the stream, or throws EOFException if end of stream/block data has</span><a href="#l3105"></a>
<span id="l3106">         * been reached.</span><a href="#l3106"></a>
<span id="l3107">         */</span><a href="#l3107"></a>
<span id="l3108">        byte peekByte() throws IOException {</span><a href="#l3108"></a>
<span id="l3109">            int val = peek();</span><a href="#l3109"></a>
<span id="l3110">            if (val &lt; 0) {</span><a href="#l3110"></a>
<span id="l3111">                throw new EOFException();</span><a href="#l3111"></a>
<span id="l3112">            }</span><a href="#l3112"></a>
<span id="l3113">            return (byte) val;</span><a href="#l3113"></a>
<span id="l3114">        }</span><a href="#l3114"></a>
<span id="l3115"></span><a href="#l3115"></a>
<span id="l3116"></span><a href="#l3116"></a>
<span id="l3117">        /* ----------------- generic input stream methods ------------------ */</span><a href="#l3117"></a>
<span id="l3118">        /*</span><a href="#l3118"></a>
<span id="l3119">         * The following methods are equivalent to their counterparts in</span><a href="#l3119"></a>
<span id="l3120">         * InputStream, except that they interpret data block boundaries and</span><a href="#l3120"></a>
<span id="l3121">         * read the requested data from within data blocks when in block data</span><a href="#l3121"></a>
<span id="l3122">         * mode.</span><a href="#l3122"></a>
<span id="l3123">         */</span><a href="#l3123"></a>
<span id="l3124"></span><a href="#l3124"></a>
<span id="l3125">        public int read() throws IOException {</span><a href="#l3125"></a>
<span id="l3126">            if (blkmode) {</span><a href="#l3126"></a>
<span id="l3127">                if (pos == end) {</span><a href="#l3127"></a>
<span id="l3128">                    refill();</span><a href="#l3128"></a>
<span id="l3129">                }</span><a href="#l3129"></a>
<span id="l3130">                return (end &gt;= 0) ? (buf[pos++] &amp; 0xFF) : -1;</span><a href="#l3130"></a>
<span id="l3131">            } else {</span><a href="#l3131"></a>
<span id="l3132">                return in.read();</span><a href="#l3132"></a>
<span id="l3133">            }</span><a href="#l3133"></a>
<span id="l3134">        }</span><a href="#l3134"></a>
<span id="l3135"></span><a href="#l3135"></a>
<span id="l3136">        public int read(byte[] b, int off, int len) throws IOException {</span><a href="#l3136"></a>
<span id="l3137">            return read(b, off, len, false);</span><a href="#l3137"></a>
<span id="l3138">        }</span><a href="#l3138"></a>
<span id="l3139"></span><a href="#l3139"></a>
<span id="l3140">        public long skip(long len) throws IOException {</span><a href="#l3140"></a>
<span id="l3141">            long remain = len;</span><a href="#l3141"></a>
<span id="l3142">            while (remain &gt; 0) {</span><a href="#l3142"></a>
<span id="l3143">                if (blkmode) {</span><a href="#l3143"></a>
<span id="l3144">                    if (pos == end) {</span><a href="#l3144"></a>
<span id="l3145">                        refill();</span><a href="#l3145"></a>
<span id="l3146">                    }</span><a href="#l3146"></a>
<span id="l3147">                    if (end &lt; 0) {</span><a href="#l3147"></a>
<span id="l3148">                        break;</span><a href="#l3148"></a>
<span id="l3149">                    }</span><a href="#l3149"></a>
<span id="l3150">                    int nread = (int) Math.min(remain, end - pos);</span><a href="#l3150"></a>
<span id="l3151">                    remain -= nread;</span><a href="#l3151"></a>
<span id="l3152">                    pos += nread;</span><a href="#l3152"></a>
<span id="l3153">                } else {</span><a href="#l3153"></a>
<span id="l3154">                    int nread = (int) Math.min(remain, MAX_BLOCK_SIZE);</span><a href="#l3154"></a>
<span id="l3155">                    if ((nread = in.read(buf, 0, nread)) &lt; 0) {</span><a href="#l3155"></a>
<span id="l3156">                        break;</span><a href="#l3156"></a>
<span id="l3157">                    }</span><a href="#l3157"></a>
<span id="l3158">                    remain -= nread;</span><a href="#l3158"></a>
<span id="l3159">                }</span><a href="#l3159"></a>
<span id="l3160">            }</span><a href="#l3160"></a>
<span id="l3161">            return len - remain;</span><a href="#l3161"></a>
<span id="l3162">        }</span><a href="#l3162"></a>
<span id="l3163"></span><a href="#l3163"></a>
<span id="l3164">        public int available() throws IOException {</span><a href="#l3164"></a>
<span id="l3165">            if (blkmode) {</span><a href="#l3165"></a>
<span id="l3166">                if ((pos == end) &amp;&amp; (unread == 0)) {</span><a href="#l3166"></a>
<span id="l3167">                    int n;</span><a href="#l3167"></a>
<span id="l3168">                    while ((n = readBlockHeader(false)) == 0) ;</span><a href="#l3168"></a>
<span id="l3169">                    switch (n) {</span><a href="#l3169"></a>
<span id="l3170">                        case HEADER_BLOCKED:</span><a href="#l3170"></a>
<span id="l3171">                            break;</span><a href="#l3171"></a>
<span id="l3172"></span><a href="#l3172"></a>
<span id="l3173">                        case -1:</span><a href="#l3173"></a>
<span id="l3174">                            pos = 0;</span><a href="#l3174"></a>
<span id="l3175">                            end = -1;</span><a href="#l3175"></a>
<span id="l3176">                            break;</span><a href="#l3176"></a>
<span id="l3177"></span><a href="#l3177"></a>
<span id="l3178">                        default:</span><a href="#l3178"></a>
<span id="l3179">                            pos = 0;</span><a href="#l3179"></a>
<span id="l3180">                            end = 0;</span><a href="#l3180"></a>
<span id="l3181">                            unread = n;</span><a href="#l3181"></a>
<span id="l3182">                            break;</span><a href="#l3182"></a>
<span id="l3183">                    }</span><a href="#l3183"></a>
<span id="l3184">                }</span><a href="#l3184"></a>
<span id="l3185">                // avoid unnecessary call to in.available() if possible</span><a href="#l3185"></a>
<span id="l3186">                int unreadAvail = (unread &gt; 0) ?</span><a href="#l3186"></a>
<span id="l3187">                    Math.min(in.available(), unread) : 0;</span><a href="#l3187"></a>
<span id="l3188">                return (end &gt;= 0) ? (end - pos) + unreadAvail : 0;</span><a href="#l3188"></a>
<span id="l3189">            } else {</span><a href="#l3189"></a>
<span id="l3190">                return in.available();</span><a href="#l3190"></a>
<span id="l3191">            }</span><a href="#l3191"></a>
<span id="l3192">        }</span><a href="#l3192"></a>
<span id="l3193"></span><a href="#l3193"></a>
<span id="l3194">        public void close() throws IOException {</span><a href="#l3194"></a>
<span id="l3195">            if (blkmode) {</span><a href="#l3195"></a>
<span id="l3196">                pos = 0;</span><a href="#l3196"></a>
<span id="l3197">                end = -1;</span><a href="#l3197"></a>
<span id="l3198">                unread = 0;</span><a href="#l3198"></a>
<span id="l3199">            }</span><a href="#l3199"></a>
<span id="l3200">            in.close();</span><a href="#l3200"></a>
<span id="l3201">        }</span><a href="#l3201"></a>
<span id="l3202"></span><a href="#l3202"></a>
<span id="l3203">        /**</span><a href="#l3203"></a>
<span id="l3204">         * Attempts to read len bytes into byte array b at offset off.  Returns</span><a href="#l3204"></a>
<span id="l3205">         * the number of bytes read, or -1 if the end of stream/block data has</span><a href="#l3205"></a>
<span id="l3206">         * been reached.  If copy is true, reads values into an intermediate</span><a href="#l3206"></a>
<span id="l3207">         * buffer before copying them to b (to avoid exposing a reference to</span><a href="#l3207"></a>
<span id="l3208">         * b).</span><a href="#l3208"></a>
<span id="l3209">         */</span><a href="#l3209"></a>
<span id="l3210">        int read(byte[] b, int off, int len, boolean copy) throws IOException {</span><a href="#l3210"></a>
<span id="l3211">            if (len == 0) {</span><a href="#l3211"></a>
<span id="l3212">                return 0;</span><a href="#l3212"></a>
<span id="l3213">            } else if (blkmode) {</span><a href="#l3213"></a>
<span id="l3214">                if (pos == end) {</span><a href="#l3214"></a>
<span id="l3215">                    refill();</span><a href="#l3215"></a>
<span id="l3216">                }</span><a href="#l3216"></a>
<span id="l3217">                if (end &lt; 0) {</span><a href="#l3217"></a>
<span id="l3218">                    return -1;</span><a href="#l3218"></a>
<span id="l3219">                }</span><a href="#l3219"></a>
<span id="l3220">                int nread = Math.min(len, end - pos);</span><a href="#l3220"></a>
<span id="l3221">                System.arraycopy(buf, pos, b, off, nread);</span><a href="#l3221"></a>
<span id="l3222">                pos += nread;</span><a href="#l3222"></a>
<span id="l3223">                return nread;</span><a href="#l3223"></a>
<span id="l3224">            } else if (copy) {</span><a href="#l3224"></a>
<span id="l3225">                int nread = in.read(buf, 0, Math.min(len, MAX_BLOCK_SIZE));</span><a href="#l3225"></a>
<span id="l3226">                if (nread &gt; 0) {</span><a href="#l3226"></a>
<span id="l3227">                    System.arraycopy(buf, 0, b, off, nread);</span><a href="#l3227"></a>
<span id="l3228">                }</span><a href="#l3228"></a>
<span id="l3229">                return nread;</span><a href="#l3229"></a>
<span id="l3230">            } else {</span><a href="#l3230"></a>
<span id="l3231">                return in.read(b, off, len);</span><a href="#l3231"></a>
<span id="l3232">            }</span><a href="#l3232"></a>
<span id="l3233">        }</span><a href="#l3233"></a>
<span id="l3234"></span><a href="#l3234"></a>
<span id="l3235">        /* ----------------- primitive data input methods ------------------ */</span><a href="#l3235"></a>
<span id="l3236">        /*</span><a href="#l3236"></a>
<span id="l3237">         * The following methods are equivalent to their counterparts in</span><a href="#l3237"></a>
<span id="l3238">         * DataInputStream, except that they interpret data block boundaries</span><a href="#l3238"></a>
<span id="l3239">         * and read the requested data from within data blocks when in block</span><a href="#l3239"></a>
<span id="l3240">         * data mode.</span><a href="#l3240"></a>
<span id="l3241">         */</span><a href="#l3241"></a>
<span id="l3242"></span><a href="#l3242"></a>
<span id="l3243">        public void readFully(byte[] b) throws IOException {</span><a href="#l3243"></a>
<span id="l3244">            readFully(b, 0, b.length, false);</span><a href="#l3244"></a>
<span id="l3245">        }</span><a href="#l3245"></a>
<span id="l3246"></span><a href="#l3246"></a>
<span id="l3247">        public void readFully(byte[] b, int off, int len) throws IOException {</span><a href="#l3247"></a>
<span id="l3248">            readFully(b, off, len, false);</span><a href="#l3248"></a>
<span id="l3249">        }</span><a href="#l3249"></a>
<span id="l3250"></span><a href="#l3250"></a>
<span id="l3251">        public void readFully(byte[] b, int off, int len, boolean copy)</span><a href="#l3251"></a>
<span id="l3252">            throws IOException</span><a href="#l3252"></a>
<span id="l3253">        {</span><a href="#l3253"></a>
<span id="l3254">            while (len &gt; 0) {</span><a href="#l3254"></a>
<span id="l3255">                int n = read(b, off, len, copy);</span><a href="#l3255"></a>
<span id="l3256">                if (n &lt; 0) {</span><a href="#l3256"></a>
<span id="l3257">                    throw new EOFException();</span><a href="#l3257"></a>
<span id="l3258">                }</span><a href="#l3258"></a>
<span id="l3259">                off += n;</span><a href="#l3259"></a>
<span id="l3260">                len -= n;</span><a href="#l3260"></a>
<span id="l3261">            }</span><a href="#l3261"></a>
<span id="l3262">        }</span><a href="#l3262"></a>
<span id="l3263"></span><a href="#l3263"></a>
<span id="l3264">        public int skipBytes(int n) throws IOException {</span><a href="#l3264"></a>
<span id="l3265">            return din.skipBytes(n);</span><a href="#l3265"></a>
<span id="l3266">        }</span><a href="#l3266"></a>
<span id="l3267"></span><a href="#l3267"></a>
<span id="l3268">        public boolean readBoolean() throws IOException {</span><a href="#l3268"></a>
<span id="l3269">            int v = read();</span><a href="#l3269"></a>
<span id="l3270">            if (v &lt; 0) {</span><a href="#l3270"></a>
<span id="l3271">                throw new EOFException();</span><a href="#l3271"></a>
<span id="l3272">            }</span><a href="#l3272"></a>
<span id="l3273">            return (v != 0);</span><a href="#l3273"></a>
<span id="l3274">        }</span><a href="#l3274"></a>
<span id="l3275"></span><a href="#l3275"></a>
<span id="l3276">        public byte readByte() throws IOException {</span><a href="#l3276"></a>
<span id="l3277">            int v = read();</span><a href="#l3277"></a>
<span id="l3278">            if (v &lt; 0) {</span><a href="#l3278"></a>
<span id="l3279">                throw new EOFException();</span><a href="#l3279"></a>
<span id="l3280">            }</span><a href="#l3280"></a>
<span id="l3281">            return (byte) v;</span><a href="#l3281"></a>
<span id="l3282">        }</span><a href="#l3282"></a>
<span id="l3283"></span><a href="#l3283"></a>
<span id="l3284">        public int readUnsignedByte() throws IOException {</span><a href="#l3284"></a>
<span id="l3285">            int v = read();</span><a href="#l3285"></a>
<span id="l3286">            if (v &lt; 0) {</span><a href="#l3286"></a>
<span id="l3287">                throw new EOFException();</span><a href="#l3287"></a>
<span id="l3288">            }</span><a href="#l3288"></a>
<span id="l3289">            return v;</span><a href="#l3289"></a>
<span id="l3290">        }</span><a href="#l3290"></a>
<span id="l3291"></span><a href="#l3291"></a>
<span id="l3292">        public char readChar() throws IOException {</span><a href="#l3292"></a>
<span id="l3293">            if (!blkmode) {</span><a href="#l3293"></a>
<span id="l3294">                pos = 0;</span><a href="#l3294"></a>
<span id="l3295">                in.readFully(buf, 0, 2);</span><a href="#l3295"></a>
<span id="l3296">            } else if (end - pos &lt; 2) {</span><a href="#l3296"></a>
<span id="l3297">                return din.readChar();</span><a href="#l3297"></a>
<span id="l3298">            }</span><a href="#l3298"></a>
<span id="l3299">            char v = Bits.getChar(buf, pos);</span><a href="#l3299"></a>
<span id="l3300">            pos += 2;</span><a href="#l3300"></a>
<span id="l3301">            return v;</span><a href="#l3301"></a>
<span id="l3302">        }</span><a href="#l3302"></a>
<span id="l3303"></span><a href="#l3303"></a>
<span id="l3304">        public short readShort() throws IOException {</span><a href="#l3304"></a>
<span id="l3305">            if (!blkmode) {</span><a href="#l3305"></a>
<span id="l3306">                pos = 0;</span><a href="#l3306"></a>
<span id="l3307">                in.readFully(buf, 0, 2);</span><a href="#l3307"></a>
<span id="l3308">            } else if (end - pos &lt; 2) {</span><a href="#l3308"></a>
<span id="l3309">                return din.readShort();</span><a href="#l3309"></a>
<span id="l3310">            }</span><a href="#l3310"></a>
<span id="l3311">            short v = Bits.getShort(buf, pos);</span><a href="#l3311"></a>
<span id="l3312">            pos += 2;</span><a href="#l3312"></a>
<span id="l3313">            return v;</span><a href="#l3313"></a>
<span id="l3314">        }</span><a href="#l3314"></a>
<span id="l3315"></span><a href="#l3315"></a>
<span id="l3316">        public int readUnsignedShort() throws IOException {</span><a href="#l3316"></a>
<span id="l3317">            if (!blkmode) {</span><a href="#l3317"></a>
<span id="l3318">                pos = 0;</span><a href="#l3318"></a>
<span id="l3319">                in.readFully(buf, 0, 2);</span><a href="#l3319"></a>
<span id="l3320">            } else if (end - pos &lt; 2) {</span><a href="#l3320"></a>
<span id="l3321">                return din.readUnsignedShort();</span><a href="#l3321"></a>
<span id="l3322">            }</span><a href="#l3322"></a>
<span id="l3323">            int v = Bits.getShort(buf, pos) &amp; 0xFFFF;</span><a href="#l3323"></a>
<span id="l3324">            pos += 2;</span><a href="#l3324"></a>
<span id="l3325">            return v;</span><a href="#l3325"></a>
<span id="l3326">        }</span><a href="#l3326"></a>
<span id="l3327"></span><a href="#l3327"></a>
<span id="l3328">        public int readInt() throws IOException {</span><a href="#l3328"></a>
<span id="l3329">            if (!blkmode) {</span><a href="#l3329"></a>
<span id="l3330">                pos = 0;</span><a href="#l3330"></a>
<span id="l3331">                in.readFully(buf, 0, 4);</span><a href="#l3331"></a>
<span id="l3332">            } else if (end - pos &lt; 4) {</span><a href="#l3332"></a>
<span id="l3333">                return din.readInt();</span><a href="#l3333"></a>
<span id="l3334">            }</span><a href="#l3334"></a>
<span id="l3335">            int v = Bits.getInt(buf, pos);</span><a href="#l3335"></a>
<span id="l3336">            pos += 4;</span><a href="#l3336"></a>
<span id="l3337">            return v;</span><a href="#l3337"></a>
<span id="l3338">        }</span><a href="#l3338"></a>
<span id="l3339"></span><a href="#l3339"></a>
<span id="l3340">        public float readFloat() throws IOException {</span><a href="#l3340"></a>
<span id="l3341">            if (!blkmode) {</span><a href="#l3341"></a>
<span id="l3342">                pos = 0;</span><a href="#l3342"></a>
<span id="l3343">                in.readFully(buf, 0, 4);</span><a href="#l3343"></a>
<span id="l3344">            } else if (end - pos &lt; 4) {</span><a href="#l3344"></a>
<span id="l3345">                return din.readFloat();</span><a href="#l3345"></a>
<span id="l3346">            }</span><a href="#l3346"></a>
<span id="l3347">            float v = Bits.getFloat(buf, pos);</span><a href="#l3347"></a>
<span id="l3348">            pos += 4;</span><a href="#l3348"></a>
<span id="l3349">            return v;</span><a href="#l3349"></a>
<span id="l3350">        }</span><a href="#l3350"></a>
<span id="l3351"></span><a href="#l3351"></a>
<span id="l3352">        public long readLong() throws IOException {</span><a href="#l3352"></a>
<span id="l3353">            if (!blkmode) {</span><a href="#l3353"></a>
<span id="l3354">                pos = 0;</span><a href="#l3354"></a>
<span id="l3355">                in.readFully(buf, 0, 8);</span><a href="#l3355"></a>
<span id="l3356">            } else if (end - pos &lt; 8) {</span><a href="#l3356"></a>
<span id="l3357">                return din.readLong();</span><a href="#l3357"></a>
<span id="l3358">            }</span><a href="#l3358"></a>
<span id="l3359">            long v = Bits.getLong(buf, pos);</span><a href="#l3359"></a>
<span id="l3360">            pos += 8;</span><a href="#l3360"></a>
<span id="l3361">            return v;</span><a href="#l3361"></a>
<span id="l3362">        }</span><a href="#l3362"></a>
<span id="l3363"></span><a href="#l3363"></a>
<span id="l3364">        public double readDouble() throws IOException {</span><a href="#l3364"></a>
<span id="l3365">            if (!blkmode) {</span><a href="#l3365"></a>
<span id="l3366">                pos = 0;</span><a href="#l3366"></a>
<span id="l3367">                in.readFully(buf, 0, 8);</span><a href="#l3367"></a>
<span id="l3368">            } else if (end - pos &lt; 8) {</span><a href="#l3368"></a>
<span id="l3369">                return din.readDouble();</span><a href="#l3369"></a>
<span id="l3370">            }</span><a href="#l3370"></a>
<span id="l3371">            double v = Bits.getDouble(buf, pos);</span><a href="#l3371"></a>
<span id="l3372">            pos += 8;</span><a href="#l3372"></a>
<span id="l3373">            return v;</span><a href="#l3373"></a>
<span id="l3374">        }</span><a href="#l3374"></a>
<span id="l3375"></span><a href="#l3375"></a>
<span id="l3376">        public String readUTF() throws IOException {</span><a href="#l3376"></a>
<span id="l3377">            return readUTFBody(readUnsignedShort());</span><a href="#l3377"></a>
<span id="l3378">        }</span><a href="#l3378"></a>
<span id="l3379"></span><a href="#l3379"></a>
<span id="l3380">        @SuppressWarnings(&quot;deprecation&quot;)</span><a href="#l3380"></a>
<span id="l3381">        public String readLine() throws IOException {</span><a href="#l3381"></a>
<span id="l3382">            return din.readLine();      // deprecated, not worth optimizing</span><a href="#l3382"></a>
<span id="l3383">        }</span><a href="#l3383"></a>
<span id="l3384"></span><a href="#l3384"></a>
<span id="l3385">        /* -------------- primitive data array input methods --------------- */</span><a href="#l3385"></a>
<span id="l3386">        /*</span><a href="#l3386"></a>
<span id="l3387">         * The following methods read in spans of primitive data values.</span><a href="#l3387"></a>
<span id="l3388">         * Though equivalent to calling the corresponding primitive read</span><a href="#l3388"></a>
<span id="l3389">         * methods repeatedly, these methods are optimized for reading groups</span><a href="#l3389"></a>
<span id="l3390">         * of primitive data values more efficiently.</span><a href="#l3390"></a>
<span id="l3391">         */</span><a href="#l3391"></a>
<span id="l3392"></span><a href="#l3392"></a>
<span id="l3393">        void readBooleans(boolean[] v, int off, int len) throws IOException {</span><a href="#l3393"></a>
<span id="l3394">            int stop, endoff = off + len;</span><a href="#l3394"></a>
<span id="l3395">            while (off &lt; endoff) {</span><a href="#l3395"></a>
<span id="l3396">                if (!blkmode) {</span><a href="#l3396"></a>
<span id="l3397">                    int span = Math.min(endoff - off, MAX_BLOCK_SIZE);</span><a href="#l3397"></a>
<span id="l3398">                    in.readFully(buf, 0, span);</span><a href="#l3398"></a>
<span id="l3399">                    stop = off + span;</span><a href="#l3399"></a>
<span id="l3400">                    pos = 0;</span><a href="#l3400"></a>
<span id="l3401">                } else if (end - pos &lt; 1) {</span><a href="#l3401"></a>
<span id="l3402">                    v[off++] = din.readBoolean();</span><a href="#l3402"></a>
<span id="l3403">                    continue;</span><a href="#l3403"></a>
<span id="l3404">                } else {</span><a href="#l3404"></a>
<span id="l3405">                    stop = Math.min(endoff, off + end - pos);</span><a href="#l3405"></a>
<span id="l3406">                }</span><a href="#l3406"></a>
<span id="l3407"></span><a href="#l3407"></a>
<span id="l3408">                while (off &lt; stop) {</span><a href="#l3408"></a>
<span id="l3409">                    v[off++] = Bits.getBoolean(buf, pos++);</span><a href="#l3409"></a>
<span id="l3410">                }</span><a href="#l3410"></a>
<span id="l3411">            }</span><a href="#l3411"></a>
<span id="l3412">        }</span><a href="#l3412"></a>
<span id="l3413"></span><a href="#l3413"></a>
<span id="l3414">        void readChars(char[] v, int off, int len) throws IOException {</span><a href="#l3414"></a>
<span id="l3415">            int stop, endoff = off + len;</span><a href="#l3415"></a>
<span id="l3416">            while (off &lt; endoff) {</span><a href="#l3416"></a>
<span id="l3417">                if (!blkmode) {</span><a href="#l3417"></a>
<span id="l3418">                    int span = Math.min(endoff - off, MAX_BLOCK_SIZE &gt;&gt; 1);</span><a href="#l3418"></a>
<span id="l3419">                    in.readFully(buf, 0, span &lt;&lt; 1);</span><a href="#l3419"></a>
<span id="l3420">                    stop = off + span;</span><a href="#l3420"></a>
<span id="l3421">                    pos = 0;</span><a href="#l3421"></a>
<span id="l3422">                } else if (end - pos &lt; 2) {</span><a href="#l3422"></a>
<span id="l3423">                    v[off++] = din.readChar();</span><a href="#l3423"></a>
<span id="l3424">                    continue;</span><a href="#l3424"></a>
<span id="l3425">                } else {</span><a href="#l3425"></a>
<span id="l3426">                    stop = Math.min(endoff, off + ((end - pos) &gt;&gt; 1));</span><a href="#l3426"></a>
<span id="l3427">                }</span><a href="#l3427"></a>
<span id="l3428"></span><a href="#l3428"></a>
<span id="l3429">                while (off &lt; stop) {</span><a href="#l3429"></a>
<span id="l3430">                    v[off++] = Bits.getChar(buf, pos);</span><a href="#l3430"></a>
<span id="l3431">                    pos += 2;</span><a href="#l3431"></a>
<span id="l3432">                }</span><a href="#l3432"></a>
<span id="l3433">            }</span><a href="#l3433"></a>
<span id="l3434">        }</span><a href="#l3434"></a>
<span id="l3435"></span><a href="#l3435"></a>
<span id="l3436">        void readShorts(short[] v, int off, int len) throws IOException {</span><a href="#l3436"></a>
<span id="l3437">            int stop, endoff = off + len;</span><a href="#l3437"></a>
<span id="l3438">            while (off &lt; endoff) {</span><a href="#l3438"></a>
<span id="l3439">                if (!blkmode) {</span><a href="#l3439"></a>
<span id="l3440">                    int span = Math.min(endoff - off, MAX_BLOCK_SIZE &gt;&gt; 1);</span><a href="#l3440"></a>
<span id="l3441">                    in.readFully(buf, 0, span &lt;&lt; 1);</span><a href="#l3441"></a>
<span id="l3442">                    stop = off + span;</span><a href="#l3442"></a>
<span id="l3443">                    pos = 0;</span><a href="#l3443"></a>
<span id="l3444">                } else if (end - pos &lt; 2) {</span><a href="#l3444"></a>
<span id="l3445">                    v[off++] = din.readShort();</span><a href="#l3445"></a>
<span id="l3446">                    continue;</span><a href="#l3446"></a>
<span id="l3447">                } else {</span><a href="#l3447"></a>
<span id="l3448">                    stop = Math.min(endoff, off + ((end - pos) &gt;&gt; 1));</span><a href="#l3448"></a>
<span id="l3449">                }</span><a href="#l3449"></a>
<span id="l3450"></span><a href="#l3450"></a>
<span id="l3451">                while (off &lt; stop) {</span><a href="#l3451"></a>
<span id="l3452">                    v[off++] = Bits.getShort(buf, pos);</span><a href="#l3452"></a>
<span id="l3453">                    pos += 2;</span><a href="#l3453"></a>
...
<span id="l3458">        void readInts(int[] v, int off, int len) throws IOException {</span><a href="#l3458"></a>
<span id="l3459">            int stop, endoff = off + len;</span><a href="#l3459"></a>
<span id="l3460">            while (off &lt; endoff) {</span><a href="#l3460"></a>
<span id="l3461">                if (!blkmode) {</span><a href="#l3461"></a>
<span id="l3462">                    int span = Math.min(endoff - off, MAX_BLOCK_SIZE &gt;&gt; 2);</span><a href="#l3462"></a>
<span id="l3463">                    in.readFully(buf, 0, span &lt;&lt; 2);</span><a href="#l3463"></a>
<span id="l3464">                    stop = off + span;</span><a href="#l3464"></a>
<span id="l3465">                    pos = 0;</span><a href="#l3465"></a>
<span id="l3466">                } else if (end - pos &lt; 4) {</span><a href="#l3466"></a>
<span id="l3467">                    v[off++] = din.readInt();</span><a href="#l3467"></a>
<span id="l3468">                    continue;</span><a href="#l3468"></a>
<span id="l3469">                } else {</span><a href="#l3469"></a>
<span id="l3470">                    stop = Math.min(endoff, off + ((end - pos) &gt;&gt; 2));</span><a href="#l3470"></a>
<span id="l3471">                }</span><a href="#l3471"></a>
<span id="l3472"></span><a href="#l3472"></a>
<span id="l3473">                while (off &lt; stop) {</span><a href="#l3473"></a>
<span id="l3474">                    v[off++] = Bits.getInt(buf, pos);</span><a href="#l3474"></a>
<span id="l3475">                    pos += 4;</span><a href="#l3475"></a>
<span id="l3476">                }</span><a href="#l3476"></a>
<span id="l3477">            }</span><a href="#l3477"></a>
<span id="l3478">        }</span><a href="#l3478"></a>
<span id="l3479"></span><a href="#l3479"></a>
<span id="l3480">        void readFloats(float[] v, int off, int len) throws IOException {</span><a href="#l3480"></a>
<span id="l3481">            int span, endoff = off + len;</span><a href="#l3481"></a>
<span id="l3482">            while (off &lt; endoff) {</span><a href="#l3482"></a>
<span id="l3483">                if (!blkmode) {</span><a href="#l3483"></a>
<span id="l3484">                    span = Math.min(endoff - off, MAX_BLOCK_SIZE &gt;&gt; 2);</span><a href="#l3484"></a>
<span id="l3485">                    in.readFully(buf, 0, span &lt;&lt; 2);</span><a href="#l3485"></a>
<span id="l3486">                    pos = 0;</span><a href="#l3486"></a>
<span id="l3487">                } else if (end - pos &lt; 4) {</span><a href="#l3487"></a>
<span id="l3488">                    v[off++] = din.readFloat();</span><a href="#l3488"></a>
<span id="l3489">                    continue;</span><a href="#l3489"></a>
<span id="l3490">                } else {</span><a href="#l3490"></a>
<span id="l3491">                    span = Math.min(endoff - off, ((end - pos) &gt;&gt; 2));</span><a href="#l3491"></a>
<span id="l3492">                }</span><a href="#l3492"></a>
<span id="l3493"></span><a href="#l3493"></a>
<span id="l3494">                bytesToFloats(buf, pos, v, off, span);</span><a href="#l3494"></a>
<span id="l3495">                off += span;</span><a href="#l3495"></a>
<span id="l3496">                pos += span &lt;&lt; 2;</span><a href="#l3496"></a>
<span id="l3497">            }</span><a href="#l3497"></a>
<span id="l3498">        }</span><a href="#l3498"></a>
<span id="l3499"></span><a href="#l3499"></a>
<span id="l3500">        void readLongs(long[] v, int off, int len) throws IOException {</span><a href="#l3500"></a>
<span id="l3501">            int stop, endoff = off + len;</span><a href="#l3501"></a>
<span id="l3502">            while (off &lt; endoff) {</span><a href="#l3502"></a>
<span id="l3503">                if (!blkmode) {</span><a href="#l3503"></a>
<span id="l3504">                    int span = Math.min(endoff - off, MAX_BLOCK_SIZE &gt;&gt; 3);</span><a href="#l3504"></a>
<span id="l3505">                    in.readFully(buf, 0, span &lt;&lt; 3);</span><a href="#l3505"></a>
<span id="l3506">                    stop = off + span;</span><a href="#l3506"></a>
<span id="l3507">                    pos = 0;</span><a href="#l3507"></a>
<span id="l3508">                } else if (end - pos &lt; 8) {</span><a href="#l3508"></a>
<span id="l3509">                    v[off++] = din.readLong();</span><a href="#l3509"></a>
<span id="l3510">                    continue;</span><a href="#l3510"></a>
<span id="l3511">                } else {</span><a href="#l3511"></a>
<span id="l3512">                    stop = Math.min(endoff, off + ((end - pos) &gt;&gt; 3));</span><a href="#l3512"></a>
<span id="l3513">                }</span><a href="#l3513"></a>
<span id="l3514"></span><a href="#l3514"></a>
<span id="l3515">                while (off &lt; stop) {</span><a href="#l3515"></a>
<span id="l3516">                    v[off++] = Bits.getLong(buf, pos);</span><a href="#l3516"></a>
<span id="l3517">                    pos += 8;</span><a href="#l3517"></a>
<span id="l3518">                }</span><a href="#l3518"></a>
<span id="l3519">            }</span><a href="#l3519"></a>
<span id="l3520">        }</span><a href="#l3520"></a>
<span id="l3521"></span><a href="#l3521"></a>
<span id="l3522">        void readDoubles(double[] v, int off, int len) throws IOException {</span><a href="#l3522"></a>
<span id="l3523">            int span, endoff = off + len;</span><a href="#l3523"></a>
<span id="l3524">            while (off &lt; endoff) {</span><a href="#l3524"></a>
<span id="l3525">                if (!blkmode) {</span><a href="#l3525"></a>
<span id="l3526">                    span = Math.min(endoff - off, MAX_BLOCK_SIZE &gt;&gt; 3);</span><a href="#l3526"></a>
<span id="l3527">                    in.readFully(buf, 0, span &lt;&lt; 3);</span><a href="#l3527"></a>
<span id="l3528">                    pos = 0;</span><a href="#l3528"></a>
<span id="l3529">                } else if (end - pos &lt; 8) {</span><a href="#l3529"></a>
<span id="l3530">                    v[off++] = din.readDouble();</span><a href="#l3530"></a>
<span id="l3531">                    continue;</span><a href="#l3531"></a>
<span id="l3532">                } else {</span><a href="#l3532"></a>
<span id="l3533">                    span = Math.min(endoff - off, ((end - pos) &gt;&gt; 3));</span><a href="#l3533"></a>
<span id="l3534">                }</span><a href="#l3534"></a>
<span id="l3535"></span><a href="#l3535"></a>
<span id="l3536">                bytesToDoubles(buf, pos, v, off, span);</span><a href="#l3536"></a>
<span id="l3537">                off += span;</span><a href="#l3537"></a>
<span id="l3538">                pos += span &lt;&lt; 3;</span><a href="#l3538"></a>
<span id="l3539">            }</span><a href="#l3539"></a>
<span id="l3540">        }</span><a href="#l3540"></a>
<span id="l3541"></span><a href="#l3541"></a>
<span id="l3542">        /**</span><a href="#l3542"></a>
<span id="l3543">         * Reads in string written in &quot;long&quot; UTF format.  &quot;Long&quot; UTF format is</span><a href="#l3543"></a>
<span id="l3544">         * identical to standard UTF, except that it uses an 8 byte header</span><a href="#l3544"></a>
<span id="l3545">         * (instead of the standard 2 bytes) to convey the UTF encoding length.</span><a href="#l3545"></a>
<span id="l3546">         */</span><a href="#l3546"></a>
<span id="l3547">        String readLongUTF() throws IOException {</span><a href="#l3547"></a>
<span id="l3548">            return readUTFBody(readLong());</span><a href="#l3548"></a>
<span id="l3549">        }</span><a href="#l3549"></a>
<span id="l3550"></span><a href="#l3550"></a>
<span id="l3551">        /**</span><a href="#l3551"></a>
<span id="l3552">         * Reads in the &quot;body&quot; (i.e., the UTF representation minus the 2-byte</span><a href="#l3552"></a>
<span id="l3553">         * or 8-byte length header) of a UTF encoding, which occupies the next</span><a href="#l3553"></a>
<span id="l3554">         * utflen bytes.</span><a href="#l3554"></a>
<span id="l3555">         */</span><a href="#l3555"></a>
<span id="l3556">        private String readUTFBody(long utflen) throws IOException {</span><a href="#l3556"></a>
<span id="l3557">            StringBuilder sbuf;</span><a href="#l3557"></a>
<span id="l3558">            if (utflen &gt; 0 &amp;&amp; utflen &lt; Integer.MAX_VALUE) {</span><a href="#l3558"></a>
<span id="l3559">                // a reasonable initial capacity based on the UTF length</span><a href="#l3559"></a>
<span id="l3560">                int initialCapacity = Math.min((int)utflen, 0xFFFF);</span><a href="#l3560"></a>
<span id="l3561">                sbuf = new StringBuilder(initialCapacity);</span><a href="#l3561"></a>
<span id="l3562">            } else {</span><a href="#l3562"></a>
<span id="l3563">                sbuf = new StringBuilder();</span><a href="#l3563"></a>
<span id="l3564">            }</span><a href="#l3564"></a>
<span id="l3565"></span><a href="#l3565"></a>
<span id="l3566">            if (!blkmode) {</span><a href="#l3566"></a>
<span id="l3567">                end = pos = 0;</span><a href="#l3567"></a>
<span id="l3568">            }</span><a href="#l3568"></a>
<span id="l3569"></span><a href="#l3569"></a>
<span id="l3570">            while (utflen &gt; 0) {</span><a href="#l3570"></a>
<span id="l3571">                int avail = end - pos;</span><a href="#l3571"></a>
<span id="l3572">                if (avail &gt;= 3 || (long) avail == utflen) {</span><a href="#l3572"></a>
<span id="l3573">                    utflen -= readUTFSpan(sbuf, utflen);</span><a href="#l3573"></a>
<span id="l3574">                } else {</span><a href="#l3574"></a>
<span id="l3575">                    if (blkmode) {</span><a href="#l3575"></a>
<span id="l3576">                        // near block boundary, read one byte at a time</span><a href="#l3576"></a>
<span id="l3577">                        utflen -= readUTFChar(sbuf, utflen);</span><a href="#l3577"></a>
<span id="l3578">                    } else {</span><a href="#l3578"></a>
<span id="l3579">                        // shift and refill buffer manually</span><a href="#l3579"></a>
<span id="l3580">                        if (avail &gt; 0) {</span><a href="#l3580"></a>
<span id="l3581">                            System.arraycopy(buf, pos, buf, 0, avail);</span><a href="#l3581"></a>
<span id="l3582">                        }</span><a href="#l3582"></a>
<span id="l3583">                        pos = 0;</span><a href="#l3583"></a>
<span id="l3584">                        end = (int) Math.min(MAX_BLOCK_SIZE, utflen);</span><a href="#l3584"></a>
<span id="l3585">                        in.readFully(buf, avail, end - avail);</span><a href="#l3585"></a>
<span id="l3586">                    }</span><a href="#l3586"></a>
<span id="l3587">                }</span><a href="#l3587"></a>
<span id="l3588">            }</span><a href="#l3588"></a>
<span id="l3589"></span><a href="#l3589"></a>
<span id="l3590">            return sbuf.toString();</span><a href="#l3590"></a>
<span id="l3591">        }</span><a href="#l3591"></a>
<span id="l3592"></span><a href="#l3592"></a>
<span id="l3593">        /**</span><a href="#l3593"></a>
<span id="l3594">         * Reads span of UTF-encoded characters out of internal buffer</span><a href="#l3594"></a>
<span id="l3595">         * (starting at offset pos and ending at or before offset end),</span><a href="#l3595"></a>
<span id="l3596">         * consuming no more than utflen bytes.  Appends read characters to</span><a href="#l3596"></a>
<span id="l3597">         * sbuf.  Returns the number of bytes consumed.</span><a href="#l3597"></a>
<span id="l3598">         */</span><a href="#l3598"></a>
<span id="l3599">        private long readUTFSpan(StringBuilder sbuf, long utflen)</span><a href="#l3599"></a>
<span id="l3600">            throws IOException</span><a href="#l3600"></a>
<span id="l3601">        {</span><a href="#l3601"></a>
<span id="l3602">            int cpos = 0;</span><a href="#l3602"></a>
<span id="l3603">            int start = pos;</span><a href="#l3603"></a>
<span id="l3604">            int avail = Math.min(end - pos, CHAR_BUF_SIZE);</span><a href="#l3604"></a>
<span id="l3605">            // stop short of last char unless all of utf bytes in buffer</span><a href="#l3605"></a>
<span id="l3606">            int stop = pos + ((utflen &gt; avail) ? avail - 2 : (int) utflen);</span><a href="#l3606"></a>
<span id="l3607">            boolean outOfBounds = false;</span><a href="#l3607"></a>
<span id="l3608"></span><a href="#l3608"></a>
<span id="l3609">            try {</span><a href="#l3609"></a>
<span id="l3610">                while (pos &lt; stop) {</span><a href="#l3610"></a>
<span id="l3611">                    int b1, b2, b3;</span><a href="#l3611"></a>
<span id="l3612">                    b1 = buf[pos++] &amp; 0xFF;</span><a href="#l3612"></a>
<span id="l3613">                    switch (b1 &gt;&gt; 4) {</span><a href="#l3613"></a>
<span id="l3614">                        case 0:</span><a href="#l3614"></a>
<span id="l3615">                        case 1:</span><a href="#l3615"></a>
<span id="l3616">                        case 2:</span><a href="#l3616"></a>
<span id="l3617">                        case 3:</span><a href="#l3617"></a>
<span id="l3618">                        case 4:</span><a href="#l3618"></a>
<span id="l3619">                        case 5:</span><a href="#l3619"></a>
<span id="l3620">                        case 6:</span><a href="#l3620"></a>
<span id="l3621">                        case 7:   // 1 byte format: 0xxxxxxx</span><a href="#l3621"></a>
<span id="l3622">                            cbuf[cpos++] = (char) b1;</span><a href="#l3622"></a>
<span id="l3623">                            break;</span><a href="#l3623"></a>
<span id="l3624"></span><a href="#l3624"></a>
<span id="l3625">                        case 12:</span><a href="#l3625"></a>
<span id="l3626">                        case 13:  // 2 byte format: 110xxxxx 10xxxxxx</span><a href="#l3626"></a>
<span id="l3627">                            b2 = buf[pos++];</span><a href="#l3627"></a>
<span id="l3628">                            if ((b2 &amp; 0xC0) != 0x80) {</span><a href="#l3628"></a>
<span id="l3629">                                throw new UTFDataFormatException();</span><a href="#l3629"></a>
<span id="l3630">                            }</span><a href="#l3630"></a>
<span id="l3631">                            cbuf[cpos++] = (char) (((b1 &amp; 0x1F) &lt;&lt; 6) |</span><a href="#l3631"></a>
<span id="l3632">                                                   ((b2 &amp; 0x3F) &lt;&lt; 0));</span><a href="#l3632"></a>
<span id="l3633">                            break;</span><a href="#l3633"></a>
<span id="l3634"></span><a href="#l3634"></a>
<span id="l3635">                        case 14:  // 3 byte format: 1110xxxx 10xxxxxx 10xxxxxx</span><a href="#l3635"></a>
<span id="l3636">                            b3 = buf[pos + 1];</span><a href="#l3636"></a>
<span id="l3637">                            b2 = buf[pos + 0];</span><a href="#l3637"></a>
<span id="l3638">                            pos += 2;</span><a href="#l3638"></a>
<span id="l3639">                            if ((b2 &amp; 0xC0) != 0x80 || (b3 &amp; 0xC0) != 0x80) {</span><a href="#l3639"></a>
<span id="l3640">                                throw new UTFDataFormatException();</span><a href="#l3640"></a>
<span id="l3641">                            }</span><a href="#l3641"></a>
<span id="l3642">                            cbuf[cpos++] = (char) (((b1 &amp; 0x0F) &lt;&lt; 12) |</span><a href="#l3642"></a>
<span id="l3643">                                                   ((b2 &amp; 0x3F) &lt;&lt; 6) |</span><a href="#l3643"></a>
<span id="l3644">                                                   ((b3 &amp; 0x3F) &lt;&lt; 0));</span><a href="#l3644"></a>
<span id="l3645">                            break;</span><a href="#l3645"></a>
<span id="l3646"></span><a href="#l3646"></a>
<span id="l3647">                        default:  // 10xx xxxx, 1111 xxxx</span><a href="#l3647"></a>
<span id="l3648">                            throw new UTFDataFormatException();</span><a href="#l3648"></a>
<span id="l3649">                    }</span><a href="#l3649"></a>
<span id="l3650">                }</span><a href="#l3650"></a>
<span id="l3651">            } catch (ArrayIndexOutOfBoundsException ex) {</span><a href="#l3651"></a>
<span id="l3652">                outOfBounds = true;</span><a href="#l3652"></a>
<span id="l3653">            } finally {</span><a href="#l3653"></a>
<span id="l3654">                if (outOfBounds || (pos - start) &gt; utflen) {</span><a href="#l3654"></a>
<span id="l3655">                    /*</span><a href="#l3655"></a>
<span id="l3656">                     * Fix for 4450867: if a malformed utf char causes the</span><a href="#l3656"></a>
<span id="l3657">                     * conversion loop to scan past the expected end of the utf</span><a href="#l3657"></a>
<span id="l3658">                     * string, only consume the expected number of utf bytes.</span><a href="#l3658"></a>
<span id="l3659">                     */</span><a href="#l3659"></a>
<span id="l3660">                    pos = start + (int) utflen;</span><a href="#l3660"></a>
<span id="l3661">                    throw new UTFDataFormatException();</span><a href="#l3661"></a>
<span id="l3662">                }</span><a href="#l3662"></a>
<span id="l3663">            }</span><a href="#l3663"></a>
<span id="l3664"></span><a href="#l3664"></a>
<span id="l3665">            sbuf.append(cbuf, 0, cpos);</span><a href="#l3665"></a>
<span id="l3666">            return pos - start;</span><a href="#l3666"></a>
<span id="l3667">        }</span><a href="#l3667"></a>
<span id="l3668"></span><a href="#l3668"></a>
<span id="l3669">        /**</span><a href="#l3669"></a>
<span id="l3670">         * Reads in single UTF-encoded character one byte at a time, appends</span><a href="#l3670"></a>
<span id="l3671">         * the character to sbuf, and returns the number of bytes consumed.</span><a href="#l3671"></a>
<span id="l3672">         * This method is used when reading in UTF strings written in block</span><a href="#l3672"></a>
<span id="l3673">         * data mode to handle UTF-encoded characters which (potentially)</span><a href="#l3673"></a>
<span id="l3674">         * straddle block-data boundaries.</span><a href="#l3674"></a>
<span id="l3675">         */</span><a href="#l3675"></a>
<span id="l3676">        private int readUTFChar(StringBuilder sbuf, long utflen)</span><a href="#l3676"></a>
<span id="l3677">            throws IOException</span><a href="#l3677"></a>
<span id="l3678">        {</span><a href="#l3678"></a>
<span id="l3679">            int b1, b2, b3;</span><a href="#l3679"></a>
<span id="l3680">            b1 = readByte() &amp; 0xFF;</span><a href="#l3680"></a>
<span id="l3681">            switch (b1 &gt;&gt; 4) {</span><a href="#l3681"></a>
<span id="l3682">                case 0:</span><a href="#l3682"></a>
<span id="l3683">                case 1:</span><a href="#l3683"></a>
<span id="l3684">                case 2:</span><a href="#l3684"></a>
<span id="l3685">                case 3:</span><a href="#l3685"></a>
<span id="l3686">                case 4:</span><a href="#l3686"></a>
<span id="l3687">                case 5:</span><a href="#l3687"></a>
<span id="l3688">                case 6:</span><a href="#l3688"></a>
<span id="l3689">                case 7:     // 1 byte format: 0xxxxxxx</span><a href="#l3689"></a>
<span id="l3690">                    sbuf.append((char) b1);</span><a href="#l3690"></a>
<span id="l3691">                    return 1;</span><a href="#l3691"></a>
<span id="l3692"></span><a href="#l3692"></a>
<span id="l3693">                case 12:</span><a href="#l3693"></a>
<span id="l3694">                case 13:    // 2 byte format: 110xxxxx 10xxxxxx</span><a href="#l3694"></a>
<span id="l3695">                    if (utflen &lt; 2) {</span><a href="#l3695"></a>
<span id="l3696">                        throw new UTFDataFormatException();</span><a href="#l3696"></a>
<span id="l3697">                    }</span><a href="#l3697"></a>
<span id="l3698">                    b2 = readByte();</span><a href="#l3698"></a>
<span id="l3699">                    if ((b2 &amp; 0xC0) != 0x80) {</span><a href="#l3699"></a>
<span id="l3700">                        throw new UTFDataFormatException();</span><a href="#l3700"></a>
<span id="l3701">                    }</span><a href="#l3701"></a>
<span id="l3702">                    sbuf.append((char) (((b1 &amp; 0x1F) &lt;&lt; 6) |</span><a href="#l3702"></a>
<span id="l3703">                                        ((b2 &amp; 0x3F) &lt;&lt; 0)));</span><a href="#l3703"></a>
<span id="l3704">                    return 2;</span><a href="#l3704"></a>
<span id="l3705"></span><a href="#l3705"></a>
<span id="l3706">                case 14:    // 3 byte format: 1110xxxx 10xxxxxx 10xxxxxx</span><a href="#l3706"></a>
<span id="l3707">                    if (utflen &lt; 3) {</span><a href="#l3707"></a>
<span id="l3708">                        if (utflen == 2) {</span><a href="#l3708"></a>
<span id="l3709">                            readByte();         // consume remaining byte</span><a href="#l3709"></a>
<span id="l3710">                        }</span><a href="#l3710"></a>
<span id="l3711">                        throw new UTFDataFormatException();</span><a href="#l3711"></a>
<span id="l3712">                    }</span><a href="#l3712"></a>
<span id="l3713">                    b2 = readByte();</span><a href="#l3713"></a>
<span id="l3714">                    b3 = readByte();</span><a href="#l3714"></a>
<span id="l3715">                    if ((b2 &amp; 0xC0) != 0x80 || (b3 &amp; 0xC0) != 0x80) {</span><a href="#l3715"></a>
<span id="l3716">                        throw new UTFDataFormatException();</span><a href="#l3716"></a>
<span id="l3717">                    }</span><a href="#l3717"></a>
<span id="l3718">                    sbuf.append((char) (((b1 &amp; 0x0F) &lt;&lt; 12) |</span><a href="#l3718"></a>
<span id="l3719">                                        ((b2 &amp; 0x3F) &lt;&lt; 6) |</span><a href="#l3719"></a>
<span id="l3720">                                        ((b3 &amp; 0x3F) &lt;&lt; 0)));</span><a href="#l3720"></a>
<span id="l3721">                    return 3;</span><a href="#l3721"></a>
<span id="l3722"></span><a href="#l3722"></a>
<span id="l3723">                default:   // 10xx xxxx, 1111 xxxx</span><a href="#l3723"></a>
<span id="l3724">                    throw new UTFDataFormatException();</span><a href="#l3724"></a>
<span id="l3725">            }</span><a href="#l3725"></a>
<span id="l3726">        }</span><a href="#l3726"></a>
<span id="l3727"></span><a href="#l3727"></a>
<span id="l3728">        /**</span><a href="#l3728"></a>
<span id="l3729">         * Returns the number of bytes read from the input stream.</span><a href="#l3729"></a>
<span id="l3730">         * @return the number of bytes read from the input stream</span><a href="#l3730"></a>
<span id="l3731">         */</span><a href="#l3731"></a>
<span id="l3732">        long getBytesRead() {</span><a href="#l3732"></a>
<span id="l3733">            return in.getBytesRead();</span><a href="#l3733"></a>
<span id="l3734">        }</span><a href="#l3734"></a>
<span id="l3735">    }</span><a href="#l3735"></a>
<span id="l3736"></span><a href="#l3736"></a>
<span id="l3737">    /**</span><a href="#l3737"></a>
<span id="l3738">     * Unsynchronized table which tracks wire handle to object mappings, as</span><a href="#l3738"></a>
<span id="l3739">     * well as ClassNotFoundExceptions associated with deserialized objects.</span><a href="#l3739"></a>
<span id="l3740">     * This class implements an exception-propagation algorithm for</span><a href="#l3740"></a>
<span id="l3741">     * determining which objects should have ClassNotFoundExceptions associated</span><a href="#l3741"></a>
<span id="l3742">     * with them, taking into account cycles and discontinuities (e.g., skipped</span><a href="#l3742"></a>
<span id="l3743">     * fields) in the object graph.</span><a href="#l3743"></a>
<span id="l3744">     *</span><a href="#l3744"></a>
<span id="l3745">     * &lt;p&gt;General use of the table is as follows: during deserialization, a</span><a href="#l3745"></a>
<span id="l3746">     * given object is first assigned a handle by calling the assign method.</span><a href="#l3746"></a>
<span id="l3747">     * This method leaves the assigned handle in an &quot;open&quot; state, wherein</span><a href="#l3747"></a>
<span id="l3748">     * dependencies on the exception status of other handles can be registered</span><a href="#l3748"></a>
<span id="l3749">     * by calling the markDependency method, or an exception can be directly</span><a href="#l3749"></a>
<span id="l3750">     * associated with the handle by calling markException.  When a handle is</span><a href="#l3750"></a>
<span id="l3751">     * tagged with an exception, the HandleTable assumes responsibility for</span><a href="#l3751"></a>
<span id="l3752">     * propagating the exception to any other objects which depend</span><a href="#l3752"></a>
<span id="l3753">     * (transitively) on the exception-tagged object.</span><a href="#l3753"></a>
<span id="l3754">     *</span><a href="#l3754"></a>
<span id="l3755">     * &lt;p&gt;Once all exception information/dependencies for the handle have been</span><a href="#l3755"></a>
<span id="l3756">     * registered, the handle should be &quot;closed&quot; by calling the finish method</span><a href="#l3756"></a>
<span id="l3757">     * on it.  The act of finishing a handle allows the exception propagation</span><a href="#l3757"></a>
<span id="l3758">     * algorithm to aggressively prune dependency links, lessening the</span><a href="#l3758"></a>
<span id="l3759">     * performance/memory impact of exception tracking.</span><a href="#l3759"></a>
<span id="l3760">     *</span><a href="#l3760"></a>
<span id="l3761">     * &lt;p&gt;Note that the exception propagation algorithm used depends on handles</span><a href="#l3761"></a>
<span id="l3762">     * being assigned/finished in LIFO order; however, for simplicity as well</span><a href="#l3762"></a>
<span id="l3763">     * as memory conservation, it does not enforce this constraint.</span><a href="#l3763"></a>
<span id="l3764">     */</span><a href="#l3764"></a>
<span id="l3765">    // REMIND: add full description of exception propagation algorithm?</span><a href="#l3765"></a>
<span id="l3766">    private static class HandleTable {</span><a href="#l3766"></a>
<span id="l3767"></span><a href="#l3767"></a>
<span id="l3768">        /* status codes indicating whether object has associated exception */</span><a href="#l3768"></a>
<span id="l3769">        private static final byte STATUS_OK = 1;</span><a href="#l3769"></a>
<span id="l3770">        private static final byte STATUS_UNKNOWN = 2;</span><a href="#l3770"></a>
<span id="l3771">        private static final byte STATUS_EXCEPTION = 3;</span><a href="#l3771"></a>
<span id="l3772"></span><a href="#l3772"></a>
<span id="l3773">        /** array mapping handle -&gt; object status */</span><a href="#l3773"></a>
<span id="l3774">        byte[] status;</span><a href="#l3774"></a>
<span id="l3775">        /** array mapping handle -&gt; object/exception (depending on status) */</span><a href="#l3775"></a>
<span id="l3776">        Object[] entries;</span><a href="#l3776"></a>
<span id="l3777">        /** array mapping handle -&gt; list of dependent handles (if any) */</span><a href="#l3777"></a>
<span id="l3778">        HandleList[] deps;</span><a href="#l3778"></a>
<span id="l3779">        /** lowest unresolved dependency */</span><a href="#l3779"></a>
<span id="l3780">        int lowDep = -1;</span><a href="#l3780"></a>
<span id="l3781">        /** number of handles in table */</span><a href="#l3781"></a>
<span id="l3782">        int size = 0;</span><a href="#l3782"></a>
<span id="l3783"></span><a href="#l3783"></a>
<span id="l3784">        /**</span><a href="#l3784"></a>
<span id="l3785">         * Creates handle table with the given initial capacity.</span><a href="#l3785"></a>
<span id="l3786">         */</span><a href="#l3786"></a>
<span id="l3787">        HandleTable(int initialCapacity) {</span><a href="#l3787"></a>
<span id="l3788">            status = new byte[initialCapacity];</span><a href="#l3788"></a>
<span id="l3789">            entries = new Object[initialCapacity];</span><a href="#l3789"></a>
<span id="l3790">            deps = new HandleList[initialCapacity];</span><a href="#l3790"></a>
<span id="l3791">        }</span><a href="#l3791"></a>
<span id="l3792"></span><a href="#l3792"></a>
<span id="l3793">        /**</span><a href="#l3793"></a>
<span id="l3794">         * Assigns next available handle to given object, and returns assigned</span><a href="#l3794"></a>
<span id="l3795">         * handle.  Once object has been completely deserialized (and all</span><a href="#l3795"></a>
<span id="l3796">         * dependencies on other objects identified), the handle should be</span><a href="#l3796"></a>
<span id="l3797">         * &quot;closed&quot; by passing it to finish().</span><a href="#l3797"></a>
<span id="l3798">         */</span><a href="#l3798"></a>
<span id="l3799">        int assign(Object obj) {</span><a href="#l3799"></a>
<span id="l3800">            if (size &gt;= entries.length) {</span><a href="#l3800"></a>
<span id="l3801">                grow();</span><a href="#l3801"></a>
<span id="l3802">            }</span><a href="#l3802"></a>
<span id="l3803">            status[size] = STATUS_UNKNOWN;</span><a href="#l3803"></a>
<span id="l3804">            entries[size] = obj;</span><a href="#l3804"></a>
<span id="l3805">            return size++;</span><a href="#l3805"></a>
<span id="l3806">        }</span><a href="#l3806"></a>
<span id="l3807"></span><a href="#l3807"></a>
<span id="l3808">        /**</span><a href="#l3808"></a>
<span id="l3809">         * Registers a dependency (in exception status) of one handle on</span><a href="#l3809"></a>
<span id="l3810">         * another.  The dependent handle must be &quot;open&quot; (i.e., assigned, but</span><a href="#l3810"></a>
<span id="l3811">         * not finished yet).  No action is taken if either dependent or target</span><a href="#l3811"></a>
<span id="l3812">         * handle is NULL_HANDLE.</span><a href="#l3812"></a>
<span id="l3813">         */</span><a href="#l3813"></a>
<span id="l3814">        void markDependency(int dependent, int target) {</span><a href="#l3814"></a>
<span id="l3815">            if (dependent == NULL_HANDLE || target == NULL_HANDLE) {</span><a href="#l3815"></a>
<span id="l3816">                return;</span><a href="#l3816"></a>
<span id="l3817">            }</span><a href="#l3817"></a>
<span id="l3818">            switch (status[dependent]) {</span><a href="#l3818"></a>
<span id="l3819"></span><a href="#l3819"></a>
<span id="l3820">                case STATUS_UNKNOWN:</span><a href="#l3820"></a>
<span id="l3821">                    switch (status[target]) {</span><a href="#l3821"></a>
<span id="l3822">                        case STATUS_OK:</span><a href="#l3822"></a>
<span id="l3823">                            // ignore dependencies on objs with no exception</span><a href="#l3823"></a>
<span id="l3824">                            break;</span><a href="#l3824"></a>
<span id="l3825"></span><a href="#l3825"></a>
<span id="l3826">                        case STATUS_EXCEPTION:</span><a href="#l3826"></a>
<span id="l3827">                            // eagerly propagate exception</span><a href="#l3827"></a>
<span id="l3828">                            markException(dependent,</span><a href="#l3828"></a>
<span id="l3829">                                (ClassNotFoundException) entries[target]);</span><a href="#l3829"></a>
<span id="l3830">                            break;</span><a href="#l3830"></a>
<span id="l3831"></span><a href="#l3831"></a>
<span id="l3832">                        case STATUS_UNKNOWN:</span><a href="#l3832"></a>
<span id="l3833">                            // add to dependency list of target</span><a href="#l3833"></a>
<span id="l3834">                            if (deps[target] == null) {</span><a href="#l3834"></a>
<span id="l3835">                                deps[target] = new HandleList();</span><a href="#l3835"></a>
<span id="l3836">                            }</span><a href="#l3836"></a>
<span id="l3837">                            deps[target].add(dependent);</span><a href="#l3837"></a>
<span id="l3838"></span><a href="#l3838"></a>
<span id="l3839">                            // remember lowest unresolved target seen</span><a href="#l3839"></a>
<span id="l3840">                            if (lowDep &lt; 0 || lowDep &gt; target) {</span><a href="#l3840"></a>
<span id="l3841">                                lowDep = target;</span><a href="#l3841"></a>
<span id="l3842">                            }</span><a href="#l3842"></a>
<span id="l3843">                            break;</span><a href="#l3843"></a>
<span id="l3844"></span><a href="#l3844"></a>
<span id="l3845">                        default:</span><a href="#l3845"></a>
<span id="l3846">                            throw new InternalError();</span><a href="#l3846"></a>
<span id="l3847">                    }</span><a href="#l3847"></a>
<span id="l3848">                    break;</span><a href="#l3848"></a>
<span id="l3849"></span><a href="#l3849"></a>
<span id="l3850">                case STATUS_EXCEPTION:</span><a href="#l3850"></a>
<span id="l3851">                    break;</span><a href="#l3851"></a>
<span id="l3852"></span><a href="#l3852"></a>
<span id="l3853">                default:</span><a href="#l3853"></a>
<span id="l3854">                    throw new InternalError();</span><a href="#l3854"></a>
<span id="l3855">            }</span><a href="#l3855"></a>
<span id="l3856">        }</span><a href="#l3856"></a>
<span id="l3857"></span><a href="#l3857"></a>
<span id="l3858">        /**</span><a href="#l3858"></a>
<span id="l3859">         * Associates a ClassNotFoundException (if one not already associated)</span><a href="#l3859"></a>
<span id="l3860">         * with the currently active handle and propagates it to other</span><a href="#l3860"></a>
<span id="l3861">         * referencing objects as appropriate.  The specified handle must be</span><a href="#l3861"></a>
<span id="l3862">         * &quot;open&quot; (i.e., assigned, but not finished yet).</span><a href="#l3862"></a>
<span id="l3863">         */</span><a href="#l3863"></a>
<span id="l3864">        void markException(int handle, ClassNotFoundException ex) {</span><a href="#l3864"></a>
<span id="l3865">            switch (status[handle]) {</span><a href="#l3865"></a>
<span id="l3866">                case STATUS_UNKNOWN:</span><a href="#l3866"></a>
<span id="l3867">                    status[handle] = STATUS_EXCEPTION;</span><a href="#l3867"></a>
<span id="l3868">                    entries[handle] = ex;</span><a href="#l3868"></a>
<span id="l3869"></span><a href="#l3869"></a>
<span id="l3870">                    // propagate exception to dependents</span><a href="#l3870"></a>
<span id="l3871">                    HandleList dlist = deps[handle];</span><a href="#l3871"></a>
<span id="l3872">                    if (dlist != null) {</span><a href="#l3872"></a>
<span id="l3873">                        int ndeps = dlist.size();</span><a href="#l3873"></a>
<span id="l3874">                        for (int i = 0; i &lt; ndeps; i++) {</span><a href="#l3874"></a>
<span id="l3875">                            markException(dlist.get(i), ex);</span><a href="#l3875"></a>
<span id="l3876">                        }</span><a href="#l3876"></a>
<span id="l3877">                        deps[handle] = null;</span><a href="#l3877"></a>
<span id="l3878">                    }</span><a href="#l3878"></a>
<span id="l3879">                    break;</span><a href="#l3879"></a>
<span id="l3880"></span><a href="#l3880"></a>
<span id="l3881">                case STATUS_EXCEPTION:</span><a href="#l3881"></a>
<span id="l3882">                    break;</span><a href="#l3882"></a>
<span id="l3883"></span><a href="#l3883"></a>
<span id="l3884">                default:</span><a href="#l3884"></a>
<span id="l3885">                    throw new InternalError();</span><a href="#l3885"></a>
<span id="l3886">            }</span><a href="#l3886"></a>
<span id="l3887">        }</span><a href="#l3887"></a>
<span id="l3888"></span><a href="#l3888"></a>
<span id="l3889">        /**</span><a href="#l3889"></a>
<span id="l3890">         * Marks given handle as finished, meaning that no new dependencies</span><a href="#l3890"></a>
<span id="l3891">         * will be marked for handle.  Calls to the assign and finish methods</span><a href="#l3891"></a>
<span id="l3892">         * must occur in LIFO order.</span><a href="#l3892"></a>
<span id="l3893">         */</span><a href="#l3893"></a>
<span id="l3894">        void finish(int handle) {</span><a href="#l3894"></a>
<span id="l3895">            int end;</span><a href="#l3895"></a>
<span id="l3896">            if (lowDep &lt; 0) {</span><a href="#l3896"></a>
<span id="l3897">                // no pending unknowns, only resolve current handle</span><a href="#l3897"></a>
<span id="l3898">                end = handle + 1;</span><a href="#l3898"></a>
<span id="l3899">            } else if (lowDep &gt;= handle) {</span><a href="#l3899"></a>
<span id="l3900">                // pending unknowns now clearable, resolve all upward handles</span><a href="#l3900"></a>
<span id="l3901">                end = size;</span><a href="#l3901"></a>
<span id="l3902">                lowDep = -1;</span><a href="#l3902"></a>
<span id="l3903">            } else {</span><a href="#l3903"></a>
<span id="l3904">                // unresolved backrefs present, can't resolve anything yet</span><a href="#l3904"></a>
<span id="l3905">                return;</span><a href="#l3905"></a>
<span id="l3906">            }</span><a href="#l3906"></a>
<span id="l3907"></span><a href="#l3907"></a>
<span id="l3908">            // change STATUS_UNKNOWN -&gt; STATUS_OK in selected span of handles</span><a href="#l3908"></a>
<span id="l3909">            for (int i = handle; i &lt; end; i++) {</span><a href="#l3909"></a>
<span id="l3910">                switch (status[i]) {</span><a href="#l3910"></a>
<span id="l3911">                    case STATUS_UNKNOWN:</span><a href="#l3911"></a>
<span id="l3912">                        status[i] = STATUS_OK;</span><a href="#l3912"></a>
<span id="l3913">                        deps[i] = null;</span><a href="#l3913"></a>
<span id="l3914">                        break;</span><a href="#l3914"></a>
<span id="l3915"></span><a href="#l3915"></a>
<span id="l3916">                    case STATUS_OK:</span><a href="#l3916"></a>
<span id="l3917">                    case STATUS_EXCEPTION:</span><a href="#l3917"></a>
<span id="l3918">                        break;</span><a href="#l3918"></a>
<span id="l3919"></span><a href="#l3919"></a>
<span id="l3920">                    default:</span><a href="#l3920"></a>
<span id="l3921">                        throw new InternalError();</span><a href="#l3921"></a>
<span id="l3922">                }</span><a href="#l3922"></a>
<span id="l3923">            }</span><a href="#l3923"></a>
<span id="l3924">        }</span><a href="#l3924"></a>
<span id="l3925"></span><a href="#l3925"></a>
<span id="l3926">        /**</span><a href="#l3926"></a>
<span id="l3927">         * Assigns a new object to the given handle.  The object previously</span><a href="#l3927"></a>
<span id="l3928">         * associated with the handle is forgotten.  This method has no effect</span><a href="#l3928"></a>
<span id="l3929">         * if the given handle already has an exception associated with it.</span><a href="#l3929"></a>
<span id="l3930">         * This method may be called at any time after the handle is assigned.</span><a href="#l3930"></a>
<span id="l3931">         */</span><a href="#l3931"></a>
<span id="l3932">        void setObject(int handle, Object obj) {</span><a href="#l3932"></a>
<span id="l3933">            switch (status[handle]) {</span><a href="#l3933"></a>
<span id="l3934">                case STATUS_UNKNOWN:</span><a href="#l3934"></a>
<span id="l3935">                case STATUS_OK:</span><a href="#l3935"></a>
<span id="l3936">                    entries[handle] = obj;</span><a href="#l3936"></a>
<span id="l3937">                    break;</span><a href="#l3937"></a>
<span id="l3938"></span><a href="#l3938"></a>
<span id="l3939">                case STATUS_EXCEPTION:</span><a href="#l3939"></a>
<span id="l3940">                    break;</span><a href="#l3940"></a>
<span id="l3941"></span><a href="#l3941"></a>
<span id="l3942">                default:</span><a href="#l3942"></a>
<span id="l3943">                    throw new InternalError();</span><a href="#l3943"></a>
<span id="l3944">            }</span><a href="#l3944"></a>
<span id="l3945">        }</span><a href="#l3945"></a>
<span id="l3946"></span><a href="#l3946"></a>
<span id="l3947">        /**</span><a href="#l3947"></a>
<span id="l3948">         * Looks up and returns object associated with the given handle.</span><a href="#l3948"></a>
<span id="l3949">         * Returns null if the given handle is NULL_HANDLE, or if it has an</span><a href="#l3949"></a>
<span id="l3950">         * associated ClassNotFoundException.</span><a href="#l3950"></a>
<span id="l3951">         */</span><a href="#l3951"></a>
<span id="l3952">        Object lookupObject(int handle) {</span><a href="#l3952"></a>
<span id="l3953">            return (handle != NULL_HANDLE &amp;&amp;</span><a href="#l3953"></a>
<span id="l3954">                    status[handle] != STATUS_EXCEPTION) ?</span><a href="#l3954"></a>
<span id="l3955">                entries[handle] : null;</span><a href="#l3955"></a>
<span id="l3956">        }</span><a href="#l3956"></a>
<span id="l3957"></span><a href="#l3957"></a>
<span id="l3958">        /**</span><a href="#l3958"></a>
<span id="l3959">         * Looks up and returns ClassNotFoundException associated with the</span><a href="#l3959"></a>
<span id="l3960">         * given handle.  Returns null if the given handle is NULL_HANDLE, or</span><a href="#l3960"></a>
<span id="l3961">         * if there is no ClassNotFoundException associated with the handle.</span><a href="#l3961"></a>
<span id="l3962">         */</span><a href="#l3962"></a>
<span id="l3963">        ClassNotFoundException lookupException(int handle) {</span><a href="#l3963"></a>
<span id="l3964">            return (handle != NULL_HANDLE &amp;&amp;</span><a href="#l3964"></a>
<span id="l3965">                    status[handle] == STATUS_EXCEPTION) ?</span><a href="#l3965"></a>
<span id="l3966">                (ClassNotFoundException) entries[handle] : null;</span><a href="#l3966"></a>
<span id="l3967">        }</span><a href="#l3967"></a>
<span id="l3968"></span><a href="#l3968"></a>
<span id="l3969">        /**</span><a href="#l3969"></a>
<span id="l3970">         * Resets table to its initial state.</span><a href="#l3970"></a>
<span id="l3971">         */</span><a href="#l3971"></a>
<span id="l3972">        void clear() {</span><a href="#l3972"></a>
<span id="l3973">            Arrays.fill(status, 0, size, (byte) 0);</span><a href="#l3973"></a>
<span id="l3974">            Arrays.fill(entries, 0, size, null);</span><a href="#l3974"></a>
<span id="l3975">            Arrays.fill(deps, 0, size, null);</span><a href="#l3975"></a>
<span id="l3976">            lowDep = -1;</span><a href="#l3976"></a>
<span id="l3977">            size = 0;</span><a href="#l3977"></a>
<span id="l3978">        }</span><a href="#l3978"></a>
<span id="l3979"></span><a href="#l3979"></a>
<span id="l3980">        /**</span><a href="#l3980"></a>
<span id="l3981">         * Returns number of handles registered in table.</span><a href="#l3981"></a>
<span id="l3982">         */</span><a href="#l3982"></a>
<span id="l3983">        int size() {</span><a href="#l3983"></a>
<span id="l3984">            return size;</span><a href="#l3984"></a>
<span id="l3985">        }</span><a href="#l3985"></a>
<span id="l3986"></span><a href="#l3986"></a>
<span id="l3987">        /**</span><a href="#l3987"></a>
<span id="l3988">         * Expands capacity of internal arrays.</span><a href="#l3988"></a>
<span id="l3989">         */</span><a href="#l3989"></a>
<span id="l3990">        private void grow() {</span><a href="#l3990"></a>
<span id="l3991">            int newCapacity = (entries.length &lt;&lt; 1) + 1;</span><a href="#l3991"></a>
<span id="l3992"></span><a href="#l3992"></a>
<span id="l3993">            byte[] newStatus = new byte[newCapacity];</span><a href="#l3993"></a>
<span id="l3994">            Object[] newEntries = new Object[newCapacity];</span><a href="#l3994"></a>
<span id="l3995">            HandleList[] newDeps = new HandleList[newCapacity];</span><a href="#l3995"></a>
<span id="l3996"></span><a href="#l3996"></a>
<span id="l3997">            System.arraycopy(status, 0, newStatus, 0, size);</span><a href="#l3997"></a>
<span id="l3998">            System.arraycopy(entries, 0, newEntries, 0, size);</span><a href="#l3998"></a>
<span id="l3999">            System.arraycopy(deps, 0, newDeps, 0, size);</span><a href="#l3999"></a>
<span id="l4000"></span><a href="#l4000"></a>
<span id="l4001">            status = newStatus;</span><a href="#l4001"></a>
<span id="l4002">            entries = newEntries;</span><a href="#l4002"></a>
<span id="l4003">            deps = newDeps;</span><a href="#l4003"></a>
<span id="l4004">        }</span><a href="#l4004"></a>
<span id="l4005"></span><a href="#l4005"></a>
<span id="l4006">        /**</span><a href="#l4006"></a>
<span id="l4007">         * Simple growable list of (integer) handles.</span><a href="#l4007"></a>
<span id="l4008">         */</span><a href="#l4008"></a>
<span id="l4009">        private static class HandleList {</span><a href="#l4009"></a>
<span id="l4010">            private int[] list = new int[4];</span><a href="#l4010"></a>
<span id="l4011">            private int size = 0;</span><a href="#l4011"></a>
<span id="l4012"></span><a href="#l4012"></a>
<span id="l4013">            public HandleList() {</span><a href="#l4013"></a>
<span id="l4014">            }</span><a href="#l4014"></a>
<span id="l4015"></span><a href="#l4015"></a>
<span id="l4016">            public void add(int handle) {</span><a href="#l4016"></a>
<span id="l4017">                if (size &gt;= list.length) {</span><a href="#l4017"></a>
<span id="l4018">                    int[] newList = new int[list.length &lt;&lt; 1];</span><a href="#l4018"></a>
<span id="l4019">                    System.arraycopy(list, 0, newList, 0, list.length);</span><a href="#l4019"></a>
<span id="l4020">                    list = newList;</span><a href="#l4020"></a>
<span id="l4021">                }</span><a href="#l4021"></a>
<span id="l4022">                list[size++] = handle;</span><a href="#l4022"></a>
<span id="l4023">            }</span><a href="#l4023"></a>
<span id="l4024"></span><a href="#l4024"></a>
<span id="l4025">            public int get(int index) {</span><a href="#l4025"></a>
<span id="l4026">                if (index &gt;= size) {</span><a href="#l4026"></a>
<span id="l4027">                    throw new ArrayIndexOutOfBoundsException();</span><a href="#l4027"></a>
<span id="l4028">                }</span><a href="#l4028"></a>
<span id="l4029">                return list[index];</span><a href="#l4029"></a>
<span id="l4030">            }</span><a href="#l4030"></a>
<span id="l4031"></span><a href="#l4031"></a>
<span id="l4032">            public int size() {</span><a href="#l4032"></a>
<span id="l4033">                return size;</span><a href="#l4033"></a>
<span id="l4034">            }</span><a href="#l4034"></a>
<span id="l4035">        }</span><a href="#l4035"></a>
<span id="l4036">    }</span><a href="#l4036"></a>
<span id="l4037"></span><a href="#l4037"></a>
<span id="l4038">    /**</span><a href="#l4038"></a>
<span id="l4039">     * Method for cloning arrays in case of using unsharing reading</span><a href="#l4039"></a>
<span id="l4040">     */</span><a href="#l4040"></a>
<span id="l4041">    private static Object cloneArray(Object array) {</span><a href="#l4041"></a>
<span id="l4042">        if (array instanceof Object[]) {</span><a href="#l4042"></a>
<span id="l4043">            return ((Object[]) array).clone();</span><a href="#l4043"></a>
<span id="l4044">        } else if (array instanceof boolean[]) {</span><a href="#l4044"></a>
<span id="l4045">            return ((boolean[]) array).clone();</span><a href="#l4045"></a>
<span id="l4046">        } else if (array instanceof byte[]) {</span><a href="#l4046"></a>
<span id="l4047">            return ((byte[]) array).clone();</span><a href="#l4047"></a>
<span id="l4048">        } else if (array instanceof char[]) {</span><a href="#l4048"></a>
<span id="l4049">            return ((char[]) array).clone();</span><a href="#l4049"></a>
<span id="l4050">        } else if (array instanceof double[]) {</span><a href="#l4050"></a>
<span id="l4051">            return ((double[]) array).clone();</span><a href="#l4051"></a>
<span id="l4052">        } else if (array instanceof float[]) {</span><a href="#l4052"></a>
<span id="l4053">            return ((float[]) array).clone();</span><a href="#l4053"></a>
<span id="l4054">        } else if (array instanceof int[]) {</span><a href="#l4054"></a>
<span id="l4055">            return ((int[]) array).clone();</span><a href="#l4055"></a>
<span id="l4056">        } else if (array instanceof long[]) {</span><a href="#l4056"></a>
<span id="l4057">            return ((long[]) array).clone();</span><a href="#l4057"></a>
<span id="l4058">        } else if (array instanceof short[]) {</span><a href="#l4058"></a>
<span id="l4059">            return ((short[]) array).clone();</span><a href="#l4059"></a>
<span id="l4060">        } else {</span><a href="#l4060"></a>
<span id="l4061">            throw new AssertionError();</span><a href="#l4061"></a>
<span id="l4062">        }</span><a href="#l4062"></a>
<span id="l4063">    }</span><a href="#l4063"></a>
<span id="l4064"></span><a href="#l4064"></a>
<span id="l4065">    private void validateDescriptor(ObjectStreamClass descriptor) {</span><a href="#l4065"></a>
<span id="l4066">        ObjectStreamClassValidator validating = validator;</span><a href="#l4066"></a>
<span id="l4067">        if (validating != null) {</span><a href="#l4067"></a>
<span id="l4068">            validating.validateDescriptor(descriptor);</span><a href="#l4068"></a>
<span id="l4069">        }</span><a href="#l4069"></a>
<span id="l4070">    }</span><a href="#l4070"></a>
<span id="l4071"></span><a href="#l4071"></a>
<span id="l4072">    // controlled access to ObjectStreamClassValidator</span><a href="#l4072"></a>
<span id="l4073">    private volatile ObjectStreamClassValidator validator;</span><a href="#l4073"></a>
<span id="l4074"></span><a href="#l4074"></a>
<span id="l4075">    private static void setValidator(ObjectInputStream ois, ObjectStreamClassValidator validator) {</span><a href="#l4075"></a>
<span id="l4076">        ois.validator = validator;</span><a href="#l4076"></a>
<span id="l4077">    }</span><a href="#l4077"></a>
<span id="l4078">    static {</span><a href="#l4078"></a>
<span id="l4079">        SharedSecrets.setJavaObjectInputStreamAccess(ObjectInputStream::setValidator);</span><a href="#l4079"></a>
<span id="l4080">        SharedSecrets.setJavaObjectInputStreamReadString(ObjectInputStream::readString);</span><a href="#l4080"></a>
<span id="l4081">    }</span><a href="#l4081"></a>
<span id="l4082">}</span><a href="#l4082"></a></pre>
