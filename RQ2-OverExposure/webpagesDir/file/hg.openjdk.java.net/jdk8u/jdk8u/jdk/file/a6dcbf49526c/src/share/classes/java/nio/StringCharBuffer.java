...
<title>jdk8u/jdk8u/jdk: a6dcbf49526c src/share/classes/java/nio/StringCharBuffer.java</title>
</head>
<body>
...
<li><a href="/jdk8u/jdk8u/jdk/file/tip/src/share/classes/java/nio/StringCharBuffer.java">latest</a></li>
<li><a href="/jdk8u/jdk8u/jdk/diff/a6dcbf49526c/src/share/classes/java/nio/StringCharBuffer.java">diff</a></li>
<li><a href="/jdk8u/jdk8u/jdk/comparison/a6dcbf49526c/src/share/classes/java/nio/StringCharBuffer.java">comparison</a></li>
<li><a href="/jdk8u/jdk8u/jdk/annotate/a6dcbf49526c/src/share/classes/java/nio/StringCharBuffer.java">annotate</a></li>
<li><a href="/jdk8u/jdk8u/jdk/log/a6dcbf49526c/src/share/classes/java/nio/StringCharBuffer.java">file log</a></li>
<li><a href="/jdk8u/jdk8u/jdk/raw-file/a6dcbf49526c/src/share/classes/java/nio/StringCharBuffer.java">raw</a></li>
</ul>
<ul>
...
<h3>view src/share/classes/java/nio/StringCharBuffer.java @ 13895:a6dcbf49526c</h3>
...
<tr>
 ...
 <td class="author"><a href="/jdk8u/jdk8u/jdk/file/1a3de3cdc684/src/share/classes/java/nio/StringCharBuffer.java">1a3de3cdc684</a> </td>
</tr>
<tr>
...
<span id="l83">    char getUnchecked(int index) {</span><a href="#l83"></a>
<span id="l84">        return str.charAt(index + offset);</span><a href="#l84"></a>
<span id="l85">    }</span><a href="#l85"></a>
<span id="l86"></span><a href="#l86"></a>
<span id="l87">    // ## Override bulk get methods for better performance</span><a href="#l87"></a>
<span id="l88"></span><a href="#l88"></a>
<span id="l89">    public final CharBuffer put(char c) {</span><a href="#l89"></a>
...
<span id="l93">    public final CharBuffer put(int index, char c) {</span><a href="#l93"></a>
...
<span id="l97">    public final CharBuffer compact() {</span><a href="#l97"></a>
<span id="l98">        throw new ReadOnlyBufferException();</span><a href="#l98"></a>
<span id="l99">    }</span><a href="#l99"></a>
<span id="l100"></span><a href="#l100"></a>
<span id="l101">    public final boolean isReadOnly() {</span><a href="#l101"></a>
<span id="l102">        return true;</span><a href="#l102"></a>
<span id="l103">    }</span><a href="#l103"></a>
<span id="l104"></span><a href="#l104"></a>
<span id="l105">    final String toString(int start, int end) {</span><a href="#l105"></a>
<span id="l106">        return str.toString().substring(start + offset, end + offset);</span><a href="#l106"></a>
<span id="l107">    }</span><a href="#l107"></a>
<span id="l108"></span><a href="#l108"></a>
<span id="l109">    public final CharBuffer subSequence(int start, int end) {</span><a href="#l109"></a>
<span id="l110">        try {</span><a href="#l110"></a>
<span id="l111">            int pos = position();</span><a href="#l111"></a>
<span id="l112">            return new StringCharBuffer(str,</span><a href="#l112"></a>
<span id="l113">                                        -1,</span><a href="#l113"></a>
<span id="l114">                                        pos + checkIndex(start, pos),</span><a href="#l114"></a>
<span id="l115">                                        pos + checkIndex(end, pos),</span><a href="#l115"></a>
<span id="l116">                                        capacity(),</span><a href="#l116"></a>
<span id="l117">                                        offset);</span><a href="#l117"></a>
<span id="l118">        } catch (IllegalArgumentException x) {</span><a href="#l118"></a>
<span id="l119">            throw new IndexOutOfBoundsException();</span><a href="#l119"></a>
<span id="l120">        }</span><a href="#l120"></a>
<span id="l121">    }</span><a href="#l121"></a>
<span id="l122"></span><a href="#l122"></a>
<span id="l123">    public boolean isDirect() {</span><a href="#l123"></a>
<span id="l124">        return false;</span><a href="#l124"></a>
<span id="l125">    }</span><a href="#l125"></a>
<span id="l126"></span><a href="#l126"></a>
<span id="l127">    public ByteOrder order() {</span><a href="#l127"></a>
<span id="l128">        return ByteOrder.nativeOrder();</span><a href="#l128"></a>
<span id="l129">    }</span><a href="#l129"></a>
<span id="l130"></span><a href="#l130"></a>
<span id="l131">}</span><a href="#l131"></a></pre>
