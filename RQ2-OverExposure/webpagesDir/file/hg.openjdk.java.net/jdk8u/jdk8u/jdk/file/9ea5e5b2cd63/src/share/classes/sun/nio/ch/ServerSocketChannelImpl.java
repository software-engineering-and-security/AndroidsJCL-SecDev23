...
<title>jdk8u/jdk8u/jdk: 9ea5e5b2cd63 src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java</title>
</head>
<body>
...
<li><a href="/jdk8u/jdk8u/jdk/file/tip/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">latest</a></li>
<li><a href="/jdk8u/jdk8u/jdk/diff/9ea5e5b2cd63/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">diff</a></li>
<li><a href="/jdk8u/jdk8u/jdk/comparison/9ea5e5b2cd63/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">comparison</a></li>
<li><a href="/jdk8u/jdk8u/jdk/annotate/9ea5e5b2cd63/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">annotate</a></li>
<li><a href="/jdk8u/jdk8u/jdk/log/9ea5e5b2cd63/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">file log</a></li>
<li><a href="/jdk8u/jdk8u/jdk/raw-file/9ea5e5b2cd63/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">raw</a></li>
</ul>
<ul>
...
<h3>view src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java @ 13794:9ea5e5b2cd63</h3>
...
<tr>
 ...
 <td class="author"><a href="/jdk8u/jdk8u/jdk/file/98ec3f89656c/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">98ec3f89656c</a> </td>
</tr>
<tr>
 <th class="author">children</th>
 <td class="author"><a href="/jdk8u/jdk8u/jdk/file/3c1716a44d94/src/share/classes/sun/nio/ch/ServerSocketChannelImpl.java">3c1716a44d94</a> </td>
</tr>
</table>
...
<span id="l247">                    n = accept(this.fd, newfd, isaa);</span><a href="#l247"></a>
...
<span id="l411">     * Accept a connection on a socket.</span><a href="#l411"></a>
<span id="l412">     *</span><a href="#l412"></a>
<span id="l413">     * @implNote Wrap native call to allow instrumentation.</span><a href="#l413"></a>
<span id="l414">     */</span><a href="#l414"></a>
<span id="l415">    private int accept(FileDescriptor ssfd, FileDescriptor newfd,</span><a href="#l415"></a>
<span id="l416">                       InetSocketAddress[] isaa)</span><a href="#l416"></a>
<span id="l417">        throws IOException</span><a href="#l417"></a>
<span id="l418">    {</span><a href="#l418"></a>
<span id="l419">        return accept0(ssfd, newfd, isaa);</span><a href="#l419"></a>
<span id="l420">    }</span><a href="#l420"></a>
<span id="l421"></span><a href="#l421"></a>
<span id="l422">    // -- Native methods --</span><a href="#l422"></a>
<span id="l423"></span><a href="#l423"></a>
<span id="l424">    // Accepts a new connection, setting the given file descriptor to refer to</span><a href="#l424"></a>
<span id="l425">    // the new socket and setting isaa[0] to the socket's remote address.</span><a href="#l425"></a>
<span id="l426">    // Returns 1 on success, or IOStatus.UNAVAILABLE (if non-blocking and no</span><a href="#l426"></a>
<span id="l427">    // connections are pending) or IOStatus.INTERRUPTED.</span><a href="#l427"></a>
<span id="l428">    //</span><a href="#l428"></a>
<span id="l429">    private native int accept0(FileDescriptor ssfd, FileDescriptor newfd,</span><a href="#l429"></a>
<span id="l430">                               InetSocketAddress[] isaa)</span><a href="#l430"></a>
<span id="l431">        throws IOException;</span><a href="#l431"></a>
<span id="l432"></span><a href="#l432"></a>
<span id="l433">    private static native void initIDs();</span><a href="#l433"></a>
<span id="l434"></span><a href="#l434"></a>
<span id="l435">    static {</span><a href="#l435"></a>
<span id="l436">        IOUtil.load();</span><a href="#l436"></a>
<span id="l437">        initIDs();</span><a href="#l437"></a>
<span id="l438">        nd = new SocketDispatcher();</span><a href="#l438"></a>
<span id="l439">    }</span><a href="#l439"></a>
<span id="l440"></span><a href="#l440"></a>
<span id="l441">}</span><a href="#l441"></a></pre>
