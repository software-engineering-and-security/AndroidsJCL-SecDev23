...
<title>jdk8u/jdk8u/jdk: 9ea5e5b2cd63 src/share/classes/sun/nio/ch/DatagramChannelImpl.java</title>
</head>
<body>
...
<li><a href="/jdk8u/jdk8u/jdk/file/tip/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">latest</a></li>
<li><a href="/jdk8u/jdk8u/jdk/diff/9ea5e5b2cd63/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">diff</a></li>
<li><a href="/jdk8u/jdk8u/jdk/comparison/9ea5e5b2cd63/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">comparison</a></li>
<li><a href="/jdk8u/jdk8u/jdk/annotate/9ea5e5b2cd63/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">annotate</a></li>
<li><a href="/jdk8u/jdk8u/jdk/log/9ea5e5b2cd63/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">file log</a></li>
<li><a href="/jdk8u/jdk8u/jdk/raw-file/9ea5e5b2cd63/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">raw</a></li>
</ul>
<ul>
...
<h3>view src/share/classes/sun/nio/ch/DatagramChannelImpl.java @ 13794:9ea5e5b2cd63</h3>
...
<tr>
 ...
 <td class="author"><a href="/jdk8u/jdk8u/jdk/file/ef425c614a11/src/share/classes/sun/nio/ch/DatagramChannelImpl.java">ef425c614a11</a> </td>
</tr>
<tr>
...
<span id="l2"> * Copyright (c) 2001, 2013, Oracle and/or its affiliates. All rights reserved.</span><a href="#l2"></a>
...
<span id="l39"> * An implementation of DatagramChannels.</span><a href="#l39"></a>
<span id="l40"> */</span><a href="#l40"></a>
<span id="l41"></span><a href="#l41"></a>
<span id="l42">class DatagramChannelImpl</span><a href="#l42"></a>
<span id="l43">    extends DatagramChannel</span><a href="#l43"></a>
<span id="l44">    implements SelChImpl</span><a href="#l44"></a>
<span id="l45">{</span><a href="#l45"></a>
<span id="l46"></span><a href="#l46"></a>
<span id="l47">    // Used to make native read and write calls</span><a href="#l47"></a>
<span id="l48">    private static NativeDispatcher nd = new DatagramDispatcher();</span><a href="#l48"></a>
<span id="l49"></span><a href="#l49"></a>
<span id="l50">    // Our file descriptor</span><a href="#l50"></a>
<span id="l51">    private final FileDescriptor fd;</span><a href="#l51"></a>
<span id="l52">    private final int fdVal;</span><a href="#l52"></a>
<span id="l53"></span><a href="#l53"></a>
<span id="l54">    // The protocol family of the socket</span><a href="#l54"></a>
<span id="l55">    private final ProtocolFamily family;</span><a href="#l55"></a>
<span id="l56"></span><a href="#l56"></a>
<span id="l57">    // IDs of native threads doing reads and writes, for signalling</span><a href="#l57"></a>
<span id="l58">    private volatile long readerThread = 0;</span><a href="#l58"></a>
<span id="l59">    private volatile long writerThread = 0;</span><a href="#l59"></a>
<span id="l60"></span><a href="#l60"></a>
<span id="l61">    // Cached InetAddress and port for unconnected DatagramChannels</span><a href="#l61"></a>
<span id="l62">    // used by receive0</span><a href="#l62"></a>
<span id="l63">    private InetAddress cachedSenderInetAddress;</span><a href="#l63"></a>
<span id="l64">    private int cachedSenderPort;</span><a href="#l64"></a>
<span id="l65"></span><a href="#l65"></a>
<span id="l66">    // Lock held by current reading or connecting thread</span><a href="#l66"></a>
<span id="l67">    private final Object readLock = new Object();</span><a href="#l67"></a>
<span id="l68"></span><a href="#l68"></a>
<span id="l69">    // Lock held by current writing or connecting thread</span><a href="#l69"></a>
<span id="l70">    private final Object writeLock = new Object();</span><a href="#l70"></a>
<span id="l71"></span><a href="#l71"></a>
<span id="l72">    // Lock held by any thread that modifies the state fields declared below</span><a href="#l72"></a>
<span id="l73">    // DO NOT invoke a blocking I/O operation while holding this lock!</span><a href="#l73"></a>
<span id="l74">    private final Object stateLock = new Object();</span><a href="#l74"></a>
<span id="l75"></span><a href="#l75"></a>
<span id="l76">    // -- The following fields are protected by stateLock</span><a href="#l76"></a>
<span id="l77"></span><a href="#l77"></a>
<span id="l78">    // State (does not necessarily increase monotonically)</span><a href="#l78"></a>
<span id="l79">    private static final int ST_UNINITIALIZED = -1;</span><a href="#l79"></a>
<span id="l80">    private static final int ST_UNCONNECTED = 0;</span><a href="#l80"></a>
<span id="l81">    private static final int ST_CONNECTED = 1;</span><a href="#l81"></a>
<span id="l82">    private static final int ST_KILLED = 2;</span><a href="#l82"></a>
<span id="l83">    private int state = ST_UNINITIALIZED;</span><a href="#l83"></a>
<span id="l84"></span><a href="#l84"></a>
<span id="l85">    // Binding</span><a href="#l85"></a>
<span id="l86">    private InetSocketAddress localAddress;</span><a href="#l86"></a>
<span id="l87">    private InetSocketAddress remoteAddress;</span><a href="#l87"></a>
<span id="l88"></span><a href="#l88"></a>
<span id="l89">    // Our socket adaptor, if any</span><a href="#l89"></a>
<span id="l90">    private DatagramSocket socket;</span><a href="#l90"></a>
<span id="l91"></span><a href="#l91"></a>
<span id="l92">    // Multicast support</span><a href="#l92"></a>
<span id="l93">    private MembershipRegistry registry;</span><a href="#l93"></a>
<span id="l94"></span><a href="#l94"></a>
<span id="l95">    // set true when socket is bound and SO_REUSEADDRESS is emulated</span><a href="#l95"></a>
<span id="l96">    private boolean reuseAddressEmulated;</span><a href="#l96"></a>
<span id="l97"></span><a href="#l97"></a>
<span id="l98">    // set true/false when socket is already bound and SO_REUSEADDR is emulated</span><a href="#l98"></a>
<span id="l99">    private boolean isReuseAddress;</span><a href="#l99"></a>
<span id="l100"></span><a href="#l100"></a>
<span id="l101">    // -- End of fields protected by stateLock</span><a href="#l101"></a>
<span id="l102"></span><a href="#l102"></a>
<span id="l103">    public DatagramChannelImpl(SelectorProvider sp)</span><a href="#l103"></a>
<span id="l104">        throws IOException</span><a href="#l104"></a>
<span id="l105">    {</span><a href="#l105"></a>
<span id="l106">        super(sp);</span><a href="#l106"></a>
<span id="l107">        ResourceManager.beforeUdpCreate();</span><a href="#l107"></a>
<span id="l108">        try {</span><a href="#l108"></a>
<span id="l109">            this.family = Net.isIPv6Available() ?</span><a href="#l109"></a>
<span id="l110">                StandardProtocolFamily.INET6 : StandardProtocolFamily.INET;</span><a href="#l110"></a>
<span id="l111">            this.fd = Net.socket(family, false);</span><a href="#l111"></a>
<span id="l112">            this.fdVal = IOUtil.fdVal(fd);</span><a href="#l112"></a>
<span id="l113">            this.state = ST_UNCONNECTED;</span><a href="#l113"></a>
<span id="l114">        } catch (IOException ioe) {</span><a href="#l114"></a>
<span id="l115">            ResourceManager.afterUdpClose();</span><a href="#l115"></a>
<span id="l116">            throw ioe;</span><a href="#l116"></a>
<span id="l117">        }</span><a href="#l117"></a>
<span id="l118">    }</span><a href="#l118"></a>
<span id="l119"></span><a href="#l119"></a>
<span id="l120">    public DatagramChannelImpl(SelectorProvider sp, ProtocolFamily family)</span><a href="#l120"></a>
<span id="l121">        throws IOException</span><a href="#l121"></a>
<span id="l122">    {</span><a href="#l122"></a>
<span id="l123">        super(sp);</span><a href="#l123"></a>
<span id="l124">        if ((family != StandardProtocolFamily.INET) &amp;&amp;</span><a href="#l124"></a>
<span id="l125">            (family != StandardProtocolFamily.INET6))</span><a href="#l125"></a>
<span id="l126">        {</span><a href="#l126"></a>
<span id="l127">            if (family == null)</span><a href="#l127"></a>
<span id="l128">                throw new NullPointerException(&quot;'family' is null&quot;);</span><a href="#l128"></a>
<span id="l129">            else</span><a href="#l129"></a>
<span id="l130">                throw new UnsupportedOperationException(&quot;Protocol family not supported&quot;);</span><a href="#l130"></a>
<span id="l131">        }</span><a href="#l131"></a>
<span id="l132">        if (family == StandardProtocolFamily.INET6) {</span><a href="#l132"></a>
<span id="l133">            if (!Net.isIPv6Available()) {</span><a href="#l133"></a>
<span id="l134">                throw new UnsupportedOperationException(&quot;IPv6 not available&quot;);</span><a href="#l134"></a>
<span id="l135">            }</span><a href="#l135"></a>
<span id="l136">        }</span><a href="#l136"></a>
<span id="l137"></span><a href="#l137"></a>
<span id="l138">        ResourceManager.beforeUdpCreate();</span><a href="#l138"></a>
<span id="l139">        try {</span><a href="#l139"></a>
<span id="l140">            this.family = family;</span><a href="#l140"></a>
<span id="l141">            this.fd = Net.socket(family, false);</span><a href="#l141"></a>
<span id="l142">            this.fdVal = IOUtil.fdVal(fd);</span><a href="#l142"></a>
<span id="l143">            this.state = ST_UNCONNECTED;</span><a href="#l143"></a>
<span id="l144">        } catch (IOException ioe) {</span><a href="#l144"></a>
<span id="l145">            ResourceManager.afterUdpClose();</span><a href="#l145"></a>
<span id="l146">            throw ioe;</span><a href="#l146"></a>
<span id="l147">        }</span><a href="#l147"></a>
<span id="l148">    }</span><a href="#l148"></a>
<span id="l149"></span><a href="#l149"></a>
<span id="l150">    public DatagramChannelImpl(SelectorProvider sp, FileDescriptor fd)</span><a href="#l150"></a>
<span id="l151">        throws IOException</span><a href="#l151"></a>
<span id="l152">    {</span><a href="#l152"></a>
<span id="l153">        super(sp);</span><a href="#l153"></a>
<span id="l154"></span><a href="#l154"></a>
<span id="l155">        // increment UDP count to match decrement when closing</span><a href="#l155"></a>
<span id="l156">        ResourceManager.beforeUdpCreate();</span><a href="#l156"></a>
<span id="l157"></span><a href="#l157"></a>
<span id="l158">        this.family = Net.isIPv6Available() ?</span><a href="#l158"></a>
<span id="l159">            StandardProtocolFamily.INET6 : StandardProtocolFamily.INET;</span><a href="#l159"></a>
<span id="l160">        this.fd = fd;</span><a href="#l160"></a>
<span id="l161">        this.fdVal = IOUtil.fdVal(fd);</span><a href="#l161"></a>
<span id="l162">        this.state = ST_UNCONNECTED;</span><a href="#l162"></a>
<span id="l163">        this.localAddress = Net.localAddress(fd);</span><a href="#l163"></a>
<span id="l164">    }</span><a href="#l164"></a>
<span id="l165"></span><a href="#l165"></a>
<span id="l166">    public DatagramSocket socket() {</span><a href="#l166"></a>
<span id="l167">        synchronized (stateLock) {</span><a href="#l167"></a>
<span id="l168">            if (socket == null)</span><a href="#l168"></a>
<span id="l169">                socket = DatagramSocketAdaptor.create(this);</span><a href="#l169"></a>
<span id="l170">            return socket;</span><a href="#l170"></a>
<span id="l171">        }</span><a href="#l171"></a>
<span id="l172">    }</span><a href="#l172"></a>
<span id="l173"></span><a href="#l173"></a>
<span id="l174">    @Override</span><a href="#l174"></a>
<span id="l175">    public SocketAddress getLocalAddress() throws IOException {</span><a href="#l175"></a>
<span id="l176">        synchronized (stateLock) {</span><a href="#l176"></a>
<span id="l177">            if (!isOpen())</span><a href="#l177"></a>
<span id="l178">                throw new ClosedChannelException();</span><a href="#l178"></a>
<span id="l179">            // Perform security check before returning address</span><a href="#l179"></a>
